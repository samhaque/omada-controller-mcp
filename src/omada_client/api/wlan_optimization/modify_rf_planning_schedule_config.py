...
from ...models.rf_planning_schedule_config_open_api_vo import (
...
def _get_kwargs(
    ...
    site_id: str,
    *,
    body: RFPlanningScheduleConfigOpenApiVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/rfPlanning/schedule/config".format(
...
def sync_detailed(
    ...
    *,
    ...
    """modify RF Planning Schedule Config
     ...
     modify RF Planning Schedule Config<br/><br/>The interface requires one of the permissions: <br/>Site
