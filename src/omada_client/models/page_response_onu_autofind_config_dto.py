...
T = TypeVar("T", bound="PageResponseOnuAutofindConfigDTO")


@_attrs_define
class PageResponseOnuAutofindConfigDTO:
    """
    Attributes:
        content (list[OnuAutofindConfigDTO] | Unset): Content
    ...
    content: list[OnuAutofindConfigDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = OnuAutofindConfigDTO.from_dict(content_item_data)
        ...
        page_response_onu_autofind_config_dto = cls(
            content=content,
        ...
        page_response_onu_autofind_config_dto.additional_properties = d
        return page_response_onu_autofind_config_dto
