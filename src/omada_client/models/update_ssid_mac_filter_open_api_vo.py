...
T = TypeVar("T", bound="UpdateSsidMacFilterOpenApiVO")


@_attrs_define
class UpdateSsidMacFilterOpenApiVO:
    """
    Attributes:
        mac_filter_enable (bool): SSID MAC Filter global config status. True: enable, false: disable.
        ...
        oui_profile_id_list (list[str] | Unset): This field represents OUI Profile ID list. OUI Profile can be created
            ...
            interface(This configuration applies to the Pro Site of the Omada Pro Controller only).
    """

    mac_filter_enable: bool
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update(
            {
                "macFilterEnable": mac_filter_enable,
            }
        )
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        mac_filter_enable = d.pop("macFilterEnable")
        ...
        update_ssid_mac_filter_open_api_vo = cls(
        ...
        update_ssid_mac_filter_open_api_vo.additional_properties = d
        return update_ssid_mac_filter_open_api_vo
