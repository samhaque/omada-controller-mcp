...
T = TypeVar("T", bound="Ipv6PppoeOpenApiVO")


@_attrs_define
class Ipv6PppoeOpenApiVO:
    """It is required when protoType is PPPoE

    Attributes:
        ppp_share (bool): Share the same PPPoE session with IPv4
        user_name (str):
        password (str):
        get_ipv_6_type (int): It should be a value as follows: 0: SLAAC, 1: DHCPv6, 2: specified, 3: auto,
            4:non_address, which ranges from 48 ~ 64.
        prefix_enable (bool):
        dns_type (int): DNS Address Type should be a value as follows: 0: dynamic, 1: static.
        prefix_size (int | Unset): It is required when [prefixEnable] is true.
        specific_ip (str | Unset): It is required when [getIpv6Type] is 2.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if specific_ip is not UNSET:
            field_dict["specificIp"] = specific_ip
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ipv_6_pppoe_open_api_vo.additional_properties = d
        return ipv_6_pppoe_open_api_vo
