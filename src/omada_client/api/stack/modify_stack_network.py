...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/stacks/{stack_id}/networks/{network_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify stack vlan interface
     ...
     Modify stack vlan interface.<br/><br/>The interface requires one of the permissions: <br/>Site
