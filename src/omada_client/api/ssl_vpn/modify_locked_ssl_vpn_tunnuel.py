...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/vpn/ssl-vpn-server/locked-tunnels/{lock_tunnel_id}".format(
            omadac_id=quote(str(omadac_id), safe=""),
            site_id=quote(str(site_id), safe=""),
            lock_tunnel_id=quote(str(lock_tunnel_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Modify locked SSL VPN tunnel
     ...
     Modify locked SSL VPN tunnel.<br/><br/>The interface requires one of the permissions: <br/>Site
