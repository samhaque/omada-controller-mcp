...
T = TypeVar("T", bound="GridVOFirmwareInfo")


@_attrs_define
class GridVOFirmwareInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = FirmwareInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_firmware_info = cls(
        ...
        grid_vo_firmware_info.additional_properties = d
        return grid_vo_firmware_info
