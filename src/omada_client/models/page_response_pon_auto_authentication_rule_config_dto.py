...
T = TypeVar("T", bound="PageResponsePonAutoAuthenticationRuleConfigDTO")


@_attrs_define
class PageResponsePonAutoAuthenticationRuleConfigDTO:
    """
    Attributes:
        content (list[PonAutoAuthenticationRuleConfigDTO] | Unset): Content
    ...
    content: list[PonAutoAuthenticationRuleConfigDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = PonAutoAuthenticationRuleConfigDTO.from_dict(
                    content_item_data
                )
        ...
        page_response_pon_auto_authentication_rule_config_dto = cls(
            content=content,
        ...
        page_response_pon_auto_authentication_rule_config_dto.additional_properties = d
        return page_response_pon_auto_authentication_rule_config_dto
