...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/lan-traffic-info".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get AP lan traffic info
     ...
     Get AP lan traffic info<br/><br/>The interface requires one of the permissions: <br/>Site Device
