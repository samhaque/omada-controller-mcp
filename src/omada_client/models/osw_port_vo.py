...
if TYPE_CHECKING:
    ...
    from ..models.osw_port_vo_tag_bridge_vlan_map import OswPortVOTagBridgeVlanMap
    from ..models.osw_port_vo_untag_bridge_vlan_map import OswPortVOUntagBridgeVlanMap
...
class OswPortVO:
    ...
    Attributes:
        ...
        tag_bridge_vlan_map (OswPortVOTagBridgeVlanMap | Unset): Tag Network Bridge Vlan Map
        untag_network_ids (list[str] | Unset): Untag Network IDs
        untag_bridge_vlan_map (OswPortVOUntagBridgeVlanMap | Unset): Untag Network Bridge Vlan Map
    ...
    tag_bridge_vlan_map: OswPortVOTagBridgeVlanMap | Unset = UNSET
    untag_network_ids: list[str] | Unset = UNSET
    untag_bridge_vlan_map: OswPortVOUntagBridgeVlanMap | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        from ..models.osw_port_speed_cap_vo import OswPortSpeedCapVO
        from ..models.osw_port_status_vo import OswPortStatusVO
        from ..models.osw_port_vo_tag_bridge_vlan_map import (
            OswPortVOTagBridgeVlanMap,
        )
        from ..models.osw_port_vo_untag_bridge_vlan_map import (
        ...
        tag_bridge_vlan_map: OswPortVOTagBridgeVlanMap | Unset
        if isinstance(_tag_bridge_vlan_map, Unset):
            tag_bridge_vlan_map = UNSET
        else:
            tag_bridge_vlan_map = OswPortVOTagBridgeVlanMap.from_dict(
        ...
        untag_bridge_vlan_map: OswPortVOUntagBridgeVlanMap | Unset
        if isinstance(_untag_bridge_vlan_map, Unset):
            untag_bridge_vlan_map = UNSET
        else:
            untag_bridge_vlan_map = OswPortVOUntagBridgeVlanMap.from_dict(
        ...
        osw_port_vo.additional_properties = d
        return osw_port_vo
