...
T = TypeVar("T", bound="GridVOVpnTunnelStatusVO")


@_attrs_define
class GridVOVpnTunnelStatusVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        grid_vo_vpn_tunnel_status_vo = cls(
        ...
        grid_vo_vpn_tunnel_status_vo.additional_properties = d
        return grid_vo_vpn_tunnel_status_vo
