...
from ..models.ont_port_vlan_config_add_item_dto_vlan_mode import (
    OntPortVlanConfigAddItemDTOVlanMode,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="OntPortVlanConfigAddItemDTO")


@_attrs_define
class OntPortVlanConfigAddItemDTO:
    """Config item add list

    Attributes:
        vlan_mode (OntPortVlanConfigAddItemDTOVlanMode): Vlan mode should not be null,vlanMode should be a value as
    ...
    vlan_mode: OntPortVlanConfigAddItemDTOVlanMode
    svlan: int
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        vlan_mode = OntPortVlanConfigAddItemDTOVlanMode(d.pop("vlanMode"))
        ...
        ont_port_vlan_config_add_item_dto = cls(
            vlan_mode=vlan_mode,
            svlan=svlan,
            spriority=spriority,
            cvlan=cvlan,
        ...
        ont_port_vlan_config_add_item_dto.additional_properties = d
        return ont_port_vlan_config_add_item_dto
