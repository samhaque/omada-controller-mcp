...
def sync_detailed(
    ...
    *,
    ...
    RADIUS user name already exists.<br/>-34025  -  The number of RADIUS users has reached the
    limit.<br/>-34030  -  The RADIUS user name exists in other sites. Please contact the administrator
    if necessary.
