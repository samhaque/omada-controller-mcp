...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/profiles/radius-server/users/{user_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    returned body is one of the following error codes (non generic error codes): <br/>-34024  -  The
    RADIUS user name already exists.<br/>-34026  -  The RADIUS user does not exist.<br/>-34030  -  The
    RADIUS user name exists in other sites. Please contact the administrator if necessary.
