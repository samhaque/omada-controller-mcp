...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/hotspot/vouchers/batch/print".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get selected vouchers in a voucher group
     ...
     Get selected vouchers brief in a voucher group.<br/><br/>The interface requires one of the
