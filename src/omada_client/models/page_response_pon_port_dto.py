...
T = TypeVar("T", bound="PageResponsePonPortDTO")


@_attrs_define
class PageResponsePonPortDTO:
    """
    Attributes:
        content (list[PonPortDTO] | Unset): Content
    ...
    content: list[PonPortDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = PonPortDTO.from_dict(content_item_data)
        ...
        page_response_pon_port_dto = cls(
            content=content,
        ...
        page_response_pon_port_dto.additional_properties = d
        return page_response_pon_port_dto
