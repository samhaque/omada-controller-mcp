...
T = TypeVar("T", bound="DBAProfileListQueryDTO")


@_attrs_define
class DBAProfileListQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dba_profile_list_query_dto = cls(
            search_key=search_key,
            sorts=sorts,
            search_fields=search_fields,
        )

        dba_profile_list_query_dto.additional_properties = d
        return dba_profile_list_query_dto
