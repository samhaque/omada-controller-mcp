...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/gateways/{gateway_mac}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get gateway info
     ...
     Get gateway info<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
