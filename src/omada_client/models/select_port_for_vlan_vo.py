...
T = TypeVar("T", bound="SelectPortForVlanVO")


@_attrs_define
class SelectPortForVlanVO:
    """Device Ports
    ...
    Attributes:
        ...
        port_id (str | Unset): ID, for example: "1/0/1" (for switch port), "3_e3f176e1c95a49849477636c43a49d3f" (for
            gateway port).
        id (int | Unset): port number, for example: 1
        type_ (int | Unset): Type. 1: Copper, 2: Combo, 3: SFP
        mode (int | Unset): Mode, 0:WAN,1:LAN;
        config_mlag_dad (bool | Unset): Whether the port is configured as a mlag dad port.
        config_mlag_peer_link (bool | Unset): Whether the port is configured as a mlag peer-link port.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        select_port_for_vlan_vo.additional_properties = d
        return select_port_for_vlan_vo
