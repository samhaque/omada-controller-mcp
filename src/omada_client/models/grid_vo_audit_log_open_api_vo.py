...
if TYPE_CHECKING:
    from ..models.audit_log_open_api_vo import AuditLogOpenApiVO


T = TypeVar("T", bound="GridVOAuditLogOpenApiVO")


@_attrs_define
class GridVOAuditLogOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = AuditLogOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_audit_log_open_api_vo = cls(
        ...
        grid_vo_audit_log_open_api_vo.additional_properties = d
        return grid_vo_audit_log_open_api_vo
