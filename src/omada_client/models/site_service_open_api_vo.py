...
if TYPE_CHECKING:
    ...
    from ..models.alert_setting_open_api_vo import AlertSettingOpenApiVO
...
T = TypeVar("T", bound="SiteServiceOpenApiVO")


@_attrs_define
class SiteServiceOpenApiVO:
    """
    Attributes:
        mesh (NewMeshSettingOpenApiVO | Unset): Site mesh setting.
        alert (AlertSettingOpenApiVO | Unset): Site alert setting.
    ...
    alert: AlertSettingOpenApiVO | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        from ..models.alert_setting_open_api_vo import (
        ...
        alert: AlertSettingOpenApiVO | Unset
        if isinstance(_alert, Unset):
            alert = UNSET
        else:
            alert = AlertSettingOpenApiVO.from_dict(_alert)
        ...
        site_service_open_api_vo.additional_properties = d
        return site_service_open_api_vo
