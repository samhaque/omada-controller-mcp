...
if TYPE_CHECKING:
    from ..models.msp_external_user_detail_open_api_vo import (
        MspExternalUserDetailOpenApiVO,
    )


T = TypeVar("T", bound="GridVOMspExternalUserDetailOpenApiVO")


@_attrs_define
class GridVOMspExternalUserDetailOpenApiVO:
    """
    Attributes:
        ...
        data (list[MspExternalUserDetailOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[MspExternalUserDetailOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = MspExternalUserDetailOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_msp_external_user_detail_open_api_vo = cls(
        ...
        grid_vo_msp_external_user_detail_open_api_vo.additional_properties = d
        return grid_vo_msp_external_user_detail_open_api_vo
