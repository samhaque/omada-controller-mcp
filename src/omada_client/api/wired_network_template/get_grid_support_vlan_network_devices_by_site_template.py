...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/networks/devices".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get device template list that can be dhcp server
     ...
     Get device template list that can be dhcp server<br/><br/>The interface requires one of the
