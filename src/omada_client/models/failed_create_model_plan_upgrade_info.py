...
T = TypeVar("T", bound="FailedCreateModelPlanUpgradeInfo")


@_attrs_define
class FailedCreateModelPlanUpgradeInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        failed_create_model_plan_upgrade_info = cls(
        ...
        failed_create_model_plan_upgrade_info.additional_properties = d
        return failed_create_model_plan_upgrade_info
