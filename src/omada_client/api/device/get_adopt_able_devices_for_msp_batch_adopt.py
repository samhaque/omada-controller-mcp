...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/msp/{msp_id}/devices/batch/info".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Batch get info of adopted device in MSP view.
     ...
     Batch get info of adopted device in MSP view.<br/><br/>The interface requires one of the
    permissions: <br/>MSP Adopt Device Manager Access<br/>MSP Add Device Manager Access
