...
if TYPE_CHECKING:
    from ..models.osw_mlag_vo import OswMlagVO


T = TypeVar("T", bound="GridVOOswMlagVO")


@_attrs_define
class GridVOOswMlagVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswMlagVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osw_mlag_vo = cls(
        ...
        grid_vo_osw_mlag_vo.additional_properties = d
        return grid_vo_osw_mlag_vo
