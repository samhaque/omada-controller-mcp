...
T = TypeVar("T", bound="TopCpuUsageHealthOpenApiVO")


@_attrs_define
class TopCpuUsageHealthOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        top_cpu_usage_health_open_api_vo = cls(
            name=name,
            mac=mac,
            model=model,
        ...
        top_cpu_usage_health_open_api_vo.additional_properties = d
        return top_cpu_usage_health_open_api_vo
