...
from ...models.ont_pots_port_list_query_dto import OntPotsPortListQueryDTO
...
def _get_kwargs(
    ...
    service_id: str,
    *,
    query_param: OntPotsPortListQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/service/{service_id}/pots-ports/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ont pots port list
     ...
     Get ont pots port list<br/><br/>The interface requires one of the permissions: <br/>Site Device
