...
T = TypeVar("T", bound="VirtualWanDslOpenApiVO")


@_attrs_define
class VirtualWanDslOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        virtual_wan_dsl_open_api_vo = cls(
            location=location,
            isp=isp,
        ...
        virtual_wan_dsl_open_api_vo.additional_properties = d
        return virtual_wan_dsl_open_api_vo
