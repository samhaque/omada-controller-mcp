...
from ...models.ap_bridge_config import ApBridgeConfig
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/bridge".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify P2P bridge config
     ...
     Modify P2P bridge config<br/><br/>The interface requires one of the permissions: <br/>Site Device
