...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/l2-feature/eth-port/port/unit1/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ETH Unit1 port list of olt
     ...
     Get ETH Unit1 port list of olt<br/><br/>The interface requires one of the permissions: <br/>Site
