...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/eaps/{ap_mac}/health/detail".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ap health detail
     ...
     Get ap health detail<br/><br/>The interface requires one of the permissions: <br/>Site Device
