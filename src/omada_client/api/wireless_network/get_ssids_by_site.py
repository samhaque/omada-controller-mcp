...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/wireless-network/ssids".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get all ssids of the site
     ...
     Get all ssids of the site<br/><br/>The interface requires one of the permissions: <br/>Site Settings
