...
T = TypeVar("T", bound="DhcpServerDevCapForVlanVO")


@_attrs_define
class DhcpServerDevCapForVlanVO:
    """
    Attributes:
        support_get_dhcp_client_table (bool | Unset): Indicates whether the device supports obtaining DHCP client table
            information through the GET message
        support_get_dhcp_server_info (bool | Unset): Indicates whether the device supports obtaining DHCP server
            information through the GET message
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dhcp_server_dev_cap_for_vlan_vo = cls(
            support_get_dhcp_client_table=support_get_dhcp_client_table,
            support_get_dhcp_server_info=support_get_dhcp_server_info,
        )

        dhcp_server_dev_cap_for_vlan_vo.additional_properties = d
        return dhcp_server_dev_cap_for_vlan_vo
