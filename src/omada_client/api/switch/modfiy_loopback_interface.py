...
def _get_kwargs(
    ...
    *,
    body: OswLoopbackInterfaceVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/switches/{switch_mac}/loopback-interface/{loopback_interface_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify Loopback Interface
     ...
     Modify Loopback Interface.<br/><br/>The interface requires one of the permissions: <br/>Site Device
