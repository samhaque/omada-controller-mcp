...
if TYPE_CHECKING:
    from ..models.device_oui_mode_query_open_api_vo import DeviceOuiModeQueryOpenApiVO
    from ..models.vlan_oui_mode_query_open_api_vo import VlanOuiModeQueryOpenApiVO


T = TypeVar("T", bound="OuiBasedVlanSwitchQueryOpenApiVO")


@_attrs_define
class OuiBasedVlanSwitchQueryOpenApiVO:
    """
    Attributes:
        ...
        device_list (list[DeviceOuiModeQueryOpenApiVO] | Unset): When mode is 0, Show configured device info.
    ...
    device_list: list[DeviceOuiModeQueryOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.device_oui_mode_query_open_api_vo import (
        ...
        if _device_list is not UNSET:
            ...
            for device_list_item_data in _device_list:
                device_list_item = DeviceOuiModeQueryOpenApiVO.from_dict(
        ...
        oui_based_vlan_switch_query_open_api_vo = cls(
            id=id,
            enable=enable,
            name=name,
            mode=mode,
        ...
        oui_based_vlan_switch_query_open_api_vo.additional_properties = d
        return oui_based_vlan_switch_query_open_api_vo
