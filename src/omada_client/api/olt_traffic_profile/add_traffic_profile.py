...
from ...models.traffic_profile_dto import TrafficProfileDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    body: TrafficProfileDTO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/traffic/profiles/add".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create new traffic profile
     ...
     Create new traffic profile<br/><br/>The interface requires one of the permissions: <br/>Site Device
