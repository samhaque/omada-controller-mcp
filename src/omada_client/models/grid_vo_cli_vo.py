...
if TYPE_CHECKING:
    from ..models.cli_vo import CliVO


T = TypeVar("T", bound="GridVOCliVO")
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = CliVO.from_dict(data_item_data)
        ...
        grid_vo_cli_vo.additional_properties = d
        return grid_vo_cli_vo
