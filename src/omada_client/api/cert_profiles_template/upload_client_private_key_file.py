...
from ...models.upload_client_private_key_file_body import UploadClientPrivateKeyFileBody
...
def _get_kwargs(
    ...
    *,
    body: UploadClientPrivateKeyFileBody | Unset = UNSET,
    data: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/files/sitetemplates/{site_template_id}/setting/profiles/cert-profiles/client-private-key".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Upload client private key Template file
     ...
     Upload client private key Template file of the omadac with the given omadacId.<br/><br/>The
    ...
    Args:
        ...
        site_template_id (str):
        data (str):
        body (UploadClientPrivateKeyFileBody | Unset):
