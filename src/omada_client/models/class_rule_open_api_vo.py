...
T = TypeVar("T", bound="ClassRuleOpenApiVO")


@_attrs_define
class ClassRuleOpenApiVO:
    """
    Attributes:
        ...
        local_ip (str): The ID of IP Group or IPv6 Group selected in the Local Address configuration. The ID can be
            obtained from 'Get group profile list' interface.
        ...
        service_type (str): The ID of Gateway Qos Service selected in the Service Name configuration. The ID can be
            obtained from 'Get all Gateway QoS Service's ID and name info' interface.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        class_rule_open_api_vo.additional_properties = d
        return class_rule_open_api_vo
