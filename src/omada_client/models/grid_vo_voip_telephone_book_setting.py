...
if TYPE_CHECKING:
    from ..models.voip_telephone_book_setting import VoipTelephoneBookSetting


T = TypeVar("T", bound="GridVOVoipTelephoneBookSetting")


@_attrs_define
class GridVOVoipTelephoneBookSetting:
    """
    Attributes:
        ...
        data (list[VoipTelephoneBookSetting] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[VoipTelephoneBookSetting] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.voip_telephone_book_setting import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = VoipTelephoneBookSetting.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_voip_telephone_book_setting = cls(
        ...
        grid_vo_voip_telephone_book_setting.additional_properties = d
        return grid_vo_voip_telephone_book_setting
