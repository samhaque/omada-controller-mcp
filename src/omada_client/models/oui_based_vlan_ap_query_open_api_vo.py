...
if TYPE_CHECKING:
    from ..models.ssid_oui_mode_open_api_vo import SsidOuiModeOpenApiVO
    from ..models.vlan_oui_mode_query_open_api_vo import VlanOuiModeQueryOpenApiVO


T = TypeVar("T", bound="OuiBasedVlanApQueryOpenApiVO")


@_attrs_define
class OuiBasedVlanApQueryOpenApiVO:
    """
    Attributes:
        id (str | Unset): Rule ID
        enable (bool | Unset): Ap Rule state.
        name (str | Unset): Ap Rule name should contain 1 to 128 characters.
        ssid_list (list[SsidOuiModeOpenApiVO] | Unset): Configured ssid list.
        rule_combine (list[VlanOuiModeQueryOpenApiVO] | Unset): Basic vlan-oui-priority configuration of oui based rule.
    """

    id: str | Unset = UNSET
    enable: bool | Unset = UNSET
    name: str | Unset = UNSET
    ssid_list: list[SsidOuiModeOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.ssid_oui_mode_open_api_vo import (
        ...
        if _ssid_list is not UNSET:
            ...
            for ssid_list_item_data in _ssid_list:
                ssid_list_item = SsidOuiModeOpenApiVO.from_dict(ssid_list_item_data)
        ...
        oui_based_vlan_ap_query_open_api_vo = cls(
            id=id,
            enable=enable,
            name=name,
            ssid_list=ssid_list,
        ...
        oui_based_vlan_ap_query_open_api_vo.additional_properties = d
        return oui_based_vlan_ap_query_open_api_vo
