...
T = TypeVar("T", bound="SelectLagForVlanVO")


@_attrs_define
class SelectLagForVlanVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        select_lag_for_vlan_vo.additional_properties = d
        return select_lag_for_vlan_vo
