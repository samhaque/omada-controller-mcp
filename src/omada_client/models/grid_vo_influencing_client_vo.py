...
if TYPE_CHECKING:
    from ..models.influencing_client_vo import InfluencingClientVO


T = TypeVar("T", bound="GridVOInfluencingClientVO")


@_attrs_define
class GridVOInfluencingClientVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = InfluencingClientVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_influencing_client_vo = cls(
        ...
        grid_vo_influencing_client_vo.additional_properties = d
        return grid_vo_influencing_client_vo
