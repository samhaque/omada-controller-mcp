...
T = TypeVar("T", bound="Ipv4PppoaOpenApiVO")


@_attrs_define
class Ipv4PppoaOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ipv_4_pppoa_open_api_vo.additional_properties = d
        return ipv_4_pppoa_open_api_vo
