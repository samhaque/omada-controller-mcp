...
T = TypeVar("T", bound="AnomalyVODevices")


@_attrs_define
class AnomalyVODevices:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        anomaly_vo_devices.additional_properties = additional_properties
        return anomaly_vo_devices
