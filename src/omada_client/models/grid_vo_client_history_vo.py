...
if TYPE_CHECKING:
    from ..models.client_history_vo import ClientHistoryVO


T = TypeVar("T", bound="GridVOClientHistoryVO")


@_attrs_define
class GridVOClientHistoryVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ClientHistoryVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_client_history_vo = cls(
        ...
        grid_vo_client_history_vo.additional_properties = d
        return grid_vo_client_history_vo
