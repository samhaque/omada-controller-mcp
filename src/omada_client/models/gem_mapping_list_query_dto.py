...
T = TypeVar("T", bound="GemMappingListQueryDTO")


@_attrs_define
class GemMappingListQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        gem_mapping_list_query_dto = cls(
            search_key=search_key,
            sorts=sorts,
            line_profile_id=line_profile_id,
        )

        gem_mapping_list_query_dto.additional_properties = d
        return gem_mapping_list_query_dto
