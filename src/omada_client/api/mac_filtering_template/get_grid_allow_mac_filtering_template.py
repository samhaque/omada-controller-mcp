...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/mac-filters/allow".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get allow MAC filtering template list
     ...
     Get allow MAC filtering template list.<br/><br/>The interface requires one of the permissions:
