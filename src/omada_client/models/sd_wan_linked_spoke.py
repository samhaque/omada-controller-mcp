...
T = TypeVar("T", bound="SdWanLinkedSpoke")


@_attrs_define
class SdWanLinkedSpoke:
    ...
    Attributes:
        ...
        status (int | Unset): The connection status of SD-WAN tunnel between spokes
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        sd_wan_linked_spoke = cls(
            device_mac_1=device_mac_1,
            device_mac_2=device_mac_2,
            status=status,
        )

        sd_wan_linked_spoke.additional_properties = d
        return sd_wan_linked_spoke
