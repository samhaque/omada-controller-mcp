...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v2/{omadac_id}/sites/{site_id}/lan-networks/batch-isolate".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Batch isolate network
     ...
     Batch isolate network.<br/><br/>The interface requires one of the permissions: <br/>Site Settings
    ...
    Please wait and try again later.<br/>-33507  -  This profile does not exist.
