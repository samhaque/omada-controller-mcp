...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/devices/batch/info".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Batch get info of adopted device in global view.
     ...
     Batch get info of adopted device in global view.<br/><br/>The interface requires one of the
    permissions: <br/>Site Adopt Device Manager Access<br/>Site Add Device Manager Access
