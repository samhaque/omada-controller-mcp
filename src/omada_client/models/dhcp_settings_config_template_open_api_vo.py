...
T = TypeVar("T", bound="DhcpSettingsConfigTemplateOpenApiVO")


@_attrs_define
class DhcpSettingsConfigTemplateOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dhcp_settings_config_template_open_api_vo = cls(
            enable=enable,
        ...
        dhcp_settings_config_template_open_api_vo.additional_properties = d
        return dhcp_settings_config_template_open_api_vo
