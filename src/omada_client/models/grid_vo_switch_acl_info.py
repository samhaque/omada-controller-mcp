...
if TYPE_CHECKING:
    from ..models.switch_acl_info import SwitchACLInfo


T = TypeVar("T", bound="GridVOSwitchACLInfo")


@_attrs_define
class GridVOSwitchACLInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SwitchACLInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_switch_acl_info = cls(
        ...
        grid_vo_switch_acl_info.additional_properties = d
        return grid_vo_switch_acl_info
