...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/qos/gateway/wans".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get siteTemplate's WAN ports info for Gateway QoS
     ...
     Get siteTemplate's WAN ports info for Gateway QoS.<br/><br/>The interface requires one of the
