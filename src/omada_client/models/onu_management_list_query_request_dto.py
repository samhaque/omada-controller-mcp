...
T = TypeVar("T", bound="OnuManagementListQueryRequestDTO")


@_attrs_define
class OnuManagementListQueryRequestDTO:
    """
    Attributes:
        pon_port (str): Pon port collection.e.g.,'GPON 1/1/1'、'GPON 1/1/1-3'、'GPON 1/1/1-3,GPON 1/1/5,GPON 1/1/7-8'
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        onu_management_list_query_request_dto = cls(
            pon_port=pon_port,
        ...
        onu_management_list_query_request_dto.additional_properties = d
        return onu_management_list_query_request_dto
