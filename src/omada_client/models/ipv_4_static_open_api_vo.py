...
T = TypeVar("T", bound="Ipv4StaticOpenApiVO")


@_attrs_define
class Ipv4StaticOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ipv_4_static_open_api_vo.additional_properties = d
        return ipv_4_static_open_api_vo
