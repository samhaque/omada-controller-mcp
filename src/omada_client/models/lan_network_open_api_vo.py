...
T = TypeVar("T", bound="LanNetworkOpenApiVO")


@_attrs_define
class LanNetworkOpenApiVO:
    """LANNetworkOpenApiVO
    ...
    Attributes:
        ...
        isolation (bool | Unset): Whether isolate this network.
        ...
        vlan (int | Unset): When purpose is "VLAN" or purpose is "interface" and VLANType is 0, create VLAN, which
            ranges from 1 to 4090.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        lan_network_open_api_vo.additional_properties = d
        return lan_network_open_api_vo
