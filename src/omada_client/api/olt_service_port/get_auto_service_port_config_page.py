...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/auto-service-ports/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get auto service port config page
     ...
     Get auto service port config page<br/><br/>The interface requires one of the permissions: <br/>Site
