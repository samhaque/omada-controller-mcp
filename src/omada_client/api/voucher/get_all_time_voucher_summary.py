...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/hotspot/vouchers/statistics/summary".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get voucher summary
     ...
     Get voucher summary of all time in the site.<br/><br/>The interface requires one of the permissions:
