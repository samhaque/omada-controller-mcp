...
if TYPE_CHECKING:
    from ..models.osw_vrf_open_api_vo import OswVrfOpenApiVO


T = TypeVar("T", bound="GridVOOswVrfOpenApiVO")


@_attrs_define
class GridVOOswVrfOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswVrfOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osw_vrf_open_api_vo = cls(
        ...
        grid_vo_osw_vrf_open_api_vo.additional_properties = d
        return grid_vo_osw_vrf_open_api_vo
