...
class PortVO:
    ...
    Attributes:
        port (int | Unset): The port id of the device port.
        standard_port (str | Unset): The stand port id of the device port.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        port_vo.additional_properties = d
        return port_vo
