...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/wireless-network/ssids/{ssid_id}/rate-control".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update SSID Template 802.11 rate control config by site
     ...
     Update SSID Template 802.11 rate control config by site<br/><br/>The interface requires one of the
