...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/switchtemplates/{device_template_id}/vrfs/{vrf_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete vrf template
     ...
     Delete vrf template. This interface has been deprecated.<br/><br/>The interface requires one of the
