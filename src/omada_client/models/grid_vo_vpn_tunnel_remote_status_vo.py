...
T = TypeVar("T", bound="GridVOVpnTunnelRemoteStatusVO")


@_attrs_define
class GridVOVpnTunnelRemoteStatusVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        grid_vo_vpn_tunnel_remote_status_vo = cls(
        ...
        grid_vo_vpn_tunnel_remote_status_vo.additional_properties = d
        return grid_vo_vpn_tunnel_remote_status_vo
