...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/devices/{device_mac}/latest-firmware-info".format(
...
def sync_detailed(
    ...
    *,
    ...
    logs.<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager View
