...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/pon-port/configs/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get pon port page
     ...
     Get pon port page<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
