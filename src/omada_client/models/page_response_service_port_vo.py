...
T = TypeVar("T", bound="PageResponseServicePortVO")


@_attrs_define
class PageResponseServicePortVO:
    """
    Attributes:
        content (list[ServicePortVO] | Unset): Content
    ...
    content: list[ServicePortVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ServicePortVO.from_dict(content_item_data)
        ...
        page_response_service_port_vo = cls(
            content=content,
        ...
        page_response_service_port_vo.additional_properties = d
        return page_response_service_port_vo
