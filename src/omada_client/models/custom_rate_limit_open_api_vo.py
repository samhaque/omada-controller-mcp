...
T = TypeVar("T", bound="CustomRateLimitOpenApiVO")


@_attrs_define
class CustomRateLimitOpenApiVO:
    ...
    Attributes:
        ...
        down_limit (int | Unset): Downlink speed limit in Kbps. The value of limit should be within the range of
            0–10485760(Kbps).
        up_limit (int | Unset): Uplink speed limit in Kbps. The value of limit should be within the range of
            0–10485760(Kbps).
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        custom_rate_limit_open_api_vo = cls(
        ...
        custom_rate_limit_open_api_vo.additional_properties = d
        return custom_rate_limit_open_api_vo
