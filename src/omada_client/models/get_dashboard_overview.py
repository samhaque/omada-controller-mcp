...
class GetDashboardOverview:
    """
    Attributes:
        total_gateway_num (int | Unset): The total number of gateways
        connected_gateway_num (int | Unset): The number of connected gateways
        disconnected_gateway_num (int | Unset): The number of disconnected gateways
        net_capacity (int | Unset): Network Capacity measured in Mbps. Null means no value.
        net_usage (float | Unset): The current link usage rate under the Gateway node (percent conversion has been
            performed, such as 98.1)
        total_switch_num (int | Unset): Total number of switches
        connected_switch_num (int | Unset): Number of switches in connected state
        disconnected_switch_num (int | Unset): Number of switches in disconnected state
        total_ports (int | Unset): Total number of ports
        available_ports (int | Unset): Number of valid ports
        power_consumption (float | Unset): Power consumption (unit: W)
        total_ap_num (int | Unset): Total number of APs
        connected_ap_num (int | Unset): Number of APs in connected state
        isolated_ap_num (int | Unset): Number of APs in isolated state
        disconnected_ap_num (int | Unset): Number of APs in disconnected state
        total_client_num (int | Unset): Total number of clients
        wired_client_num (int | Unset): Number of wired clients
        wireless_client_num (int | Unset): Number of wireless clients
        guest_num (int | Unset): Number of wireless guest clients
    """

    total_gateway_num: int | Unset = UNSET
    connected_gateway_num: int | Unset = UNSET
    disconnected_gateway_num: int | Unset = UNSET
    net_capacity: int | Unset = UNSET
    net_usage: float | Unset = UNSET
    total_switch_num: int | Unset = UNSET
    connected_switch_num: int | Unset = UNSET
    disconnected_switch_num: int | Unset = UNSET
    total_ports: int | Unset = UNSET
    available_ports: int | Unset = UNSET
    power_consumption: float | Unset = UNSET
