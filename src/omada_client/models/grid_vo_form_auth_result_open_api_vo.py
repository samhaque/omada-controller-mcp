...
T = TypeVar("T", bound="GridVOFormAuthResultOpenApiVO")


@_attrs_define
class GridVOFormAuthResultOpenApiVO:
    """
    Attributes:
        ...
        data (list[FormAuthResultOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[FormAuthResultOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = FormAuthResultOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_form_auth_result_open_api_vo = cls(
        ...
        grid_vo_form_auth_result_open_api_vo.additional_properties = d
        return grid_vo_form_auth_result_open_api_vo
