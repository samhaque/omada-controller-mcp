...
def sync_detailed(
    ...
    *,
    ...
    """Delete an existing LAN profile
     ...
     Delete an existing LAN profile. If returns -33560, use "Query Agile Series switch that used the
    profile" to query these Agile Series switches.<br/><br/>The interface requires one of the
