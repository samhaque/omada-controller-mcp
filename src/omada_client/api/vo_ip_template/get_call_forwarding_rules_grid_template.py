...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/voip/call-forwarding/grid".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get siteTemplate's Call Forwarding list
     ...
     Get siteTemplate's Call Forwarding list.<br/><br/>The interface requires one of the permissions:
