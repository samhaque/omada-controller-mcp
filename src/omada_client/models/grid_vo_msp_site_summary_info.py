...
if TYPE_CHECKING:
    from ..models.msp_site_summary_info import MspSiteSummaryInfo


T = TypeVar("T", bound="GridVOMspSiteSummaryInfo")


@_attrs_define
class GridVOMspSiteSummaryInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = MspSiteSummaryInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_msp_site_summary_info = cls(
        ...
        grid_vo_msp_site_summary_info.additional_properties = d
        return grid_vo_msp_site_summary_info
