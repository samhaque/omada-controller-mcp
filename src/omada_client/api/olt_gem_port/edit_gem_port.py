...
from ...models.gem_port_modify_dto import GemPortModifyDTO
...
def _get_kwargs(
    ...
    line_profile_id: str,
    *,
    body: GemPortModifyDTO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/{line_profile_id}/gem-ports/edit".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify an existing gem port
     ...
     Modify an existing gem port<br/><br/>The interface requires one of the permissions: <br/>Site Device
