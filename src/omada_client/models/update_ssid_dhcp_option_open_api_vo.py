...
T = TypeVar("T", bound="UpdateSsidDhcpOptionOpenApiVO")


@_attrs_define
class UpdateSsidDhcpOptionOpenApiVO:
    """
    Attributes:
        dhcp_enable (bool): SSID DHCP Option 82 global config status. True: enable, false: disable.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_ssid_dhcp_option_open_api_vo = cls(
        ...
        update_ssid_dhcp_option_open_api_vo.additional_properties = d
        return update_ssid_dhcp_option_open_api_vo
