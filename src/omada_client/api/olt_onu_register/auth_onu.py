...
from ...models.onu_activation_config_dto import OnuActivationConfigDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    body: OnuActivationConfigDTO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/onu-register/autofind/onus/auth".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Authenticate ONU
     ...
     Authenticate ONU<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
