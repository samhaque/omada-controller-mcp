...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/radio-config".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify AP radio config
     ...
     Modify AP radio config<br/><br/>The interface requires one of the permissions: <br/>Site Device
