...
if TYPE_CHECKING:
    from ..models.msp_user_vo import MspUserVO


T = TypeVar("T", bound="GridVOMspUserVO")


@_attrs_define
class GridVOMspUserVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = MspUserVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_msp_user_vo = cls(
        ...
        grid_vo_msp_user_vo.additional_properties = d
        return grid_vo_msp_user_vo
