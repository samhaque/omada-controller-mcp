...
def _get_kwargs(
    ...
    *,
    ...
    sorts_create_time: str | Unset = UNSET,
    filters_time_start: int | Unset = UNSET,
    filters_time_end: int | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """Get Voucher Group List
     ...
     Get Voucher Group List with the given params.<br/><br/>The interface requires one of the
    ...
    Args:
        ...
        sorts_create_time (str | Unset):
        filters_time_start (int | Unset):
        filters_time_end (int | Unset):
