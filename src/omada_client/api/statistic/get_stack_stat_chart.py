...
from ...models.osw_stack_stat_query_open_api_dto import OswStackStatQueryOpenApiDTO
...
def _get_kwargs(
    ...
    stack_id: str,
    *,
    body: OswStackStatQueryOpenApiDTO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/stat/stack/{stack_id}/chart".format(
