...
if TYPE_CHECKING:
    ...
    from ..models.osw_lag_vo_tag_bridge_vlan_map import OswLagVOTagBridgeVlanMap
    from ..models.osw_lag_vo_untag_bridge_vlan_map import OswLagVOUntagBridgeVlanMap
...
class OswLagVO:
    ...
    Attributes:
        ...
        tag_bridge_vlan_map (OswLagVOTagBridgeVlanMap | Unset): Tag Network Bridge Vlan Map
        untag_network_ids (list[str] | Unset): Untag Network IDs
        untag_bridge_vlan_map (OswLagVOUntagBridgeVlanMap | Unset): Untag Network Bridge Vlan Map
    ...
    tag_bridge_vlan_map: OswLagVOTagBridgeVlanMap | Unset = UNSET
    untag_network_ids: list[str] | Unset = UNSET
    untag_bridge_vlan_map: OswLagVOUntagBridgeVlanMap | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.osw_band_ctrl_vo import OswBandCtrlVO
        from ..models.osw_lag_status_vo import OswLagStatusVO
        from ..models.osw_lag_vo_tag_bridge_vlan_map import (
            OswLagVOTagBridgeVlanMap,
        )
        from ..models.osw_lag_vo_untag_bridge_vlan_map import (
        ...
        tag_bridge_vlan_map: OswLagVOTagBridgeVlanMap | Unset
        if isinstance(_tag_bridge_vlan_map, Unset):
            tag_bridge_vlan_map = UNSET
        else:
            tag_bridge_vlan_map = OswLagVOTagBridgeVlanMap.from_dict(
        ...
        untag_bridge_vlan_map: OswLagVOUntagBridgeVlanMap | Unset
        if isinstance(_untag_bridge_vlan_map, Unset):
            untag_bridge_vlan_map = UNSET
        else:
            untag_bridge_vlan_map = OswLagVOUntagBridgeVlanMap.from_dict(
        ...
        osw_lag_vo.additional_properties = d
        return osw_lag_vo
