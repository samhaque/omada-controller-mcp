...
T = TypeVar("T", bound="GatewayQosServiceOpenApiVO")


@_attrs_define
class GatewayQosServiceOpenApiVO:
    """
    Attributes:
        name (str): The name of Gateway QoS Service should contain 1 to 64 characters.
        protocol (int): The protocol of Gateway QoS Service should be a value as follows: 0: TCP, 1: UDP, 2: TCP/UDP, 3:
            ICMP, 4: Other.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        gateway_qos_service_open_api_vo = cls(
            name=name,
            protocol=protocol,
        ...
        gateway_qos_service_open_api_vo.additional_properties = d
        return gateway_qos_service_open_api_vo
