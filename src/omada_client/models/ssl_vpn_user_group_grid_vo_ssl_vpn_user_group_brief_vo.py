...
if TYPE_CHECKING:
    from ..models.ssl_vpn_user_group_brief_vo import SslVpnUserGroupBriefVO


T = TypeVar("T", bound="SslVpnUserGroupGridVOSslVpnUserGroupBriefVO")


@_attrs_define
class SslVpnUserGroupGridVOSslVpnUserGroupBriefVO:
    """
    Attributes:
        ...
        data (list[SslVpnUserGroupBriefVO] | Unset):
    ...
    data: list[SslVpnUserGroupBriefVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.ssl_vpn_user_group_brief_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SslVpnUserGroupBriefVO.from_dict(data_item_data)
        ...
        ssl_vpn_user_group_grid_vo_ssl_vpn_user_group_brief_vo = cls(
        ...
        ssl_vpn_user_group_grid_vo_ssl_vpn_user_group_brief_vo.additional_properties = d
        return ssl_vpn_user_group_grid_vo_ssl_vpn_user_group_brief_vo
