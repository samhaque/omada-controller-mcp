...
if TYPE_CHECKING:
    from ..models.ap_override_audit_log_vo import ApOverrideAuditLogVO


T = TypeVar("T", bound="GridVOApOverrideAuditLogVO")


@_attrs_define
class GridVOApOverrideAuditLogVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.ap_override_audit_log_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ApOverrideAuditLogVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ap_override_audit_log_vo = cls(
        ...
        grid_vo_ap_override_audit_log_vo.additional_properties = d
        return grid_vo_ap_override_audit_log_vo
