...
if TYPE_CHECKING:
    from ..models.upgrade_failed_device_info import UpgradeFailedDeviceInfo


T = TypeVar("T", bound="GridVOUpgradeFailedDeviceInfo")


@_attrs_define
class GridVOUpgradeFailedDeviceInfo:
    """
    Attributes:
        ...
        data (list[UpgradeFailedDeviceInfo] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[UpgradeFailedDeviceInfo] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.upgrade_failed_device_info import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = UpgradeFailedDeviceInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_upgrade_failed_device_info = cls(
        ...
        grid_vo_upgrade_failed_device_info.additional_properties = d
        return grid_vo_upgrade_failed_device_info
