...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/profiles/radius".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create a new RADIUS profile template
     ...
     Create a new RADIUS profile template with the given params.<br/><br/>The interface requires one of
    ...
    space).<br/>-34004  -  This RADIUS profile already exists.<br/>-34011  -  Invalid IP address of the
    RADIUS server.<br/>-34011  -  Invalid IP address of the RADIUS server.<br/>-34014  -  The number of
    RADIUS profiles has reached the limit.
