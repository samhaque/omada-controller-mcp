...
if TYPE_CHECKING:
    from ..models.client_history_info import ClientHistoryInfo


T = TypeVar("T", bound="GridVOClientHistoryInfo")


@_attrs_define
class GridVOClientHistoryInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ClientHistoryInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_client_history_info = cls(
        ...
        grid_vo_client_history_info.additional_properties = d
        return grid_vo_client_history_info
