...
T = TypeVar("T", bound="GatewayPortConfig")


@_attrs_define
class GatewayPortConfig:
    """gateway port config entity

    Attributes:
        port (int): Port serial number
        ...
        mirror_mode (int | Unset): Port mirror mode should be a value as follows: 0: ingress; 1: egress; 2: ingress and
            egress
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        gateway_port_config.additional_properties = d
        return gateway_port_config
