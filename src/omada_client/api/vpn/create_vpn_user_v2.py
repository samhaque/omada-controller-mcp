...
def sync_detailed(
    ...
    *,
    ...
    """Create VPN user V2
     ...
     Create VPN user. This interface has been deprecated. Please use the following interfaces instead:
    Create VPN user V3. This interface had been deprecated.<br/><br/>The interface requires one of the
