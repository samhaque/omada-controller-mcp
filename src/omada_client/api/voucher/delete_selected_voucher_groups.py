...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/hotspot/voucher-groups/batch/delete".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete selected Voucher Groups
     ...
     Delete selected Voucher Groups with the given params.<br/><br/>The interface requires one of the
