...
T = TypeVar("T", bound="SwitchACLConfig")


@_attrs_define
class SwitchACLConfig:
    """
    Attributes:
        ...
        bi_directional (bool | Unset): Whether to enable the bidirectional, this field required only when creating a new
            entry
    """
    ...
    bi_directional: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if bi_directional is not UNSET:
            field_dict["biDirectional"] = bi_directional
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        bi_directional = d.pop("biDirectional", UNSET)

        switch_acl_config = cls(
            description=description,
            status=status,
            policy=policy,
            protocols=protocols,
        ...
        switch_acl_config.additional_properties = d
        return switch_acl_config
