...
T = TypeVar("T", bound="AnomalyCauseVODevices")


@_attrs_define
class AnomalyCauseVODevices:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        anomaly_cause_vo_devices.additional_properties = additional_properties
        return anomaly_cause_vo_devices
