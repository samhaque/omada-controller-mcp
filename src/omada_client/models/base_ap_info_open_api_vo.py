...
T = TypeVar("T", bound="BaseApInfoOpenApiVO")


@_attrs_define
class BaseApInfoOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        base_ap_info_open_api_vo.additional_properties = d
        return base_ap_info_open_api_vo
