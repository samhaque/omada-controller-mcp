...
T = TypeVar("T", bound="GatewayCustomACLInfoEntity")


@_attrs_define
class GatewayCustomACLInfoEntity:
    """
    Attributes:
        ...
        hit_counts (int | Unset): Show custom ACL hit counts.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        gateway_custom_acl_info_entity = cls(
            id=id,
            index=index,
            status=status,
            description=description,
        ...
        gateway_custom_acl_info_entity.additional_properties = d
        return gateway_custom_acl_info_entity
