...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/full-channel-detect/channel-load".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get channel utilization results of interference detection
     ...
     Get channel utilization results of interference detection<br/><br/>The interface requires one of the
