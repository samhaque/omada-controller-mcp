...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/stacks/{stack_id}/staticRoutings/{static_routing_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify stack staticRouting
     ...
     Modify stack staticRouting.<br/><br/>The interface requires one of the permissions: <br/>Site Device
