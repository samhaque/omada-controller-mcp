...
if TYPE_CHECKING:
    from ..models.external_user_group_detail_open_api_vo import (
        ExternalUserGroupDetailOpenApiVO,
    )


T = TypeVar("T", bound="GridVOExternalUserGroupDetailOpenApiVO")


@_attrs_define
class GridVOExternalUserGroupDetailOpenApiVO:
    """
    Attributes:
        ...
        data (list[ExternalUserGroupDetailOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[ExternalUserGroupDetailOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ExternalUserGroupDetailOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_external_user_group_detail_open_api_vo = cls(
        ...
        grid_vo_external_user_group_detail_open_api_vo.additional_properties = d
        return grid_vo_external_user_group_detail_open_api_vo
