...
if TYPE_CHECKING:
    from ..models.device_telephone_number import DeviceTelephoneNumber


T = TypeVar("T", bound="GridVODeviceTelephoneNumber")


@_attrs_define
class GridVODeviceTelephoneNumber:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.device_telephone_number import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = DeviceTelephoneNumber.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_device_telephone_number = cls(
        ...
        grid_vo_device_telephone_number.additional_properties = d
        return grid_vo_device_telephone_number
