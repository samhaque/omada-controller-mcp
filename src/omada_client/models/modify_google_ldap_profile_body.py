...
T = TypeVar("T", bound="ModifyGoogleLdapProfileBody")


@_attrs_define
class ModifyGoogleLdapProfileBody:
    """
    Attributes:
        ...
        file (File | Unset): Google LDAP certificate file.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        modify_google_ldap_profile_body = cls(
            config=config,
            file=file,
        )

        modify_google_ldap_profile_body.additional_properties = d
        return modify_google_ldap_profile_body
