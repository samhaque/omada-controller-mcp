...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/grid/bridge-devices/pending".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Bridge group ungrouped devices
     ...
     Get Bridge group ungrouped devices.<br/><br/>The interface requires one of the permissions:
