...
from ...models.stack_lag_setting_vo import StackLagSettingVO
...
def _get_kwargs(
    ...
    lag_id: str,
    *,
    body: StackLagSettingVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v2/{omadac_id}/sites/{site_id}/stacks/{stack_id}/lags/{lag_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify stack lag V2
     ...
     Modify stack lag V2.<br/><br/>The interface requires one of the permissions: <br/>Site Device
