...
if TYPE_CHECKING:
    from ..models.speed_test_v2_result_item_open_api_vo import (
        SpeedTestV2ResultItemOpenApiVO,
    )


T = TypeVar("T", bound="GridVOSpeedTestV2ResultItemOpenApiVO")


@_attrs_define
class GridVOSpeedTestV2ResultItemOpenApiVO:
    """
    Attributes:
        ...
        data (list[SpeedTestV2ResultItemOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[SpeedTestV2ResultItemOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SpeedTestV2ResultItemOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_speed_test_v2_result_item_open_api_vo = cls(
        ...
        grid_vo_speed_test_v2_result_item_open_api_vo.additional_properties = d
        return grid_vo_speed_test_v2_result_item_open_api_vo
