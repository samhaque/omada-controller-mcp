...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v2/{omadac_id}/sites/{site_id}/lan-networks/isolate/interfaces".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get interface List
     ...
     Get interface List.<br/><br/>The interface requires one of the permissions: <br/>Site Settings
