...
if TYPE_CHECKING:
    from ..models.eap_acl_info import EapACLInfo


T = TypeVar("T", bound="GridVOEapACLInfo")


@_attrs_define
class GridVOEapACLInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = EapACLInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_eap_acl_info = cls(
        ...
        grid_vo_eap_acl_info.additional_properties = d
        return grid_vo_eap_acl_info
