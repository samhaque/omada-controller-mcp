...
from ...models.update_ssid_enable_status_open_api_vo import (
...
def _get_kwargs(
    ...
    ssid_id: str,
    *,
    body: UpdateSsidEnableStatusOpenApiVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/wireless-network/ssids/{ssid_id}/enable".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update SSID Template Enable Status
     ...
     Update SSID Template Enable Status<br/><br/>The interface requires one of the permissions: <br/>Site
