...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/setting/service/dns-cache".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify DNS cache setting
     ...
     Modify DNS cache setting<br/><br/>The interface requires one of the permissions: <br/>Global Site
