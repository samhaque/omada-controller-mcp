...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/gatewaytemplates/{device_template_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get gateway template info
     ...
     Get gateway template info<br/><br/>The interface requires one of the permissions: <br/>Global Site
