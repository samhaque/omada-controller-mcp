...
T = TypeVar("T", bound="MulticastExceptDeviceVO")


@_attrs_define
class MulticastExceptDeviceVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        multicast_except_device_vo = cls(
            stack_id=stack_id,
        ...
        multicast_except_device_vo.additional_properties = d
        return multicast_except_device_vo
