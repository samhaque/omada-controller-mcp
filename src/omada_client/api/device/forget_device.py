...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/devices/{device_mac}/forget".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Forget device
     ...
     Forget device.<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
    Modify<br/>MSP Device Manager Modify<br/><br/>The possible error code for the interface in the
