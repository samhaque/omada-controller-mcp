...
if TYPE_CHECKING:
    from ..models.candidate_parent_for_adopt_open_api_vo import (
        CandidateParentForAdoptOpenApiVO,
    )


T = TypeVar("T", bound="GridVOCandidateParentForAdoptOpenApiVO")


@_attrs_define
class GridVOCandidateParentForAdoptOpenApiVO:
    """
    Attributes:
        ...
        data (list[CandidateParentForAdoptOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[CandidateParentForAdoptOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = CandidateParentForAdoptOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_candidate_parent_for_adopt_open_api_vo = cls(
        ...
        grid_vo_candidate_parent_for_adopt_open_api_vo.additional_properties = d
        return grid_vo_candidate_parent_for_adopt_open_api_vo
