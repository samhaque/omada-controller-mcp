...
def sync_detailed(
    ...
    *,
    ...
    """Get group profile list
     ...
     Get group profile list of the site with the given omadacId and siteId.<br/><br/>The interface
    requires one of the permissions: <br/>Site Settings Manager View Only<br/>Network Config Page View
    Only<br/>Site Device Manager View Only<br/>Device Config Page View Only<br/><br/>The possible error
