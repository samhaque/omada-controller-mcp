...
T = TypeVar("T", bound="StaticRoutingConfigTemplate")


@_attrs_define
class StaticRoutingConfigTemplate:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        static_routing_config_template = cls(
            name=name,
            status=status,
            destinations=destinations,
        ...
        static_routing_config_template.additional_properties = d
        return static_routing_config_template
