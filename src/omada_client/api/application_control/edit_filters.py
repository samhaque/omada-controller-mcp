...
def sync_detailed(
    ...
    *,
    ...
    """Modify an existing filter
     ...
     Modify an existing filter.<br/><br/>The interface requires one of the permissions: <br/>Site
    ...
    generic error codes): <br/>-35103  -  Rules should not be empty.<br/>-35104  -  Filter name already
