...
if TYPE_CHECKING:
    from ..models.ap_wifi_interference_result import ApWifiInterferenceResult


T = TypeVar("T", bound="GridVOApWifiInterferenceResult")


@_attrs_define
class GridVOApWifiInterferenceResult:
    """
    Attributes:
        ...
        data (list[ApWifiInterferenceResult] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[ApWifiInterferenceResult] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.ap_wifi_interference_result import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ApWifiInterferenceResult.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ap_wifi_interference_result = cls(
        ...
        grid_vo_ap_wifi_interference_result.additional_properties = d
        return grid_vo_ap_wifi_interference_result
