...
T = TypeVar("T", bound="ApRssiThresholdVO")


@_attrs_define
class ApRssiThresholdVO:
    """
    Attributes:
        rssi_enable (bool | Unset):
        threshold (int | Unset):
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ap_rssi_threshold_vo = cls(
            rssi_enable=rssi_enable,
            threshold=threshold,
        )

        ap_rssi_threshold_vo.additional_properties = d
        return ap_rssi_threshold_vo
