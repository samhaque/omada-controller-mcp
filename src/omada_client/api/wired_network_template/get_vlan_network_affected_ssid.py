...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/networks/{network_id}/vlan/{vlan}/ssids".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get grid ssid template list that use the vlan
     ...
     Get grid ssid template list that use the vlan<br/><br/>The interface requires one of the
