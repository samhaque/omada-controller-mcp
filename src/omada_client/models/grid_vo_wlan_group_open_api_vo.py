...
T = TypeVar("T", bound="GridVOWlanGroupOpenApiVO")


@_attrs_define
class GridVOWlanGroupOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = WlanGroupOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_wlan_group_open_api_vo = cls(
        ...
        grid_vo_wlan_group_open_api_vo.additional_properties = d
        return grid_vo_wlan_group_open_api_vo
