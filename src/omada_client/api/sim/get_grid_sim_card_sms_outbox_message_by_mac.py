...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/gateways/{gateway_mac}/sim/sms/outbox/{sim_card}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get one of Dual-SIM card's SMS outbox message by mac
     ...
     Get SMS outbox message by mac.<br/><br/>The interface requires one of the permissions: <br/>Site
