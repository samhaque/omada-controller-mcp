...
T = TypeVar("T", bound="SelectStackMemberPortForVlanVO")


@_attrs_define
class SelectStackMemberPortForVlanVO:
    """Ports
    ...
    Attributes:
        ...
        port_id (str | Unset): ID, for example: "1/0/1"
        id (int | Unset): port number, for example: 1
        type_ (int | Unset): Type. 1: Copper, 2: Combo, 3: SFP
        config_stack (bool | Unset): Whether the port is configured as a stack port.
        mad_enable (bool | Unset):
        lag_id (int | Unset): Lag ID. It indicates the lag id of the port when the port is in a lag.
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if mad_enable is not UNSET:
            field_dict["madEnable"] = mad_enable
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        mad_enable = d.pop("madEnable", UNSET)

        lag_id = d.pop("lagId", UNSET)

        select_stack_member_port_for_vlan_vo = cls(
            name=name,
            enable=enable,
            ...
            mad_enable=mad_enable,
            lag_id=lag_id,
        )

        select_stack_member_port_for_vlan_vo.additional_properties = d
        return select_stack_member_port_for_vlan_vo
