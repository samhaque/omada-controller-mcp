...
T = TypeVar("T", bound="AnomalyBriefCountVOCauses")


@_attrs_define
class AnomalyBriefCountVOCauses:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        anomaly_brief_count_vo_causes = cls()
        ...
        anomaly_brief_count_vo_causes.additional_properties = additional_properties
        return anomaly_brief_count_vo_causes
