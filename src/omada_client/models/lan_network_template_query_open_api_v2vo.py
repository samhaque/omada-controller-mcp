...
T = TypeVar("T", bound="LanNetworkTemplateQueryOpenApiV2VO")


@_attrs_define
class LanNetworkTemplateQueryOpenApiV2VO:
    """
    Attributes:
        ...
        dhcp_settings_vo (DhcpSettingsTemplateOpenApiVO | Unset): Configure DHCP settings
    ...
    dhcp_settings_vo: DhcpSettingsTemplateOpenApiVO | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dhcp_settings_vo: DhcpSettingsTemplateOpenApiVO | Unset
        if isinstance(_dhcp_settings_vo, Unset):
            dhcp_settings_vo = UNSET
        else:
            dhcp_settings_vo = DhcpSettingsTemplateOpenApiVO.from_dict(
                _dhcp_settings_vo
            )
        ...
        lan_network_template_query_open_api_v2vo = cls(
            name=name,
            purpose=purpose,
        ...
        lan_network_template_query_open_api_v2vo.additional_properties = d
        return lan_network_template_query_open_api_v2vo
