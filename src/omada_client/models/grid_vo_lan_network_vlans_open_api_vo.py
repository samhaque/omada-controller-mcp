...
if TYPE_CHECKING:
    from ..models.lan_network_vlans_open_api_vo import LanNetworkVlansOpenApiVO


T = TypeVar("T", bound="GridVOLanNetworkVlansOpenApiVO")


@_attrs_define
class GridVOLanNetworkVlansOpenApiVO:
    """
    Attributes:
        ...
        data (list[LanNetworkVlansOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[LanNetworkVlansOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.lan_network_vlans_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = LanNetworkVlansOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_lan_network_vlans_open_api_vo = cls(
        ...
        grid_vo_lan_network_vlans_open_api_vo.additional_properties = d
        return grid_vo_lan_network_vlans_open_api_vo
