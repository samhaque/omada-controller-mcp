...
T = TypeVar("T", bound="DhcpSettingConfig")


@_attrs_define
class DhcpSettingConfig:
    ...
    Attributes:
        ...
        ip_range_pool (list[DhcpRangeOpenApiVO] | Unset): The list of DHCP Range, which size can't be more than
            "dhcpRangePoolSize", "dhcpRangePoolSize" can be obtained from 'Get LAN network list' interface.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dhcp_setting_config.additional_properties = d
        return dhcp_setting_config
