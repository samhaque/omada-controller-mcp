...
T = TypeVar("T", bound="PageResponseStatisticInfoDTO")


@_attrs_define
class PageResponseStatisticInfoDTO:
    """
    Attributes:
        content (list[StatisticInfoDTO] | Unset): Content
    ...
    content: list[StatisticInfoDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = StatisticInfoDTO.from_dict(content_item_data)
        ...
        page_response_statistic_info_dto = cls(
            content=content,
        ...
        page_response_statistic_info_dto.additional_properties = d
        return page_response_statistic_info_dto
