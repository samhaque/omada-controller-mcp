...
if TYPE_CHECKING:
    from ..models.controller_user_app_vo import ControllerUserAppVO


T = TypeVar("T", bound="GridVOControllerUserAppVO")


@_attrs_define
class GridVOControllerUserAppVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ControllerUserAppVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_controller_user_app_vo = cls(
        ...
        grid_vo_controller_user_app_vo.additional_properties = d
        return grid_vo_controller_user_app_vo
