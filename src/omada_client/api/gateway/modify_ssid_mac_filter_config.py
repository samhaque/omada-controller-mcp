...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/gateways/{gateway_mac}/config/wlans/ssid/{ssid_id}/mac-filter".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update SSID mac filter config
     ...
     Update SSID MAC filter config<br/><br/>The interface requires one of the permissions: <br/>Site
