...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/setting/voip/grid/provider-profiles".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get the grid of provider profile list template
     ...
     Get the grid of provider profile list template.<br/><br/>The interface requires one of the
