...
T = TypeVar("T", bound="TcontPageQueryDTO")


@_attrs_define
class TcontPageQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        tcont_page_query_dto.additional_properties = d
        return tcont_page_query_dto
