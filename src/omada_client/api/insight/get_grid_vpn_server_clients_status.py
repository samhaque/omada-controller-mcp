...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/setting/vpn/stats/server/{vpn_id}/client".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get VPN Server's clients status list
     ...
     Get VPN Server's clients status list by VPN ID.<br/><br/>The interface requires one of the
