...
def _get_kwargs(
    ...
    *,
    ...
    sorts_left_lock_time: str | Unset = UNSET,
) -> dict[str, Any]:
    ...
    params["sorts.leftLockTime"] = sorts_left_lock_time

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/vpn/ssl-vpn-server/locked-users".format(
...
def sync_detailed(
    ...
    *,
    ...
    codes): <br/>-43008  -  The current gateway model or firmware version does not support SSL VPN
    configuration.
    ...
    Args:
        ...
        sorts_ip (str | Unset):
        sorts_left_lock_time (str | Unset):
    ...
    kwargs = _get_kwargs(
        ...
        sorts_ip=sorts_ip,
        sorts_left_lock_time=sorts_left_lock_time,
    )
