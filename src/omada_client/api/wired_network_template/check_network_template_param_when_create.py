...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/networks/param-check".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Check basic parameters when creating network template
     ...
     Check basic parameters when creating network template<br/><br/>The interface requires one of the
