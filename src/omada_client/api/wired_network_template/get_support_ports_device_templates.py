...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/devicetemplates/support-ports".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get grid devices templates that support ports config.
     ...
     Get grid devices templates that support ports config.<br/><br/>The interface requires one of the
