...
if TYPE_CHECKING:
    ...
    from ..models.osw_down_link_client_vo import OswDownLinkClientVO
...
T = TypeVar("T", bound="OswDetailForPortsViewVO")


@_attrs_define
class OswDetailForPortsViewVO:
    """
    Attributes:
        ...
        client_list (list[OswDownLinkClientVO] | Unset): Downlink Client device list
        support_clear_counters (bool | Unset): Clear Counters Support
    ...
    client_list: list[OswDownLinkClientVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        from ..models.osw_down_link_client_vo import (
            OswDownLinkClientVO,
        )
        from ..models.osw_downlink_vo import OswDownlinkVO
        from ..models.osw_uplink_vo import OswUplinkVO
        ...
        if _client_list is not UNSET:
            ...
            for client_list_item_data in _client_list:
                client_list_item = OswDownLinkClientVO.from_dict(client_list_item_data)
        ...
        osw_detail_for_ports_view_vo = cls(
            type_=type_,
            mac=mac,
            name=name,
            model=model,
        ...
        osw_detail_for_ports_view_vo.additional_properties = d
        return osw_detail_for_ports_view_vo
