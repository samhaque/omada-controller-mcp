...
T = TypeVar("T", bound="OswPortsSettingOverviewVO")


@_attrs_define
class OswPortsSettingOverviewVO:
    """
    Attributes:
        port (int | Unset): Port
        ...
        profile_type (int | Unset): Lan Profile Type
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osw_ports_setting_overview_vo = cls(
            port=port,
        ...
        osw_ports_setting_overview_vo.additional_properties = d
        return osw_ports_setting_overview_vo
