...
if TYPE_CHECKING:
    from ..models.topology_device_client import TopologyDeviceClient


T = TypeVar("T", bound="GridVOTopologyDeviceClient")


@_attrs_define
class GridVOTopologyDeviceClient:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.topology_device_client import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = TopologyDeviceClient.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_topology_device_client = cls(
        ...
        grid_vo_topology_device_client.additional_properties = d
        return grid_vo_topology_device_client
