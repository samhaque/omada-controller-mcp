...
if TYPE_CHECKING:
    from ..models.topology_client_uplink_port import TopologyClientUplinkPort
    from ..models.wired_port_v3dto import WiredPortV3DTO


T = TypeVar("T", bound="TopologyClientWiredUpInfo")


@_attrs_define
class TopologyClientWiredUpInfo:
    """Client uplink information while connection is wired.

    Attributes:
        port (TopologyClientUplinkPort | Unset): Uplink port information while connection is wired.
    ...
    port: TopologyClientUplinkPort | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.topology_client_uplink_port import (
        ...
        port: TopologyClientUplinkPort | Unset
        if isinstance(_port, Unset):
            port = UNSET
        else:
            port = TopologyClientUplinkPort.from_dict(_port)
        ...
        topology_client_wired_up_info = cls(
            port=port,
        ...
        topology_client_wired_up_info.additional_properties = d
        return topology_client_wired_up_info
