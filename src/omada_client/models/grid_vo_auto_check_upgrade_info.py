...
if TYPE_CHECKING:
    from ..models.auto_check_upgrade_info import AutoCheckUpgradeInfo


T = TypeVar("T", bound="GridVOAutoCheckUpgradeInfo")


@_attrs_define
class GridVOAutoCheckUpgradeInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.auto_check_upgrade_info import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = AutoCheckUpgradeInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_auto_check_upgrade_info = cls(
        ...
        grid_vo_auto_check_upgrade_info.additional_properties = d
        return grid_vo_auto_check_upgrade_info
