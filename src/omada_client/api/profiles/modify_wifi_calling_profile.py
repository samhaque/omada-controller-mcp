...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/profiles/wifi-calling/{profile_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify a wifi calling profile
     ...
     Modify a wifi calling profile with the given params.<br/><br/>The interface requires one of the
    ...
    later.<br/>-44900  -  The Wi-Fi calling profile already exists.<br/>-44901  -  The number of ePDGs
