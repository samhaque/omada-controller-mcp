...
if TYPE_CHECKING:
    ...
    from ..models.dhcp_settings_config_template_open_api_vo import (
...
T = TypeVar("T", bound="LanNetworkTemplateOpenApiVO")


@_attrs_define
class LanNetworkTemplateOpenApiVO:
    ...
    Attributes:
        ...
        interface_ids (list[str] | Unset): Gateway LAN port IDs, which are acquired from "Check WAN/LAN status"
        ...
        dhcp_settings_vo (DhcpSettingsConfigTemplateOpenApiVO | Unset): Configure DHCP settings
    ...
    dhcp_settings_vo: DhcpSettingsConfigTemplateOpenApiVO | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dhcp_settings_vo: DhcpSettingsConfigTemplateOpenApiVO | Unset
        if isinstance(_dhcp_settings_vo, Unset):
            dhcp_settings_vo = UNSET
        else:
            dhcp_settings_vo = DhcpSettingsConfigTemplateOpenApiVO.from_dict(
                _dhcp_settings_vo
            )
        ...
        lan_network_template_open_api_vo = cls(
            name=name,
            purpose=purpose,
        ...
        lan_network_template_open_api_vo.additional_properties = d
        return lan_network_template_open_api_vo
