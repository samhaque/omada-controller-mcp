...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/devices/stat".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Query the statistics for the list of global adopted devices.
     ...
     Query the statistics for the list of global adopted devices.<br/><br/>The interface requires one of
    the permissions: <br/>Site Device Manager View Only<br/>MSP Device Manager View Only
