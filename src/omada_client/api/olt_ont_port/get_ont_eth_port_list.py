...
from ...models.ont_eth_port_list_query_dto import OntEthPortListQueryDTO
...
def _get_kwargs(
    ...
    service_id: str,
    *,
    query_param: OntEthPortListQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/service/{service_id}/eth-ports/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ont eth port list
     ...
     Get ont eth port list<br/><br/>The interface requires one of the permissions: <br/>Site Device
