...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/stack/{stack_id}/loopback-interface".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create Stack Loopback Interface
     ...
     Create Stack Loopback Interface.<br/><br/>The interface requires one of the permissions: <br/>Site
