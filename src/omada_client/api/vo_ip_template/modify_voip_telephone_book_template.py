...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/voip/telephone-book/{contact_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify an existing Contact Person in siteTemplate
     ...
     Modify an existing Contact Person in siteTemplate.<br/><br/>The interface requires one of the
