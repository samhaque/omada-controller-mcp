...
if TYPE_CHECKING:
    from ..models.plan_upgrade_model_list import PlanUpgradeModelList


T = TypeVar("T", bound="GridVOPlanUpgradeModelList")


@_attrs_define
class GridVOPlanUpgradeModelList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.plan_upgrade_model_list import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = PlanUpgradeModelList.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_plan_upgrade_model_list = cls(
        ...
        grid_vo_plan_upgrade_model_list.additional_properties = d
        return grid_vo_plan_upgrade_model_list
