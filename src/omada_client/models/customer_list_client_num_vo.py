...
T = TypeVar("T", bound="CustomerListClientNumVO")


@_attrs_define
class CustomerListClientNumVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        customer_list_client_num_vo = cls(
        ...
        customer_list_client_num_vo.additional_properties = d
        return customer_list_client_num_vo
