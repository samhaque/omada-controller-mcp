...
if TYPE_CHECKING:
    from ..models.usb_lte_setting_config_open_api_vo import UsbLteSettingConfigOpenApiVO
    from ..models.wan_port_setting_open_api_vo import WanPortSettingOpenApiVO


T = TypeVar("T", bound="WanSettingConfigOpenApiVO")


@_attrs_define
class WanSettingConfigOpenApiVO:
    """
    Attributes:
        wan_ports_config (list[WanPortSettingOpenApiVO] | Unset): WAN ports config
        usb_ports_config (list[UsbLteSettingConfigOpenApiVO] | Unset): USB LTE ports config
    """

    wan_ports_config: list[WanPortSettingOpenApiVO] | Unset = UNSET
    usb_ports_config: list[UsbLteSettingConfigOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.usb_lte_setting_config_open_api_vo import (
        ...
        if _usb_ports_config is not UNSET:
            ...
            for usb_ports_config_item_data in _usb_ports_config:
                usb_ports_config_item = UsbLteSettingConfigOpenApiVO.from_dict(
                    usb_ports_config_item_data
                )

                usb_ports_config.append(usb_ports_config_item)

        wan_setting_config_open_api_vo = cls(
            wan_ports_config=wan_ports_config,
            usb_ports_config=usb_ports_config,
        )

        wan_setting_config_open_api_vo.additional_properties = d
        return wan_setting_config_open_api_vo
