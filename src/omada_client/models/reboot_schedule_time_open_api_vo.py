...
T = TypeVar("T", bound="RebootScheduleTimeOpenApiVO")


@_attrs_define
class RebootScheduleTimeOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        reboot_schedule_time_open_api_vo = cls(
        ...
        reboot_schedule_time_open_api_vo.additional_properties = d
        return reboot_schedule_time_open_api_vo
