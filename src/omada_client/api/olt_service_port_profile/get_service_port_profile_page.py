...
from ...models.service_port_profile_page_query_dto import ServicePortProfilePageQueryDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: ServicePortProfilePageQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/service-port/profiles/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get service port profile page
     ...
     Get service port profile page<br/><br/>The interface requires one of the permissions: <br/>MSP
