...
T = TypeVar("T", bound="RemoteLogSettingOpenApiVO")


@_attrs_define
class RemoteLogSettingOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        remote_log_setting_open_api_vo = cls(
            enable=enable,
            host=host,
            port=port,
        ...
        remote_log_setting_open_api_vo.additional_properties = d
        return remote_log_setting_open_api_vo
