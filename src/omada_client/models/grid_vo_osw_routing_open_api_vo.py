...
if TYPE_CHECKING:
    from ..models.osw_routing_open_api_vo import OswRoutingOpenApiVO


T = TypeVar("T", bound="GridVOOswRoutingOpenApiVO")


@_attrs_define
class GridVOOswRoutingOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.osw_routing_open_api_vo import (
            OswRoutingOpenApiVO,
        )
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswRoutingOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osw_routing_open_api_vo = cls(
        ...
        grid_vo_osw_routing_open_api_vo.additional_properties = d
        return grid_vo_osw_routing_open_api_vo
