...
if TYPE_CHECKING:
    ...
    from ..models.client_traffic_with_application_detail import (
        ClientTrafficWithApplicationDetail,
    )


T = TypeVar("T", bound="ClientTrafficGridVOClientTrafficWithApplicationDetail")


@_attrs_define
class ClientTrafficGridVOClientTrafficWithApplicationDetail:
    """
    Attributes:
        ...
        data (list[ClientTrafficWithApplicationDetail] | Unset):
    ...
    data: list[ClientTrafficWithApplicationDetail] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ClientTrafficWithApplicationDetail.from_dict(data_item_data)
        ...
        client_traffic_grid_vo_client_traffic_with_application_detail = cls(
        ...
        client_traffic_grid_vo_client_traffic_with_application_detail.additional_properties = d
        return client_traffic_grid_vo_client_traffic_with_application_detail
