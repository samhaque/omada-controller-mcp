...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/gateways/{gateway_mac}/config/advanced/wireless".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify gateway advanced wireless config
     ...
     Modify gateway advanced wireless config<br/><br/>The interface requires one of the permissions:
