...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/msp/{msp_id}/customers/{customer_id}/sites/{site_id}/eaps/{ap_mac}/health/timeline".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get msp ap health time line
     ...
     Get msp ap health time line<br/><br/>The interface requires one of the permissions: <br/>MSP Device
