...
if TYPE_CHECKING:
    from ..models.lan_profile_info_open_api_vo import LanProfileInfoOpenApiVO


T = TypeVar("T", bound="GridVOLanProfileInfoOpenApiVO")


@_attrs_define
class GridVOLanProfileInfoOpenApiVO:
    """
    Attributes:
        ...
        data (list[LanProfileInfoOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[LanProfileInfoOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.lan_profile_info_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = LanProfileInfoOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_lan_profile_info_open_api_vo = cls(
        ...
        grid_vo_lan_profile_info_open_api_vo.additional_properties = d
        return grid_vo_lan_profile_info_open_api_vo
