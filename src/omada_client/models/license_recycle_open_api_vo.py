...
T = TypeVar("T", bound="LicenseRecycleOpenApiVO")


@_attrs_define
class LicenseRecycleOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        license_recycle_open_api_vo = cls(
            customer_id=customer_id,
            license_num=license_num,
            others=others,
        )

        license_recycle_open_api_vo.additional_properties = d
        return license_recycle_open_api_vo
