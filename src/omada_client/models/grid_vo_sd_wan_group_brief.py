...
if TYPE_CHECKING:
    from ..models.sd_wan_group_brief import SdWanGroupBrief


T = TypeVar("T", bound="GridVOSdWanGroupBrief")


@_attrs_define
class GridVOSdWanGroupBrief:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SdWanGroupBrief.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_sd_wan_group_brief = cls(
        ...
        grid_vo_sd_wan_group_brief.additional_properties = d
        return grid_vo_sd_wan_group_brief
