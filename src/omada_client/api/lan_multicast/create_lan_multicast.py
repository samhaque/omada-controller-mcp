...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/lan-multicasts".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create new lan multicast
     ...
     Create new lan multicast<br/><br/>The interface requires one of the permissions: <br/>Site Settings
