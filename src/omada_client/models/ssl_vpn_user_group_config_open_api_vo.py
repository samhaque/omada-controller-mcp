...
T = TypeVar("T", bound="SslVpnUserGroupConfigOpenApiVO")


@_attrs_define
class SslVpnUserGroupConfigOpenApiVO:
    """
    Attributes:
        name (str): Name of the SSL VPN user group should contain 1 to 20 characters.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ssl_vpn_user_group_config_open_api_vo = cls(
            name=name,
        ...
        ssl_vpn_user_group_config_open_api_vo.additional_properties = d
        return ssl_vpn_user_group_config_open_api_vo
