...
if TYPE_CHECKING:
    from ..models.un_known_multicast_except_device_vo import (
        UnKnownMulticastExceptDeviceVO,
    )


T = TypeVar("T", bound="UnknownMulticastConfigVO")


@_attrs_define
class UnknownMulticastConfigVO:
    """UnknownMulticastConfigVO.

    Attributes:
        enable (bool | Unset): enable
        device_list (list[UnKnownMulticastExceptDeviceVO] | Unset): unknown multicast except device list
    """

    enable: bool | Unset = UNSET
    device_list: list[UnKnownMulticastExceptDeviceVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _device_list is not UNSET:
            ...
            for device_list_item_data in _device_list:
                device_list_item = UnKnownMulticastExceptDeviceVO.from_dict(
                    device_list_item_data
                )

                device_list.append(device_list_item)

        unknown_multicast_config_vo = cls(
            enable=enable,
            device_list=device_list,
        )

        unknown_multicast_config_vo.additional_properties = d
        return unknown_multicast_config_vo
