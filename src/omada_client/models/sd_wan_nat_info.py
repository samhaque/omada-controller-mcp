...
T = TypeVar("T", bound="SdWanNatInfo")
...
class SdWanNatInfo:
    ...
    Attributes:
        ...
        network_map_list (list[SdWanNetworkMap] | Unset): A list of the network map item
    """

    default_map_network_list: list[str] | Unset = UNSET
    custom_map_network_list: list[str] | Unset = UNSET
    network_map_list: list[SdWanNetworkMap] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _network_map_list is not UNSET:
            ...
            for network_map_list_item_data in _network_map_list:
                network_map_list_item = SdWanNetworkMap.from_dict(
        ...
        sd_wan_nat_info.additional_properties = d
        return sd_wan_nat_info
