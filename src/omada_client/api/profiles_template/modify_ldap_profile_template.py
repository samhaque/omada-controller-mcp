...
def sync_detailed(
    ...
    *,
    ...
    """Modify an exist LDAP profile template
     ...
     Modify an exist LDAP profile template with the given params.<br/><br/>The interface requires one of
    ...
    Please wait and try again later.<br/>-43404  -  Cannot delete the LDAP profile. It is being used in
