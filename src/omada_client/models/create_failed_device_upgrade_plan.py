...
T = TypeVar("T", bound="CreateFailedDeviceUpgradePlan")


@_attrs_define
class CreateFailedDeviceUpgradePlan:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_failed_device_upgrade_plan = cls(
            upgrade_id_list=upgrade_id_list,
        )

        create_failed_device_upgrade_plan.additional_properties = d
        return create_failed_device_upgrade_plan
