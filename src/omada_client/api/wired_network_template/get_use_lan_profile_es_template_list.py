...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/lan-profiles/{profile_id}/es".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Use LAN profile ES template list
     ...
     Get Use LAN profile ES template list.<br/><br/>The interface requires one of the permissions:
