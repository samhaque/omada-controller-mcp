...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/l3access".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get AP l3Access config
     ...
     Get AP l3Access config<br/><br/>The interface requires one of the permissions: <br/>Site Device
