...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/wireless-network/ssids/{ssid_id}/enable".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update SSID Enable Status by site
     ...
     Update SSID Enable Status by site<br/><br/>The interface requires one of the permissions: <br/>Site
