...
if TYPE_CHECKING:
    from ..models.oui_based_vlan_ap_query_open_api_vo import (
        OuiBasedVlanApQueryOpenApiVO,
    )


T = TypeVar("T", bound="GridVOOuiBasedVlanApQueryOpenApiVO")


@_attrs_define
class GridVOOuiBasedVlanApQueryOpenApiVO:
    """
    Attributes:
        ...
        data (list[OuiBasedVlanApQueryOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[OuiBasedVlanApQueryOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OuiBasedVlanApQueryOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_oui_based_vlan_ap_query_open_api_vo = cls(
        ...
        grid_vo_oui_based_vlan_ap_query_open_api_vo.additional_properties = d
        return grid_vo_oui_based_vlan_ap_query_open_api_vo
