...
if TYPE_CHECKING:
    from ..models.site_template_summary_vo import SiteTemplateSummaryVO


T = TypeVar("T", bound="GridVOSiteTemplateSummaryVO")


@_attrs_define
class GridVOSiteTemplateSummaryVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.site_template_summary_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SiteTemplateSummaryVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_site_template_summary_vo = cls(
        ...
        grid_vo_site_template_summary_vo.additional_properties = d
        return grid_vo_site_template_summary_vo
