...
T = TypeVar("T", bound="AirtimeFairnessSettingVO")


@_attrs_define
class AirtimeFairnessSettingVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        airtime_fairness_setting_vo = cls(
            enable2g=enable2g,
            enable5g=enable5g,
            enable6g=enable6g,
        )

        airtime_fairness_setting_vo.additional_properties = d
        return airtime_fairness_setting_vo
