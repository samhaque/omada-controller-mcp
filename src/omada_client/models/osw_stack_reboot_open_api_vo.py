...
T = TypeVar("T", bound="OswStackRebootOpenApiVO")


@_attrs_define
class OswStackRebootOpenApiVO:
    """
    Attributes:
        select_all (bool | Unset): Indicates whether to select the entire stack
        macs (list[str] | Unset): Selected Devices
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osw_stack_reboot_open_api_vo = cls(
            select_all=select_all,
            macs=macs,
        )

        osw_stack_reboot_open_api_vo.additional_properties = d
        return osw_stack_reboot_open_api_vo
