...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/switches/{switch_mac}/ports/{port}/profile-override".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Set profile-override for given port
     ...
     Set profile-override for given port.<br/><br/>The interface requires one of the permissions:
