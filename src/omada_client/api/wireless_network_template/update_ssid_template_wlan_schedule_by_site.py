...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/wireless-network/ssids/{ssid_id}/wlan-schedule".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update SSID Template WLAN schedule config by site
     ...
     Update SSID Template WLAN schedule config by site<br/><br/>The interface requires one of the
