...
T = TypeVar("T", bound="ActivePairOpenApiDTO")


@_attrs_define
class ActivePairOpenApiDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        active_pair_open_api_dto = cls(
            device_mac=device_mac,
            license_type=license_type,
            license_id=license_id,
        )

        active_pair_open_api_dto.additional_properties = d
        return active_pair_open_api_dto
