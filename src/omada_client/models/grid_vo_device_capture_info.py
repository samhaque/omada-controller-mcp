...
if TYPE_CHECKING:
    from ..models.device_capture_info import DeviceCaptureInfo


T = TypeVar("T", bound="GridVODeviceCaptureInfo")


@_attrs_define
class GridVODeviceCaptureInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = DeviceCaptureInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_device_capture_info = cls(
        ...
        grid_vo_device_capture_info.additional_properties = d
        return grid_vo_device_capture_info
