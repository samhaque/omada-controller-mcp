...
T = TypeVar("T", bound="OswVrrpDeviceOpenApiVO")


@_attrs_define
class OswVrrpDeviceOpenApiVO:
    ...
    Attributes:
        ...
        device_series_type (int | Unset): Device type.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osw_vrrp_device_open_api_vo = cls(
            name=name,
            mac=mac,
            priority=priority,
        ...
        osw_vrrp_device_open_api_vo.additional_properties = d
        return osw_vrrp_device_open_api_vo
