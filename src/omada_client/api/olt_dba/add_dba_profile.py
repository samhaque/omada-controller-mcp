...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/dba/profiles/add".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create new DBA profile
     ...
     Create new DBA profile<br/><br/>The interface requires one of the permissions: <br/>Site Device
