...
from ..models.service_port_modify_dto_admin_status import (
    ServicePortModifyDTOAdminStatus,
)
from ..models.service_port_modify_dto_ether_type import ServicePortModifyDTOEtherType
from ..models.service_port_modify_dto_statistic_performance import (
    ServicePortModifyDTOStatisticPerformance,
)
from ..models.service_port_modify_dto_tag_action import ServicePortModifyDTOTagAction
from ..types import UNSET, Unset

T = TypeVar("T", bound="ServicePortModifyDTO")


@_attrs_define
class ServicePortModifyDTO:
    """
    Attributes:
        index (int): Service port ID should be within the range of 1 to 8100
        onu_id (int): Onu ID should be within the range of 0 to 127
        admin_status (ServicePortModifyDTOAdminStatus): The enable status of the service flows matched by this Service
            Port. AdminStatus should be a value as follows: DISABLE,ENABLE. Default value: ENABLE.
        statistic_performance (ServicePortModifyDTOStatisticPerformance): The traffic statistics switch status for the
        ...
        tag_action (ServicePortModifyDTOTagAction | Unset): TagAction should be a value as
        ...
        ether_type (ServicePortModifyDTOEtherType | Unset): EtherType should be a value as
        ...
        description (str | Unset): Description of service port.Description should contain 1 to 32 characters including
            numbers, Upper and lower letters, -@_:/. .
    """

    index: int
    onu_id: int
    admin_status: ServicePortModifyDTOAdminStatus
    statistic_performance: ServicePortModifyDTOStatisticPerformance
    ...
    tag_action: ServicePortModifyDTOTagAction | Unset = UNSET
    inner_vlan: int | Unset = UNSET
    inner_vlan_priority: int | Unset = UNSET
    ether_type: ServicePortModifyDTOEtherType | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        admin_status = ServicePortModifyDTOAdminStatus(d.pop("adminStatus"))
        ...
        tag_action: ServicePortModifyDTOTagAction | Unset
        if isinstance(_tag_action, Unset):
            tag_action = UNSET
        else:
            tag_action = ServicePortModifyDTOTagAction(_tag_action)
        ...
        ether_type: ServicePortModifyDTOEtherType | Unset
        if isinstance(_ether_type, Unset):
            ether_type = UNSET
        else:
            ether_type = ServicePortModifyDTOEtherType(_ether_type)
        ...
        service_port_modify_dto.additional_properties = d
        return service_port_modify_dto
