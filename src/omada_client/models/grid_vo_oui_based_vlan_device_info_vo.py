...
if TYPE_CHECKING:
    from ..models.oui_based_vlan_device_info_vo import OuiBasedVlanDeviceInfoVO


T = TypeVar("T", bound="GridVOOuiBasedVlanDeviceInfoVO")


@_attrs_define
class GridVOOuiBasedVlanDeviceInfoVO:
    """
    Attributes:
        ...
        data (list[OuiBasedVlanDeviceInfoVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[OuiBasedVlanDeviceInfoVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.oui_based_vlan_device_info_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OuiBasedVlanDeviceInfoVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_oui_based_vlan_device_info_vo = cls(
        ...
        grid_vo_oui_based_vlan_device_info_vo.additional_properties = d
        return grid_vo_oui_based_vlan_device_info_vo
