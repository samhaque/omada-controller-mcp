...
T = TypeVar("T", bound="UpdateEoGreTunnelSettingOpenApiVO")


@_attrs_define
class UpdateEoGreTunnelSettingOpenApiVO:
    """
    Attributes:
        gre_enable (bool): EoGRE Tunnel global config status; True: enable, false: disable.
        tunnel_mtu (int): Maximum Transmission Unit. The value of parameter [tunnelMtu] should be between [850, 1500].
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update(
            {
                "greEnable": gre_enable,
                "tunnelMtu": tunnel_mtu,
            }
        )
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        gre_enable = d.pop("greEnable")

        tunnel_mtu = d.pop("tunnelMtu")
        ...
        update_eo_gre_tunnel_setting_open_api_vo = cls(
        ...
        update_eo_gre_tunnel_setting_open_api_vo.additional_properties = d
        return update_eo_gre_tunnel_setting_open_api_vo
