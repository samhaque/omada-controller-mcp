...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/vlan".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get AP vlan config
     ...
     Get AP vlan config. This interface has been deprecated. Please use the following interface instead:
