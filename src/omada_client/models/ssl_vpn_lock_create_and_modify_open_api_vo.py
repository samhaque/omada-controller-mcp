...
T = TypeVar("T", bound="SslVpnLockCreateAndModifyOpenApiVO")


@_attrs_define
class SslVpnLockCreateAndModifyOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ssl_vpn_lock_create_and_modify_open_api_vo = cls(
            type_=type_,
        ...
        ssl_vpn_lock_create_and_modify_open_api_vo.additional_properties = d
        return ssl_vpn_lock_create_and_modify_open_api_vo
