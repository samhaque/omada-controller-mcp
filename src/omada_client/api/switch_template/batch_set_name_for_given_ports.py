...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/switchtemplates/{device_template_id}/multi-ports/name".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Batch set name for given switch template ports
     ...
     Batch set name for given switch template ports.<br/><br/>The interface requires one of the
