...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/switches/{switch_mac}/ospf-neighbors".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get switch ospf neighbor table
     ...
     Get switch ospf neighbor table.<br/><br/>The interface requires one of the permissions: <br/>Site
