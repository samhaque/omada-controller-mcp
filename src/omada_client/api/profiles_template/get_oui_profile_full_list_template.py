...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/oui-profiles/all".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get OUI profile template summary list
     ...
     Get OUI profile template summary list.<br/><br/>The interface requires one of the permissions:
