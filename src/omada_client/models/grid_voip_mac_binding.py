...
if TYPE_CHECKING:
    from ..models.ip_mac_binding import IPMacBinding


T = TypeVar("T", bound="GridVOIPMacBinding")


@_attrs_define
class GridVOIPMacBinding:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = IPMacBinding.from_dict(data_item_data)

                data.append(data_item)

        grid_voip_mac_binding = cls(
        ...
        grid_voip_mac_binding.additional_properties = d
        return grid_voip_mac_binding
