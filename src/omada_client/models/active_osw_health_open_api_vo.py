...
T = TypeVar("T", bound="ActiveOswHealthOpenApiVO")


@_attrs_define
class ActiveOswHealthOpenApiVO:
    ...
    Attributes:
        ...
        traffic (int | Unset): Device traffic (Bytes)
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        active_osw_health_open_api_vo = cls(
            name=name,
            mac=mac,
            model=model,
        ...
        active_osw_health_open_api_vo.additional_properties = d
        return active_osw_health_open_api_vo
