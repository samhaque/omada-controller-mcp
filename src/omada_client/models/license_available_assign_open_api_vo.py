...
T = TypeVar("T", bound="LicenseAvailableAssignOpenApiVO")


@_attrs_define
class LicenseAvailableAssignOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        license_available_assign_open_api_vo = cls(
            license_num=license_num,
        )

        license_available_assign_open_api_vo.additional_properties = d
        return license_available_assign_open_api_vo
