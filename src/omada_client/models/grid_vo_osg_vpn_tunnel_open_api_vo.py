...
if TYPE_CHECKING:
    from ..models.osg_vpn_tunnel_open_api_vo import OsgVpnTunnelOpenApiVO


T = TypeVar("T", bound="GridVOOsgVpnTunnelOpenApiVO")


@_attrs_define
class GridVOOsgVpnTunnelOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.osg_vpn_tunnel_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OsgVpnTunnelOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osg_vpn_tunnel_open_api_vo = cls(
        ...
        grid_vo_osg_vpn_tunnel_open_api_vo.additional_properties = d
        return grid_vo_osg_vpn_tunnel_open_api_vo
