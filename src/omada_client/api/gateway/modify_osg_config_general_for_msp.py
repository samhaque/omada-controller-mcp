...
from ...models.gateway_msp_config_general import GatewayMspConfigGeneral
...
def _get_kwargs(
    ...
    gateway_mac: str,
    *,
    body: GatewayMspConfigGeneral,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/msp/{msp_id}/customers/{customer_id}/sites/{site_id}/gateways/{gateway_mac}/config/general".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify general gateway config for msp
     ...
     Modify general gateway config for msp<br/><br/>The interface requires one of the permissions:
