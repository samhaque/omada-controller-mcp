...
T = TypeVar("T", bound="OpenApiWebhookSettingEditVO")


@_attrs_define
class OpenApiWebhookSettingEditVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        open_api_webhook_setting_edit_vo = cls(
            url_list=url_list,
        ...
        open_api_webhook_setting_edit_vo.additional_properties = d
        return open_api_webhook_setting_edit_vo
