...
T = TypeVar("T", bound="GatewayCustomACLAddEntity")


@_attrs_define
class GatewayCustomACLAddEntity:
    """Added Custom ACLs.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        gateway_custom_acl_add_entity = cls(
            index=index,
            status=status,
            description=description,
            direction=direction,
        ...
        gateway_custom_acl_add_entity.additional_properties = d
        return gateway_custom_acl_add_entity
