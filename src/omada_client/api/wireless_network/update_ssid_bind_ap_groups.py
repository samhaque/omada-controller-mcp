...
from ...models.update_ssid_bind_ap_group_open_api_vo import (
...
def _get_kwargs(
    ...
    ssid_id: str,
    *,
    body: UpdateSsidBindApGroupOpenApiVO,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Update SSID binding ap groups
     ...
     Update SSID binding ap groups<br/><br/>The interface requires one of the permissions: <br/>Site
