...
if TYPE_CHECKING:
    from ..models.sslvpn_lock_entity import SSLVPNLockEntity


T = TypeVar("T", bound="GridVOSSLVPNLockEntity")


@_attrs_define
class GridVOSSLVPNLockEntity:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SSLVPNLockEntity.from_dict(data_item_data)

                data.append(data_item)

        grid_vosslvpn_lock_entity = cls(
        ...
        grid_vosslvpn_lock_entity.additional_properties = d
        return grid_vosslvpn_lock_entity
