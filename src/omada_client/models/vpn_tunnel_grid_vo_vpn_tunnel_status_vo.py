...
T = TypeVar("T", bound="VpnTunnelGridVOVpnTunnelStatusVO")


@_attrs_define
class VpnTunnelGridVOVpnTunnelStatusVO:
    """
    Attributes:
        ...
        lock_status (bool | Unset): Lock status of the SSL VPN tunnel
        lock_type (int | Unset): Lock type of the SSL VPN tunnel
    """
    ...
    lock_status: bool | Unset = UNSET
    lock_type: int | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        lock_type = d.pop("lockType", UNSET)

        vpn_tunnel_grid_vo_vpn_tunnel_status_vo = cls(
        ...
        vpn_tunnel_grid_vo_vpn_tunnel_status_vo.additional_properties = d
        return vpn_tunnel_grid_vo_vpn_tunnel_status_vo
