...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/wired-uplink".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get AP uplink(wired) detail
     ...
     Get AP uplink(wired) detail<br/><br/>The interface requires one of the permissions: <br/>Site Device
