...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/pon-port/informations/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get pon port information list
     ...
     Get pon port information list<br/><br/>The interface requires one of the permissions: <br/>Site
