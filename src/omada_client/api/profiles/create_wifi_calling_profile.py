...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/profiles/wifi-calling".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create a new wifi calling profile
     ...
     Create a new wifi calling profile with the given params.<br/><br/>The interface requires one of the
