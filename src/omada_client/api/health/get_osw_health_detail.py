...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/switches/{switch_mac}/health/detail".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get switch health detail
     ...
     Get switch health detail<br/><br/>The interface requires one of the permissions: <br/>Site Device
