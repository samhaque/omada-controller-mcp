...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/onu-management/informations/reboot-status/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ONU reboot status
     ...
     Get ONU reboot status<br/><br/>The interface requires one of the permissions: <br/>Site Device
