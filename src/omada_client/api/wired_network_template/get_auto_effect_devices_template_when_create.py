...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/networks/auto-effect-devices".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get auto effect devices when creating network
     ...
     Get auto effect devices when creating network.<br/><br/>The interface requires one of the
