...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/internet/load-balance".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify site template internet load balance config
     ...
     Modify site template internet load balance config.<br/><br/>The interface requires one of the
