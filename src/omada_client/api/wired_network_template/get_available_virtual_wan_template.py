...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/setting/available-virtual-wans".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Query available virtual WAN list for template
     ...
     Query available virtual WAN list for template.<br/><br/>The interface requires one of the
