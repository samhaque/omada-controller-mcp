...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v3/{omadac_id}/sites/{site_id}/vpn/{vpn_id}/users".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get user list by VPN server ID
     ...
     Get user list by VPN server ID.<br/><br/>The interface requires one of the permissions: <br/>Site
