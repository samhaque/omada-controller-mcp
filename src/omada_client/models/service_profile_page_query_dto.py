...
T = TypeVar("T", bound="ServiceProfilePageQueryDTO")


@_attrs_define
class ServiceProfilePageQueryDTO:
    """
    Attributes:
        ...
        search_fields (list[str] | Unset): Search fields
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        service_profile_page_query_dto = cls(
        ...
        service_profile_page_query_dto.additional_properties = d
        return service_profile_page_query_dto
