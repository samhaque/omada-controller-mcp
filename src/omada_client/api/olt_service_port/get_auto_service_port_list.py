...
from ...models.auto_service_port_query_dto import AutoServicePortQueryDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: AutoServicePortQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/auto-service-ports/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get auto service port list
     ...
     Get auto service port list<br/><br/>The interface requires one of the permissions: <br/>Site Device
