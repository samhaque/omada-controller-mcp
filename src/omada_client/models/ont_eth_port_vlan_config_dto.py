...
from ..models.ont_eth_port_vlan_config_dto_vlan_config_mode import (
...
T = TypeVar("T", bound="OntEthPortVlanConfigDTO")


@_attrs_define
class OntEthPortVlanConfigDTO:
    """Configure the VLAN TAG processing mode of the ONT port

    Attributes:
        vlan_config_mode (OntEthPortVlanConfigDTOVlanConfigMode):
        config_item_list (list[OntPortVlanConfigItemDTO] | Unset):
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ont_eth_port_vlan_config_dto = cls(
            vlan_config_mode=vlan_config_mode,
            config_item_list=config_item_list,
        )

        ont_eth_port_vlan_config_dto.additional_properties = d
        return ont_eth_port_vlan_config_dto
