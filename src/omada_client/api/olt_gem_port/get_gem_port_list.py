...
from ...models.gem_port_list_query_dto import GemPortListQueryDTO
...
def _get_kwargs(
    ...
    line_profile_id: str,
    *,
    query_param: GemPortListQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/{line_profile_id}/gem-ports/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get gem port list
     ...
     Get gem port list<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
