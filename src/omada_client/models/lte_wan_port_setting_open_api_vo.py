...
T = TypeVar("T", bound="LteWanPortSettingOpenApiVO")


@_attrs_define
class LteWanPortSettingOpenApiVO:
    """A list of LTE wan setting.

    Attributes:
        port_uu_id (str): Port UUID
        mobile_data (bool): mobile data
        data_roaming (bool): First SIM card's data roaming
        network_mode (int): First SIM card's networkMode: 1:3G Only, 2:4G Only, 3:4G Preferred, 4: 5G-NSA/4G, 5: 5G-SA,
            6: 5G/4G/3G
        ...
        sim_card_used (int | Unset): The SIM card being used
        status (int | Unset): 0: unknown, 1: disconnected, 2:disconnecting, 3:connected, 4:connecting
        card_status (int | Unset): cardStatus: 0:no_sim, 1:unknown, 2:pin_lock, 3:pin_verified, 4:ready, 5:puk_lock,
            6:blocked
        sim_priority (int | Unset): Which SIM card is used first.
        band_mode (int | Unset): First SIM card's bandMode: 0:auto, 1:manual, only for networkMode 4g Only and 4G
            Preferred
        bands (list[str] | Unset): First SIM card's. Only for band mode manual
        ...
        support_network_mode (list[int] | Unset): The network mode that the device can select.
    """
    ...
    support_network_mode: list[int] | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        port_uu_id = self.port_uu_id
        ...
        support_network_mode: list[int] | Unset = UNSET
        if not isinstance(self.support_network_mode, Unset):
            support_network_mode = self.support_network_mode
        ...
        if support_network_mode is not UNSET:
            field_dict["supportNetworkMode"] = support_network_mode
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        support_network_mode = cast(list[int], d.pop("supportNetworkMode", UNSET))

        lte_wan_port_setting_open_api_vo = cls(
            port_uu_id=port_uu_id,
            ...
            support_network_mode=support_network_mode,
        )

        lte_wan_port_setting_open_api_vo.additional_properties = d
        return lte_wan_port_setting_open_api_vo
