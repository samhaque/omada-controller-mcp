...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/msp/{msp_id}/customers/{customer_id}/sites/{site_id}/olts/{device_mac}/pon/pon-port/configs/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get pon port list(msp mode)
     ...
     Get pon port list(msp mode)<br/><br/>The interface requires one of the permissions: <br/>MSP Device
