...
T = TypeVar("T", bound="OtoNatInfoOpenApiVO")


@_attrs_define
class OtoNatInfoOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        oto_nat_info_open_api_vo.additional_properties = d
        return oto_nat_info_open_api_vo
