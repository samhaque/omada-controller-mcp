...
if TYPE_CHECKING:
    ...
    from ..models.category_traffic import CategoryTraffic


T = TypeVar("T", bound="ApplicationGridVOCategoryTraffic")


@_attrs_define
class ApplicationGridVOCategoryTraffic:
    """
    Attributes:
        ...
        data (list[CategoryTraffic] | Unset):
    ...
    data: list[CategoryTraffic] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = CategoryTraffic.from_dict(data_item_data)
        ...
        application_grid_vo_category_traffic = cls(
        ...
        application_grid_vo_category_traffic.additional_properties = d
        return application_grid_vo_category_traffic
