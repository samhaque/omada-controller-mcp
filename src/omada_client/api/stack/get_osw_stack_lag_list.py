...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/stacks/{stack_id}/lags".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get stack lag List
     ...
     Get stack lag List.<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
