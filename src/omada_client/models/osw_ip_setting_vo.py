...
T = TypeVar("T", bound="OswIpSettingVO")


@_attrs_define
class OswIpSettingVO:
    """Network IP setting.

    Attributes:
        mode (int): IP Setting mode. Static:0, DHCP:1
        ip (str | Unset): Static IP for mode 0, like 192.168.0.1
        gateway (str | Unset): Gateway, like 192.168.0.1
        netmask (str | Unset): IP Mask, like 255.255.255.0
        pre_dns (str | Unset): primary DNS Server
        sec_dns (str | Unset): second DNS Server
        ...
        use_fixed_addr (bool | Unset): The switch of Fixed Address
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osw_ip_setting_vo.additional_properties = d
        return osw_ip_setting_vo
