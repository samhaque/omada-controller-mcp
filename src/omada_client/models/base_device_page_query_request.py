...
T = TypeVar("T", bound="BaseDevicePageQueryRequest")


@_attrs_define
class BaseDevicePageQueryRequest:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        base_device_page_query_request = cls(
        ...
        base_device_page_query_request.additional_properties = d
        return base_device_page_query_request
