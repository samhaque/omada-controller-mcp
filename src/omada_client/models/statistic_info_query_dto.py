...
T = TypeVar("T", bound="StatisticInfoQueryDTO")


@_attrs_define
class StatisticInfoQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        statistic_info_query_dto.additional_properties = d
        return statistic_info_query_dto
