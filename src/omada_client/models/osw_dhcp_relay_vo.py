...
T = TypeVar("T", bound="OswDhcpRelayVO")


@_attrs_define
class OswDhcpRelayVO:
    """Network DHCP relay settings.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osw_dhcp_relay_vo = cls(
            addr=addr,
            server_addrs=server_addrs,
            vrf_id=vrf_id,
        )

        osw_dhcp_relay_vo.additional_properties = d
        return osw_dhcp_relay_vo
