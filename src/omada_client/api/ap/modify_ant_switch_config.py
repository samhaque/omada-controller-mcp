...
from ...models.update_ap_ant_switch_config import UpdateApAntSwitchConfig
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/ant-switch".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify AP antSwitch setting
     ...
     Modify AP antSwitch setting<br/><br/>The interface requires one of the permissions: <br/>Site Device
