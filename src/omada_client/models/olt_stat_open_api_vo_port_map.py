...
T = TypeVar("T", bound="OltStatOpenApiVOPortMap")


@_attrs_define
class OltStatOpenApiVOPortMap:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        olt_stat_open_api_vo_port_map = cls()
        ...
        olt_stat_open_api_vo_port_map.additional_properties = additional_properties
        return olt_stat_open_api_vo_port_map
