...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/upgrade/plan/models".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get the list of models
     ...
     Get the list of models on the Controller upgrade plan page.<br/><br/>The interface requires one of
    the permissions: <br/>Site Manual Firmware Upgrade View Only<br/><br/>The possible error code for
