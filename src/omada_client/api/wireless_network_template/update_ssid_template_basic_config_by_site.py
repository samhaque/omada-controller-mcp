...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/wireless-network/ssids/{ssid_id}/basic-config".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update SSID Template basic config by site
     ...
     Update SSID Template basic config by site<br/><br/>The interface requires one of the permissions:
    ...
    codes): <br/>-33009  -  This site template does not exist.<br/>-33217  -  Invalid SSID security
    mode.<br/>-33219  -  This SSID already exists.<br/>-33220  -  Enter a different SSID to override the
    current SSID.<br/>-33231  -  The ssid' s name should not be the same with emergency ssid.<br/>-33235
