...
T = TypeVar("T", bound="Ipv4L2TpOpenApiVO")


@_attrs_define
class Ipv4L2TpOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ipv_4l2_tp_open_api_vo.additional_properties = d
        return ipv_4l2_tp_open_api_vo
