...
def _get_kwargs(
    ...
    *,
    body: CallForwardingRule,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/voip/call-forwarding/{forwarding_rule_id}".format(
            omadac_id=quote(str(omadac_id), safe=""),
            site_template_id=quote(str(site_template_id), safe=""),
            forwarding_rule_id=quote(str(forwarding_rule_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Modify an existing Call Forwarding in siteTemplate
     ...
     Modify an existing Call Forwarding in siteTemplate.<br/><br/>The interface requires one of the
