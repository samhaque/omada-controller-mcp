...
class APRadioTrafficEntity:
    ...
    Attributes:
        ...
        rx (int | Unset): Total RX bytes
        tx (int | Unset): Total TX bytes
        ...
        rx_retry_pkts (int | Unset): RX retried packets
        tx_retry_pkts (int | Unset): TX retried packets
    """
    ...
    rx_retry_pkts: int | Unset = UNSET
    tx_retry_pkts: int | Unset = UNSET
