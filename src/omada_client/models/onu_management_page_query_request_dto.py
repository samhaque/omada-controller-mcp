...
T = TypeVar("T", bound="OnuManagementPageQueryRequestDTO")


@_attrs_define
class OnuManagementPageQueryRequestDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        onu_management_page_query_request_dto = cls(
            pon_port=pon_port,
        ...
        onu_management_page_query_request_dto.additional_properties = d
        return onu_management_page_query_request_dto
