...
from ...models.line_profile_page_query_dto import LineProfilePageQueryDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: LineProfilePageQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/profiles/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get line profile page
     ...
     Get line profile page<br/><br/>The interface requires one of the permissions: <br/>Site Device
