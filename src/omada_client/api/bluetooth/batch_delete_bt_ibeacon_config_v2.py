...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/openapi/v2/{omadac_id}/sites/{site_id}/setting/iot/devices/config/batch".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Batch delete Bluetooth Advertising v2
     ...
     Batch delete Bluetooth Advertising v2.<br/><br/>The interface requires one of the permissions:
