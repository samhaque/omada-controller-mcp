...
T = TypeVar("T", bound="NewIPSAllowListEntry")


@_attrs_define
class NewIPSAllowListEntry:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        new_ips_allow_list_entry.additional_properties = d
        return new_ips_allow_list_entry
