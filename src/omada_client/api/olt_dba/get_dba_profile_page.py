...
from ...models.dba_profile_page_query_dto import DBAProfilePageQueryDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: DBAProfilePageQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/dba/profiles/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get DBA profile page
     ...
     Get DBA profile page<br/><br/>The interface requires one of the permissions: <br/>Site Device
