...
if TYPE_CHECKING:
    from ..models.device_available_template_open_api_vo import (
        DeviceAvailableTemplateOpenApiVO,
    )


T = TypeVar("T", bound="GridVODeviceAvailableTemplateOpenApiVO")


@_attrs_define
class GridVODeviceAvailableTemplateOpenApiVO:
    """
    Attributes:
        ...
        data (list[DeviceAvailableTemplateOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[DeviceAvailableTemplateOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = DeviceAvailableTemplateOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_device_available_template_open_api_vo = cls(
        ...
        grid_vo_device_available_template_open_api_vo.additional_properties = d
        return grid_vo_device_available_template_open_api_vo
