...
if TYPE_CHECKING:
    from ..models.known_client_vo import KnownClientVO


T = TypeVar("T", bound="GridVOKnownClientVO")


@_attrs_define
class GridVOKnownClientVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = KnownClientVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_known_client_vo = cls(
        ...
        grid_vo_known_client_vo.additional_properties = d
        return grid_vo_known_client_vo
