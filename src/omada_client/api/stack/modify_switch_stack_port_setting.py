...
from ...models.stack_port_setting_vo import StackPortSettingVO
...
def _get_kwargs(
    ...
    port: str,
    *,
    body: StackPortSettingVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v2/{omadac_id}/sites/{site_id}/stacks/{stack_id}/ports/{port}".format(
