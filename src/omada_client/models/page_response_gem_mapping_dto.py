...
T = TypeVar("T", bound="PageResponseGemMappingDTO")


@_attrs_define
class PageResponseGemMappingDTO:
    """
    Attributes:
        content (list[GemMappingDTO] | Unset): Content
    ...
    content: list[GemMappingDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = GemMappingDTO.from_dict(content_item_data)
        ...
        page_response_gem_mapping_dto = cls(
            content=content,
        ...
        page_response_gem_mapping_dto.additional_properties = d
        return page_response_gem_mapping_dto
