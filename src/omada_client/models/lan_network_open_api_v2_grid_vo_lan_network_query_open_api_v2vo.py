...
if TYPE_CHECKING:
    from ..models.lan_network_query_open_api_v2vo import LanNetworkQueryOpenApiV2VO


T = TypeVar("T", bound="LanNetworkOpenApiV2GridVOLanNetworkQueryOpenApiV2VO")


@_attrs_define
class LanNetworkOpenApiV2GridVOLanNetworkQueryOpenApiV2VO:
    """
    Attributes:
        ...
        data (list[LanNetworkQueryOpenApiV2VO] | Unset):
    ...
    data: list[LanNetworkQueryOpenApiV2VO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.lan_network_query_open_api_v2vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = LanNetworkQueryOpenApiV2VO.from_dict(data_item_data)
        ...
        lan_network_open_api_v2_grid_vo_lan_network_query_open_api_v2vo = cls(
        ...
        lan_network_open_api_v2_grid_vo_lan_network_query_open_api_v2vo.additional_properties = d
        return lan_network_open_api_v2_grid_vo_lan_network_query_open_api_v2vo
