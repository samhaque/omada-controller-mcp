...
T = TypeVar("T", bound="GemMappingPageQueryDTO")


@_attrs_define
class GemMappingPageQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        gem_mapping_page_query_dto = cls(
        ...
        gem_mapping_page_query_dto.additional_properties = d
        return gem_mapping_page_query_dto
