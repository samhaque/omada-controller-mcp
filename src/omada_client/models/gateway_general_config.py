...
T = TypeVar("T", bound="GatewayGeneralConfig")


@_attrs_define
class GatewayGeneralConfig:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        gateway_general_config.additional_properties = d
        return gateway_general_config
