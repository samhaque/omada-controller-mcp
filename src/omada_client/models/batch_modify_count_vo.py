...
T = TypeVar("T", bound="BatchModifyCountVO")


@_attrs_define
class BatchModifyCountVO:
    """
    Attributes:
        successes (int | Unset):
        failures (int | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        batch_modify_count_vo = cls(
            successes=successes,
            failures=failures,
        )

        batch_modify_count_vo.additional_properties = d
        return batch_modify_count_vo
