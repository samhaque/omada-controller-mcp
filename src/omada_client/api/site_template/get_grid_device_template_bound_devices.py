...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/devicetemplates/{device_template_id}/bound-devices".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get deviceTemplate's bound devices
     ...
     Get deviceTemplate's bound devices.<br/><br/>The interface requires one of the permissions:
