...
T = TypeVar("T", bound="UpgradeBaseScheduleTimeOpenApiVO")


@_attrs_define
class UpgradeBaseScheduleTimeOpenApiVO:
    """Periodic execution time, and it should not be null

    Attributes:
        timing_type (int): Time type should be a value as follows: 1:Daily; 2:Weekly; 3:Monthly; 4:yearly
        ...
        day_of_week (int | Unset): It should be within the range of 0(Sunday)~6(Saturday). Required when parameter
            [timingType] is 2.
        day_of_month (int | Unset): It should be within the range of 1~31. Required when parameter [timingType] is 3 or
            4.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        upgrade_base_schedule_time_open_api_vo = cls(
        ...
        upgrade_base_schedule_time_open_api_vo.additional_properties = d
        return upgrade_base_schedule_time_open_api_vo
