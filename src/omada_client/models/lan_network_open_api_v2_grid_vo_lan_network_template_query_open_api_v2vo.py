...
if TYPE_CHECKING:
    from ..models.lan_network_template_query_open_api_v2vo import (
        LanNetworkTemplateQueryOpenApiV2VO,
    )


T = TypeVar("T", bound="LanNetworkOpenApiV2GridVOLanNetworkTemplateQueryOpenApiV2VO")


@_attrs_define
class LanNetworkOpenApiV2GridVOLanNetworkTemplateQueryOpenApiV2VO:
    """
    Attributes:
        ...
        data (list[LanNetworkTemplateQueryOpenApiV2VO] | Unset):
    ...
    data: list[LanNetworkTemplateQueryOpenApiV2VO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = LanNetworkTemplateQueryOpenApiV2VO.from_dict(data_item_data)
        ...
        lan_network_open_api_v2_grid_vo_lan_network_template_query_open_api_v2vo = cls(
        ...
        lan_network_open_api_v2_grid_vo_lan_network_template_query_open_api_v2vo.additional_properties = d
        return lan_network_open_api_v2_grid_vo_lan_network_template_query_open_api_v2vo
