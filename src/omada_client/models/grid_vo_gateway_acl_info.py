...
if TYPE_CHECKING:
    from ..models.gateway_acl_info import GatewayACLInfo


T = TypeVar("T", bound="GridVOGatewayACLInfo")


@_attrs_define
class GridVOGatewayACLInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = GatewayACLInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_gateway_acl_info = cls(
        ...
        grid_vo_gateway_acl_info.additional_properties = d
        return grid_vo_gateway_acl_info
