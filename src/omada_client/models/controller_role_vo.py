...
class ControllerRoleVO:
    ...
    Attributes:
        license_ (int | Unset): License permission, it should be a value as follows: 0:block; 1:view only; 2:modify
        global_dashboard (int | Unset): Dashboard permission in global view. It should be a value as follows: 0:block;
            1:view only; 2:modify
        dashboard (int | Unset): Dashboard permission in site view. It should be a value as follows: 0:block; 1:view
            only; 2:modify
        devices (int | Unset): Devices permission in site view and global view. It should be a value as follows:
            0:block; 1:view only; 2:modify
        adopt (int | Unset): Adopt permission should be a value as follows: 0:block; 2:access
        add_devices (int | Unset): Add devices permission should be a value as follows: 0:block; 2:access
        add_adopt_device (int | Unset): Add and adopt devices permission should be a value as follows: 0:block; 2:access
        manual_upgrade (int | Unset): Manual Upgrade permission should be a value as follows: 0:block; 2:access
        global_log (int | Unset): Log permission in global view should be a value as follows: 0:block; 1:view only;
            2:modify
        log (int | Unset): Log permission in site view should be a value as follows: 0:block; 1:view only; 2:modify
        license_bind (int | Unset): License bind permission should be a value as follows: 0:block; 1:view only; 2:modify
        users (int | Unset): Users permission in global view should be a value as follows: 0:block; 1:view only;
            2:modify
        roles (int | Unset): Roles permission in global view should be a value as follows: 0:block; 1:view only;
            2:modify
        saml_users (int | Unset): Saml users permission in global view should be a value as follows: 0:block; 1:view
            only; 2:modify
        saml_roles (int | Unset): Saml roles permission in global view should be a value as follows: 0:block; 1:view
            only; 2:modify
        saml_ssos (int | Unset): Saml ssos permission in global view should be a value as follows: 0:block; 1:view only;
            2:modify
        global_setting (int | Unset): Settings permission in global view should be a value as follows: 0:block; 1:view
            only; 2:modify
        export_data (int | Unset): Export data permission in site view should be a value as follows: 0:block; 2:access
        global_export_data (int | Unset): Export data permission in global view should be a value as follows: 0:block;
            2:access
        export_global_log (int | Unset): Export global log data permission in global view should be a value as follows:
            0:block; 2:access
        global_cluster (int | Unset): Cluster permission in global view. 0:block; 1:view only; 2:modify
        hotspot (int | Unset): Hotspot permission should be a value as follows: 0:block; 1:view only; 2:modify
        statics (int | Unset): Statics permission in site view should be a value as follows: 0:block; 1:view only;
            2:modify
        map_ (int | Unset): Map permission in site view should be a value as follows: 0:block; 1:view only; 2:modify
        clients (int | Unset): Clients permission in site view should be a value as follows: 0:block; 1:view only;
            2:modify
        insight (int | Unset): Insight permission in site view should be a value as follows: 0:block; 1:view only;
            2:modify
        report (int | Unset): Network report permission in site view should be a value as follows: 0:block; 1:view only;
            2:modify
        network (int | Unset): Site network settings permission in site view -> settings should be a value as follows:
            0:block; 1:view only; 2:modify
        device_account (int | Unset): Device account permission in site view -> site settings should be a value as
            follows: 0:block; 1:view only; 2:modify
        anomaly (int | Unset): Anomaly permission in global view should be a value as follows: 0:block; 1:view only;
            2:modify
        analyze (int | Unset): Tools permission in global view. Only for hardware controller should be a value as
            follows: 0:block; 1:view only; 2:modify
        site_analyze (int | Unset): Tools in site view should be a value as follows: 0:block; 1:view only; 2:modify
        global_security (int | Unset): Security permission in global view should be a value as follows: 0:block; 1:view
            only; 2:modify
        global_webhook (int | Unset): Webhook in global view should be a value as follows: 0:block; 1:view only;
            2:modify, only for pro controller
        global_map_token (int | Unset): MapToken in global view should be a value as follows: 0:block; 1:view only;
            2:modify, only for pro controller
        site_template (int | Unset): SiteTemplate in global view should be a value as follows: 0:block; 1:view only;
            2:modify, only for pro controller
        firmware_manager (int | Unset): FirmwareManager in global view should be a value as follows: 0:block; 1:view
            only; 2:modify, only for pro controller
        sd_wan (int | Unset): SD-WAN in global view should be a value as follows: 0:block; 1:view only; 2:modify
        site_home (int | Unset): Site home permission in site view. 0:block; 1:view only; 2:modify
        device_recovery (int | Unset): Device recovery permission in site view. 0:block; 1:view only; 2:modify
        site_network (int | Unset): Network config page permission in site view. 0:block; 1:view only; 2:modify
        site_device (int | Unset): Device config page permission in site view. 0:block; 1:view only; 2:modify
        site_maintain (int | Unset): Maintenance page permission in site view. 0:block; 1:view only; 2:modify
        ai_assi (int | Unset): AI assistant permission. 0:block; 1:view only; 2:modify
    """
    ...
    firmware_manager: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if firmware_manager is not UNSET:
            field_dict["firmwareManager"] = firmware_manager
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        firmware_manager = d.pop("firmwareManager", UNSET)
