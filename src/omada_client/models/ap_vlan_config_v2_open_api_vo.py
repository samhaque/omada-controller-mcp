...
T = TypeVar("T", bound="ApVlanConfigV2OpenApiVO")


@_attrs_define
class ApVlanConfigV2OpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ap_vlan_config_v2_open_api_vo = cls(
            mvlan_setting=mvlan_setting,
            voip_vlan_setting=voip_vlan_setting,
        )

        ap_vlan_config_v2_open_api_vo.additional_properties = d
        return ap_vlan_config_v2_open_api_vo
