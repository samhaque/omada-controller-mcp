...
if TYPE_CHECKING:
    from ..models.vlan_lan_network_for_btach_delete_vo import (
        VlanLanNetworkForBtachDeleteVO,
    )


T = TypeVar("T", bound="GridVOVlanLanNetworkForBtachDeleteVO")


@_attrs_define
class GridVOVlanLanNetworkForBtachDeleteVO:
    """
    Attributes:
        ...
        data (list[VlanLanNetworkForBtachDeleteVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[VlanLanNetworkForBtachDeleteVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = VlanLanNetworkForBtachDeleteVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_vlan_lan_network_for_btach_delete_vo = cls(
        ...
        grid_vo_vlan_lan_network_for_btach_delete_vo.additional_properties = d
        return grid_vo_vlan_lan_network_for_btach_delete_vo
