...
class SSHSetting:
    ...
    Attributes:
        ssh_enable (bool): Whether to enable SSH
        ssh_server_port (int | Unset): SSH server port should be 22 or within the range of 1025-65535.
        layer_3_access (bool | Unset): Whether to enable layer 3 accessibility
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ssh_setting.additional_properties = d
        return ssh_setting
