...
from ...models.rf_scan_command import RFScanCommand
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v2/{omadac_id}/sites/{site_id}/aps/{ap_mac}/start-rf-scan".format(
...
def sync_detailed(
    ...
    *,
    ...
    network to start scanning.<br/><br/>The interface requires one of the permissions: <br/>Site Device
    ...
    support RF Scanning.<br/>-34824  -  Rogue AP scanning... Please wait.
