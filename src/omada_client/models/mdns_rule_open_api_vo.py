...
T = TypeVar("T", bound="MdnsRuleOpenApiVO")


@_attrs_define
class MdnsRuleOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        mdns_rule_open_api_vo.additional_properties = d
        return mdns_rule_open_api_vo
