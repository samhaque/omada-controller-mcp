...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/anomaly/overview/incident-distribution".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get incident overview distribution
     ...
     Get incident overview distribution.<br/><br/>The interface requires one of the permissions:
