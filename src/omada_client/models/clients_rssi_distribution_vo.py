...
T = TypeVar("T", bound="ClientsRssiDistributionVO")


@_attrs_define
class ClientsRssiDistributionVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        clients_rssi_distribution_vo = cls(
        ...
        clients_rssi_distribution_vo.additional_properties = d
        return clients_rssi_distribution_vo
