...
if TYPE_CHECKING:
    from ..models.active_pair_multi_site_open_api_dto import (
        ActivePairMultiSiteOpenApiDTO,
    )


T = TypeVar("T", bound="ActiveDeviceMultiSiteOpenApiVO")


@_attrs_define
class ActiveDeviceMultiSiteOpenApiVO:
    """
    Attributes:
        active_pair_list (list[ActivePairMultiSiteOpenApiDTO]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for active_pair_list_item_data in _active_pair_list:
            active_pair_list_item = ActivePairMultiSiteOpenApiDTO.from_dict(
        ...
        active_device_multi_site_open_api_vo = cls(
            active_pair_list=active_pair_list,
            category=category,
        )

        active_device_multi_site_open_api_vo.additional_properties = d
        return active_device_multi_site_open_api_vo
