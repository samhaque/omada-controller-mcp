...
T = TypeVar("T", bound="UpdateWidsConfigOpenApiVO")


@_attrs_define
class UpdateWidsConfigOpenApiVO:
    """
    Attributes:
        status (bool): Wireless IDS config status; true:enable, false:disable.
        level (int): Wireless IDS detection level; It should be a value as follows: 0:High; 1:Low; 2:Custom.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_wids_config_open_api_vo = cls(
            status=status,
            level=level,
            detection=detection,
        )

        update_wids_config_open_api_vo.additional_properties = d
        return update_wids_config_open_api_vo
