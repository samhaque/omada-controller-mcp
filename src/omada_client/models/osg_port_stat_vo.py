...
T = TypeVar("T", bound="OsgPortStatVO")
...
class OsgPortStatVO:
    ...
    Attributes:
        ...
        status (int | Unset): Port status, 0-disconnected; 1-connected;
        internet_state (int | Unset): Wan internet state, 0-disconnected; 1-connected;
        ip (str | Unset): Ip
        ...
        tx_training_rate (int | Unset):
        rx_training_rate (int | Unset):
        port_uuid (str | Unset):
        max_bandwidth (int | Unset):
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        charge_mode = d.pop("chargeMode", UNSET)
        ...
        osg_port_stat_vo.additional_properties = d
        return osg_port_stat_vo
