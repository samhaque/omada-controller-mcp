...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/gatewaytemplates/{device_template_id}/config/wlans/ssid".format(
...
def sync_detailed(
    ...
    *,
    ...
    exist.<br/>-39501  -  This gateway does not exist.
