...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v2/{omadac_id}/sitetemplates/{site_template_id}/lan-profiles".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create new switch profile template
     ...
     Create new switch profile template.<br/><br/>The interface requires one of the permissions:
