...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/wireless-network/wlans/{wlan_id}/ssids/{ssid_id}/update-wifi-calling".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update SSID template wifi calling config
     ...
     Update SSID template Wi-Fi Calling config, Legacy note: “wlanId” is the legacy name of “apGroupId”.
    This endpoint will be deprecated in future releases. Please use Update SSID Template wifi calling
