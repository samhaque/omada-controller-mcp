...
if TYPE_CHECKING:
    from ..models.static_routing_info_template import StaticRoutingInfoTemplate


T = TypeVar("T", bound="StaticRoutingOpenApiGridVOStaticRoutingInfoTemplate")


@_attrs_define
class StaticRoutingOpenApiGridVOStaticRoutingInfoTemplate:
    """
    Attributes:
        ...
        data (list[StaticRoutingInfoTemplate] | Unset):
    ...
    data: list[StaticRoutingInfoTemplate] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.static_routing_info_template import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = StaticRoutingInfoTemplate.from_dict(data_item_data)
        ...
        static_routing_open_api_grid_vo_static_routing_info_template = cls(
        ...
        static_routing_open_api_grid_vo_static_routing_info_template.additional_properties = d
        return static_routing_open_api_grid_vo_static_routing_info_template
