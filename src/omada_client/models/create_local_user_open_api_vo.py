...
if TYPE_CHECKING:
    from ..models.daily_auth_time_open_api_vo import DailyAuthTimeOpenApiVO
    from ..models.rate_limit_open_api_vo import RateLimitOpenApiVO


T = TypeVar("T", bound="CreateLocalUserOpenApiVO")


@_attrs_define
class CreateLocalUserOpenApiVO:
    """
    Attributes:
        user_name (str): User name should contain 1 to 128 ASCII visible characters, with no spaces at the beginning and
            end, and spaces in the middle, cannot be changed after creation.
        ...
        daily_limit (DailyAuthTimeOpenApiVO | Unset): Daily time limit setting, required when parameter
            [dailyLimitEnable] is true
    """
    ...
    daily_limit: DailyAuthTimeOpenApiVO | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.daily_auth_time_open_api_vo import (
        ...
        daily_limit: DailyAuthTimeOpenApiVO | Unset
        if isinstance(_daily_limit, Unset):
            daily_limit = UNSET
        else:
            daily_limit = DailyAuthTimeOpenApiVO.from_dict(_daily_limit)

        create_local_user_open_api_vo = cls(
            user_name=user_name,
            password=password,
            enable=enable,
        ...
        create_local_user_open_api_vo.additional_properties = d
        return create_local_user_open_api_vo
