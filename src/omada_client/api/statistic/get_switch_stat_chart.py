...
from ...models.osw_stat_query_open_api_dto import OswStatQueryOpenApiDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    body: OswStatQueryOpenApiDTO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/stat/switches/{device_mac}/chart".format(
