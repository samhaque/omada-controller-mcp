...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/hotspot/dashboard/statistics".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get hotspot statistic
     ...
     Get hotspot statistic with the given omadacId and siteId.<br/><br/>The interface requires one of the
