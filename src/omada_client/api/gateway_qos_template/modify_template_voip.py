...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/qos/gateway/voip-prioritization".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify siteTemplate's VoIP Prioritization info
     ...
     Modify siteTemplate's VoIP Prioritization info.<br/><br/>The interface requires one of the
