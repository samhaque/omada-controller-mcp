...
T = TypeVar("T", bound="LineProfileDeleteResultDTO")


@_attrs_define
class LineProfileDeleteResultDTO:
    """Device configuration information.If the type of data is 'Object',ignore this field

    Attributes:
        profiles_in_use (list[int] | Unset): A list of Line Profile IDs that failed to delete because they are in use.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        line_profile_delete_result_dto = cls(
            profiles_in_use=profiles_in_use,
        )

        line_profile_delete_result_dto.additional_properties = d
        return line_profile_delete_result_dto
