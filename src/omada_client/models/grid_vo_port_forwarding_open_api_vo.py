...
if TYPE_CHECKING:
    from ..models.port_forwarding_open_api_vo import PortForwardingOpenApiVO


T = TypeVar("T", bound="GridVOPortForwardingOpenApiVO")


@_attrs_define
class GridVOPortForwardingOpenApiVO:
    """
    Attributes:
        ...
        data (list[PortForwardingOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[PortForwardingOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.port_forwarding_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = PortForwardingOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_port_forwarding_open_api_vo = cls(
        ...
        grid_vo_port_forwarding_open_api_vo.additional_properties = d
        return grid_vo_port_forwarding_open_api_vo
