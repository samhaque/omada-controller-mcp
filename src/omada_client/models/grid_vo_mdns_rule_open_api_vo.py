...
if TYPE_CHECKING:
    from ..models.mdns_rule_open_api_vo import MdnsRuleOpenApiVO


T = TypeVar("T", bound="GridVOMdnsRuleOpenApiVO")


@_attrs_define
class GridVOMdnsRuleOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = MdnsRuleOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_mdns_rule_open_api_vo = cls(
        ...
        grid_vo_mdns_rule_open_api_vo.additional_properties = d
        return grid_vo_mdns_rule_open_api_vo
