...
T = TypeVar("T", bound="SendMailServerOpenApiVO")


@_attrs_define
class SendMailServerOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        send_mail_server_open_api_vo = cls(
        ...
        send_mail_server_open_api_vo.additional_properties = d
        return send_mail_server_open_api_vo
