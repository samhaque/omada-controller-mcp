...
T = TypeVar("T", bound="LinkErrorHealthInfoDetailVO")


@_attrs_define
class LinkErrorHealthInfoDetailVO:
    """Port link error info and score
    ...
    Attributes:
        ...
        port_num (int | Unset): Total number of ports.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        link_error_health_info_detail_vo = cls(
        ...
        link_error_health_info_detail_vo.additional_properties = d
        return link_error_health_info_detail_vo
