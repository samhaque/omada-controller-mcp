...
if TYPE_CHECKING:
    from ..models.batch_osw_port_setting_vo_tag_bridge_vlan_map import (
        BatchOswPortSettingVOTagBridgeVlanMap,
    )
    from ..models.batch_osw_port_setting_vo_untag_bridge_vlan_map import (
...
T = TypeVar("T", bound="BatchOswPortSettingVO")


@_attrs_define
class BatchOswPortSettingVO:
    """
    Attributes:
        port_list (list[int]):
        ...
        tag_bridge_vlan_map (BatchOswPortSettingVOTagBridgeVlanMap | Unset): Tag Network Bridge Vlan Map
        untag_network_ids (list[str] | Unset): Untag Network IDs
        untag_bridge_vlan_map (BatchOswPortSettingVOUntagBridgeVlanMap | Unset): Untag Network Bridge Vlan Map
    ...
    tag_bridge_vlan_map: BatchOswPortSettingVOTagBridgeVlanMap | Unset = UNSET
    untag_network_ids: list[str] | Unset = UNSET
    untag_bridge_vlan_map: BatchOswPortSettingVOUntagBridgeVlanMap | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        tag_bridge_vlan_map: BatchOswPortSettingVOTagBridgeVlanMap | Unset
        if isinstance(_tag_bridge_vlan_map, Unset):
            tag_bridge_vlan_map = UNSET
        else:
            tag_bridge_vlan_map = BatchOswPortSettingVOTagBridgeVlanMap.from_dict(
        ...
        untag_bridge_vlan_map: BatchOswPortSettingVOUntagBridgeVlanMap | Unset
        if isinstance(_untag_bridge_vlan_map, Unset):
            untag_bridge_vlan_map = UNSET
        else:
            untag_bridge_vlan_map = BatchOswPortSettingVOUntagBridgeVlanMap.from_dict(
        ...
        batch_osw_port_setting_vo.additional_properties = d
        return batch_osw_port_setting_vo
