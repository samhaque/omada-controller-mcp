...
T = TypeVar("T", bound="SiteSettingAnomalyStatVO")


@_attrs_define
class SiteSettingAnomalyStatVO:
    """Statistics of incidents for site.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        site_setting_anomaly_stat_vo = cls(
            critical=critical,
            error=error,
            warning=warning,
            info=info,
        ...
        site_setting_anomaly_stat_vo.additional_properties = d
        return site_setting_anomaly_stat_vo
