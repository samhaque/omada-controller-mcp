...
from ...models.batch_bind_device_open_api_vo import BatchBindDeviceOpenApiVO
...
def _get_kwargs(
    ...
    *,
    body: BatchBindDeviceOpenApiVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/devicetemplates/{device_template_id}/batch-sync-config".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Device template batch sync config to devices
     ...
     Device template batch sync config to devices.<br/><br/>The interface requires one of the
    ...
    <br/>-1001  -  Invalid request parameters.<br/>-44402  -  Device template does not exist.
