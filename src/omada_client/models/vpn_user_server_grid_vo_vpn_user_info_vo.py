...
if TYPE_CHECKING:
    ...
    from ..models.vpn_user_server_info_vo import VpnUserServerInfoVO


T = TypeVar("T", bound="VpnUserServerGridVOVpnUserInfoVO")


@_attrs_define
class VpnUserServerGridVOVpnUserInfoVO:
    """
    Attributes:
        ...
        vpn_info (VpnUserServerInfoVO | Unset):
        total (int | Unset):
        available (int | Unset):
        expired (int | Unset):
    """
    ...
    vpn_info: VpnUserServerInfoVO | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        vpn_info: dict[str, Any] | Unset = UNSET
        if not isinstance(self.vpn_info, Unset):
            vpn_info = self.vpn_info.to_dict()
        ...
        if vpn_info is not UNSET:
            field_dict["vpnInfo"] = vpn_info
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.vpn_user_info_vo import VpnUserInfoVO
        from ..models.vpn_user_server_info_vo import (
            VpnUserServerInfoVO,
        )
        ...
        _vpn_info = d.pop("vpnInfo", UNSET)
        vpn_info: VpnUserServerInfoVO | Unset
        if isinstance(_vpn_info, Unset):
            vpn_info = UNSET
        else:
            vpn_info = VpnUserServerInfoVO.from_dict(_vpn_info)
        ...
        vpn_user_server_grid_vo_vpn_user_info_vo = cls(
        ...
        vpn_user_server_grid_vo_vpn_user_info_vo.additional_properties = d
        return vpn_user_server_grid_vo_vpn_user_info_vo
