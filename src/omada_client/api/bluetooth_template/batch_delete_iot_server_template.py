...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/setting/iot/servers/batch-delete".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Batch delete IoT Transport Stream(Template)
     ...
     Batch delete IoT Transport Stream setting in site template.<br/><br/>The interface requires one of
