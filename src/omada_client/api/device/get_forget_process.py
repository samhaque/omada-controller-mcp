...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/devices/forget/{forget_id}/status".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get batch forget process
     ...
     Get process of the batch forget operation. The expire time of result is 300 seconds.<br/><br/>The
