...
T = TypeVar("T", bound="PageResponseTrafficProfileVO")


@_attrs_define
class PageResponseTrafficProfileVO:
    """
    Attributes:
        content (list[TrafficProfileVO] | Unset): Content
    ...
    content: list[TrafficProfileVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = TrafficProfileVO.from_dict(content_item_data)
        ...
        page_response_traffic_profile_vo = cls(
            content=content,
        ...
        page_response_traffic_profile_vo.additional_properties = d
        return page_response_traffic_profile_vo
