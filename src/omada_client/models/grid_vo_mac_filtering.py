...
T = TypeVar("T", bound="GridVOMacFiltering")


@_attrs_define
class GridVOMacFiltering:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = MacFiltering.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_mac_filtering = cls(
        ...
        grid_vo_mac_filtering.additional_properties = d
        return grid_vo_mac_filtering
