...
T = TypeVar("T", bound="PageResponseOnuInformationConfigDTO")


@_attrs_define
class PageResponseOnuInformationConfigDTO:
    """
    Attributes:
        content (list[OnuInformationConfigDTO] | Unset): Content
    ...
    content: list[OnuInformationConfigDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = OnuInformationConfigDTO.from_dict(content_item_data)
        ...
        page_response_onu_information_config_dto = cls(
            content=content,
        ...
        page_response_onu_information_config_dto.additional_properties = d
        return page_response_onu_information_config_dto
