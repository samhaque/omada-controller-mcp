...
T = TypeVar("T", bound="TrafficProfilePageQueryDTO")


@_attrs_define
class TrafficProfilePageQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        traffic_profile_page_query_dto = cls(
        ...
        traffic_profile_page_query_dto.additional_properties = d
        return traffic_profile_page_query_dto
