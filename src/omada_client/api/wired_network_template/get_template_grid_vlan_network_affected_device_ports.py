...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/networks/{network_id}/vlan/{vlan}/ports".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get the ports of devices template that use the network
     ...
     Get the ports of devices template that use the network.<br/><br/>The interface requires one of the
