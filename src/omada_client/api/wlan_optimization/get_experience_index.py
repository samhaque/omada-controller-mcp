...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/experienceIndex".format(
...
def sync_detailed(
    ...
    *,
    ...
    """get Experience Index
     ...
     get Experience Index<br/><br/>The interface requires one of the permissions: <br/>Site Settings
