...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/devices/unknown-devices".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get global unknown device list
     ...
     Get global unknown device list.<br/><br/>The interface requires one of the permissions: <br/>Site
    Device Manager View Only<br/>MSP Device Manager View Only
