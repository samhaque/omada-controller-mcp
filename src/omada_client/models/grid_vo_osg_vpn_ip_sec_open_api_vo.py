...
if TYPE_CHECKING:
    from ..models.osg_vpn_ip_sec_open_api_vo import OsgVpnIpSecOpenApiVO


T = TypeVar("T", bound="GridVOOsgVpnIpSecOpenApiVO")


@_attrs_define
class GridVOOsgVpnIpSecOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.osg_vpn_ip_sec_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OsgVpnIpSecOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osg_vpn_ip_sec_open_api_vo = cls(
        ...
        grid_vo_osg_vpn_ip_sec_open_api_vo.additional_properties = d
        return grid_vo_osg_vpn_ip_sec_open_api_vo
