...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/onu-management/global-config/get".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ONU global config status
     ...
     Get ONU global config status<br/><br/>The interface requires one of the permissions: <br/>Site
