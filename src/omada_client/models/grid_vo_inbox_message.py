...
T = TypeVar("T", bound="GridVOInboxMessage")


@_attrs_define
class GridVOInboxMessage:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = InboxMessage.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_inbox_message = cls(
        ...
        grid_vo_inbox_message.additional_properties = d
        return grid_vo_inbox_message
