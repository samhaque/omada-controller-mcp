...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/hotspot/voucher-groups/{group_id}/print-unused".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get unused vouchers in voucher group
     ...
     Get unused vouchers brief information in a voucher group.<br/><br/>The interface requires one of the
