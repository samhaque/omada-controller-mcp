...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/wireless-network/ssids/{ssid_id}/band-steer".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update SSID Template band steer config by site
     ...
     Update SSID Template band steer config by site<br/><br/>The interface requires one of the
