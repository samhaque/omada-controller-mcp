...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/ports".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get AP port list
     ...
     Get AP port list<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
