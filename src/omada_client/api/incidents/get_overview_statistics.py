...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/anomaly/overview/statistics".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get incident overview statistics
     ...
     Get incident overview statistics for the pie chart.<br/><br/>The interface requires one of the
    permissions: <br/>Incidents Page View Only
