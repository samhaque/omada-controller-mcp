...
def sync_detailed(
    ...
    *,
    ...
    """Get SSID list
     ...
     Get SSID list of Wlan group, Legacy note: “wlanId” is the legacy name of “apGroupId”. This endpoint
    will be deprecated in future releases. Please use Get SSID list by site.<br/><br/>The interface
