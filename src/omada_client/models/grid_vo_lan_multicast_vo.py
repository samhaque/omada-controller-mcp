...
T = TypeVar("T", bound="GridVOLanMulticastVO")


@_attrs_define
class GridVOLanMulticastVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = LanMulticastVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_lan_multicast_vo = cls(
        ...
        grid_vo_lan_multicast_vo.additional_properties = d
        return grid_vo_lan_multicast_vo
