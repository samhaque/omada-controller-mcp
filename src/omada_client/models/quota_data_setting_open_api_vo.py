...
T = TypeVar("T", bound="QuotaDataSettingOpenApiVO")


@_attrs_define
class QuotaDataSettingOpenApiVO:
    """Data quota setting.

    Attributes:
        type_ (int): Billing cycle type should be a value as follows: 0:total; 1:monthly.
        limit (bool): Quota limit is enabled/disabled.
        used (float | Unset): The amount of data usage (KB) in current billing cycle.
        start_date (int | Unset): Start date of monthly billing cycle type, valid date should be within the range of
            1–31.
        credit (float | Unset): The amount of data allowance in current billing cycle.
        credit_unit (int | Unset): Unit for data allowance should be a value as follows: 2:MB; 3:GB.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if credit_unit is not UNSET:
            field_dict["creditUnit"] = credit_unit
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        credit_unit = d.pop("creditUnit", UNSET)
        ...
        quota_data_setting_open_api_vo = cls(
            type_=type_,
            limit=limit,
            used=used,
        ...
        quota_data_setting_open_api_vo.additional_properties = d
        return quota_data_setting_open_api_vo
