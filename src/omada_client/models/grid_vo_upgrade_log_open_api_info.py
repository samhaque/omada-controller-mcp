...
if TYPE_CHECKING:
    from ..models.upgrade_log_open_api_info import UpgradeLogOpenApiInfo


T = TypeVar("T", bound="GridVOUpgradeLogOpenApiInfo")


@_attrs_define
class GridVOUpgradeLogOpenApiInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.upgrade_log_open_api_info import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = UpgradeLogOpenApiInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_upgrade_log_open_api_info = cls(
        ...
        grid_vo_upgrade_log_open_api_info.additional_properties = d
        return grid_vo_upgrade_log_open_api_info
