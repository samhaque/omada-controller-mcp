...
if TYPE_CHECKING:
    from ..models.gateway_qos_service_detail_open_api_vo import (
        GatewayQosServiceDetailOpenApiVO,
    )


T = TypeVar("T", bound="GridVOGatewayQosServiceDetailOpenApiVO")


@_attrs_define
class GridVOGatewayQosServiceDetailOpenApiVO:
    """
    Attributes:
        ...
        data (list[GatewayQosServiceDetailOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[GatewayQosServiceDetailOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = GatewayQosServiceDetailOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_gateway_qos_service_detail_open_api_vo = cls(
        ...
        grid_vo_gateway_qos_service_detail_open_api_vo.additional_properties = d
        return grid_vo_gateway_qos_service_detail_open_api_vo
