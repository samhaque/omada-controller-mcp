...
if TYPE_CHECKING:
    from ..models.class_rule_detail_open_api_vo import ClassRuleDetailOpenApiVO


T = TypeVar("T", bound="GridVOClassRuleDetailOpenApiVO")


@_attrs_define
class GridVOClassRuleDetailOpenApiVO:
    """
    Attributes:
        ...
        data (list[ClassRuleDetailOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[ClassRuleDetailOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.class_rule_detail_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ClassRuleDetailOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_class_rule_detail_open_api_vo = cls(
        ...
        grid_vo_class_rule_detail_open_api_vo.additional_properties = d
        return grid_vo_class_rule_detail_open_api_vo
