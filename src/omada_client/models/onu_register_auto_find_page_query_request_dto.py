...
T = TypeVar("T", bound="OnuRegisterAutoFindPageQueryRequestDTO")


@_attrs_define
class OnuRegisterAutoFindPageQueryRequestDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        onu_register_auto_find_page_query_request_dto = cls(
            pon_port=pon_port,
        ...
        onu_register_auto_find_page_query_request_dto.additional_properties = d
        return onu_register_auto_find_page_query_request_dto
