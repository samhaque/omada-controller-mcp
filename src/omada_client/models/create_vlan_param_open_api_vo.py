...
T = TypeVar("T", bound="CreateVlanParamOpenApiVO")


@_attrs_define
class CreateVlanParamOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_vlan_param_open_api_vo = cls(
            lan_network=lan_network,
            device_config=device_config,
        )

        create_vlan_param_open_api_vo.additional_properties = d
        return create_vlan_param_open_api_vo
