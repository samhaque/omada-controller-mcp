...
T = TypeVar("T", bound="VpnOpenApiGridVOVPN")


@_attrs_define
class VpnOpenApiGridVOVPN:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = VPN.from_dict(data_item_data)
        ...
        vpn_open_api_grid_vovpn.additional_properties = d
        return vpn_open_api_grid_vovpn
