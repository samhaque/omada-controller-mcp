...
if TYPE_CHECKING:
    ...
    from ..models.stack_lag_setting_vo_tag_bridge_vlan_map import (
        StackLagSettingVOTagBridgeVlanMap,
    )
    from ..models.stack_lag_setting_vo_untag_bridge_vlan_map import (
        StackLagSettingVOUntagBridgeVlanMap,
    )


T = TypeVar("T", bound="StackLagSettingVO")


@_attrs_define
class StackLagSettingVO:
    """
    Attributes:
        ...
        tag_bridge_vlan_map (StackLagSettingVOTagBridgeVlanMap | Unset): Tag Network Bridge Vlan Map
        untag_network_ids (list[str] | Unset): Untag Network IDs
        untag_bridge_vlan_map (StackLagSettingVOUntagBridgeVlanMap | Unset): Untag Network Bridge Vlan Map
    ...
    tag_bridge_vlan_map: StackLagSettingVOTagBridgeVlanMap | Unset = UNSET
    untag_network_ids: list[str] | Unset = UNSET
    untag_bridge_vlan_map: StackLagSettingVOUntagBridgeVlanMap | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        tag_bridge_vlan_map: StackLagSettingVOTagBridgeVlanMap | Unset
        if isinstance(_tag_bridge_vlan_map, Unset):
            tag_bridge_vlan_map = UNSET
        else:
            tag_bridge_vlan_map = StackLagSettingVOTagBridgeVlanMap.from_dict(
        ...
        untag_bridge_vlan_map: StackLagSettingVOUntagBridgeVlanMap | Unset
        if isinstance(_untag_bridge_vlan_map, Unset):
            untag_bridge_vlan_map = UNSET
        else:
            untag_bridge_vlan_map = StackLagSettingVOUntagBridgeVlanMap.from_dict(
        ...
        stack_lag_setting_vo.additional_properties = d
        return stack_lag_setting_vo
