...
T = TypeVar("T", bound="GridVORestrictionResultEntity")


@_attrs_define
class GridVORestrictionResultEntity:
    """
    Attributes:
        ...
        data (list[RestrictionResultEntity] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[RestrictionResultEntity] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = RestrictionResultEntity.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_restriction_result_entity = cls(
        ...
        grid_vo_restriction_result_entity.additional_properties = d
        return grid_vo_restriction_result_entity
