...
if TYPE_CHECKING:
    from ..models.rogue_ap_scan_result_entry import RogueAPScanResultEntry


T = TypeVar("T", bound="GridVORogueAPScanResultEntry")


@_attrs_define
class GridVORogueAPScanResultEntry:
    """
    Attributes:
        ...
        data (list[RogueAPScanResultEntry] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[RogueAPScanResultEntry] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.rogue_ap_scan_result_entry import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = RogueAPScanResultEntry.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_rogue_ap_scan_result_entry = cls(
        ...
        grid_vo_rogue_ap_scan_result_entry.additional_properties = d
        return grid_vo_rogue_ap_scan_result_entry
