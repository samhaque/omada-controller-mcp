...
T = TypeVar("T", bound="OswNetworkGridOswNetworkOpenApi")


@_attrs_define
class OswNetworkGridOswNetworkOpenApi:
    """
    Attributes:
        ...
        data (list[OswNetworkOpenApi] | Unset):
    ...
    data: list[OswNetworkOpenApi] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswNetworkOpenApi.from_dict(data_item_data)

                data.append(data_item)

        support_ipv_6 = d.pop("supportIpv6", UNSET)

        osw_network_grid_osw_network_open_api = cls(
        ...
        osw_network_grid_osw_network_open_api.additional_properties = d
        return osw_network_grid_osw_network_open_api
