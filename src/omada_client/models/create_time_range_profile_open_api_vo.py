...
T = TypeVar("T", bound="CreateTimeRangeProfileOpenApiVO")


@_attrs_define
class CreateTimeRangeProfileOpenApiVO:
    """
    Attributes:
        name (str): Time range profile name should contain 1 to 64 characters.
        day_mode (int): Time range profile day mode; It should be a value as follows: 0: Every Day, 1: Weekday, 2:
            Weekend, 3: Customized
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_time_range_profile_open_api_vo = cls(
            name=name,
            day_mode=day_mode,
            time_list=time_list,
        ...
        create_time_range_profile_open_api_vo.additional_properties = d
        return create_time_range_profile_open_api_vo
