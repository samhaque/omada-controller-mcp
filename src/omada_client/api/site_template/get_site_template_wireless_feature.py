...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/setting/wireless/feature".format(
...
def sync_detailed(
    ...
    *,
    ...
    """get site template WirelessFeature
     ...
     get site template WirelessFeature.<br/><br/>The interface requires one of the permissions:
