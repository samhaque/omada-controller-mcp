...
if TYPE_CHECKING:
    from ..models.wireguard_detail_open_api_vo import WireguardDetailOpenApiVO


T = TypeVar("T", bound="GridVOWireguardDetailOpenApiVO")


@_attrs_define
class GridVOWireguardDetailOpenApiVO:
    """
    Attributes:
        ...
        data (list[WireguardDetailOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[WireguardDetailOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.wireguard_detail_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = WireguardDetailOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_wireguard_detail_open_api_vo = cls(
        ...
        grid_vo_wireguard_detail_open_api_vo.additional_properties = d
        return grid_vo_wireguard_detail_open_api_vo
