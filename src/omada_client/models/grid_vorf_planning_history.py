...
if TYPE_CHECKING:
    from ..models.rf_planning_history import RFPlanningHistory


T = TypeVar("T", bound="GridVORFPlanningHistory")


@_attrs_define
class GridVORFPlanningHistory:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = RFPlanningHistory.from_dict(data_item_data)

                data.append(data_item)

        grid_vorf_planning_history = cls(
        ...
        grid_vorf_planning_history.additional_properties = d
        return grid_vorf_planning_history
