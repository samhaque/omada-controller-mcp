...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/stack/{stack_id}/ddm/info".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get stack ddm info.
     ...
     Get stack ddm info.<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
