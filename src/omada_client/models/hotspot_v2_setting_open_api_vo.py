...
T = TypeVar("T", bound="HotspotV2SettingOpenApiVO")


@_attrs_define
class HotspotV2SettingOpenApiVO:
    """Hotspot 2.0 is a WFA (Wi-Fi Alliance) technical specification based on IEEE 802.11u protocol.<br />It provides a
    simplified mechanism for wireless clients to discover and connect to suitable networks and switch seamlessly between
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        hotspot_v2_setting_open_api_vo = cls(
        ...
        hotspot_v2_setting_open_api_vo.additional_properties = d
        return hotspot_v2_setting_open_api_vo
