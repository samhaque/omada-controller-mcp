...
T = TypeVar("T", bound="LanNetworkOpenApiV2VO")


@_attrs_define
class LanNetworkOpenApiV2VO:
    """LANNetworkOpenApiVO
    ...
    Attributes:
        ...
        dhcp_settings_vo (DhcpSettingConfig | Unset): Configure DHCP settings
    ...
    dhcp_settings_vo: DhcpSettingConfig | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dhcp_settings_vo: DhcpSettingConfig | Unset
        if isinstance(_dhcp_settings_vo, Unset):
            dhcp_settings_vo = UNSET
        else:
            dhcp_settings_vo = DhcpSettingConfig.from_dict(_dhcp_settings_vo)
        ...
        lan_network_open_api_v2vo.additional_properties = d
        return lan_network_open_api_v2vo
