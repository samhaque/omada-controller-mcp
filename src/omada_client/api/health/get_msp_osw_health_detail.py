...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/msp/{msp_id}/customers/{customer_id}/sites/{site_id}/switches/{switch_mac}/health/detail".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get msp switch health detail
     ...
     Get msp switch health detail<br/><br/>The interface requires one of the permissions: <br/>MSP Device
