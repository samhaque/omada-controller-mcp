...
if TYPE_CHECKING:
    from ..models.ospf_process_open_api_vo import OspfProcessOpenApiVO


T = TypeVar("T", bound="GridVOOspfProcessOpenApiVO")


@_attrs_define
class GridVOOspfProcessOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.ospf_process_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OspfProcessOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ospf_process_open_api_vo = cls(
        ...
        grid_vo_ospf_process_open_api_vo.additional_properties = d
        return grid_vo_ospf_process_open_api_vo
