...
T = TypeVar("T", bound="OuiProfileQueryOpenApiVO")


@_attrs_define
class OuiProfileQueryOpenApiVO:
    """OUIProfileQueryOpenApiVO

    Attributes:
        name (str): OUI Profile name should contain 1 to 64 characters.
        id (str | Unset): OUI Profile ID
        count (int | Unset): OUI Profile count
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        oui_profile_query_open_api_vo = cls(
            name=name,
            id=id,
            count=count,
        ...
        oui_profile_query_open_api_vo.additional_properties = d
        return oui_profile_query_open_api_vo
