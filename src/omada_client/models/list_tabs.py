...
class ListTabs:
    ...
    Attributes:
        ...
        name (str | Unset): Name cannot be duplicated on the dashboard page, it should contain 1 to 64 characters.
        type_ (int | Unset): Type should be a value as follows: 1: Network; 2: Clients; 3: Customized.
