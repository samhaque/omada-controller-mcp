...
T = TypeVar("T", bound="ApMvlanSettingOpenApiVO")


@_attrs_define
class ApMvlanSettingOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ap_mvlan_setting_open_api_vo = cls(
            mode=mode,
            lan_network_id=lan_network_id,
            bridge_vlan=bridge_vlan,
        )

        ap_mvlan_setting_open_api_vo.additional_properties = d
        return ap_mvlan_setting_open_api_vo
