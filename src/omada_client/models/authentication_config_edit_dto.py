...
T = TypeVar("T", bound="AuthenticationConfigEditDTO")


@_attrs_define
class AuthenticationConfigEditDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        authentication_config_edit_dto = cls(
            key=key,
            port_id=port_id,
            onu_id=onu_id,
        ...
        authentication_config_edit_dto.additional_properties = d
        return authentication_config_edit_dto
