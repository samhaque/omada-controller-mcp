...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/devices/{device_mac}/forget/{forget_id}/status".format(
            omadac_id=quote(str(omadac_id), safe=""),
            site_id=quote(str(site_id), safe=""),
            device_mac=quote(str(device_mac), safe=""),
            forget_id=quote(str(forget_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get forget process of device
     ...
     Get forget process of one device from batch-forget. The expire time of result for each device is 300
    seconds.<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
    ...
    later.<br/>-39050  -  This device does not exist.<br/>-39104  -  The current request parameters do
    not exist or the request result has expired.
