...
if TYPE_CHECKING:
    from ..models.ips_signature_info import IpsSignatureInfo


T = TypeVar("T", bound="GridVOIpsSignatureInfo")


@_attrs_define
class GridVOIpsSignatureInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = IpsSignatureInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ips_signature_info = cls(
        ...
        grid_vo_ips_signature_info.additional_properties = d
        return grid_vo_ips_signature_info
