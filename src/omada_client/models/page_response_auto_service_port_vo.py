...
T = TypeVar("T", bound="PageResponseAutoServicePortVO")


@_attrs_define
class PageResponseAutoServicePortVO:
    """
    Attributes:
        content (list[AutoServicePortVO] | Unset): Content
    ...
    content: list[AutoServicePortVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = AutoServicePortVO.from_dict(content_item_data)
        ...
        page_response_auto_service_port_vo = cls(
            content=content,
        ...
        page_response_auto_service_port_vo.additional_properties = d
        return page_response_auto_service_port_vo
