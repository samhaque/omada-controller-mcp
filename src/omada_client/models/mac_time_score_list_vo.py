...
T = TypeVar("T", bound="MacTimeScoreListVO")


@_attrs_define
class MacTimeScoreListVO:
    """Health timeline

    Attributes:
        mac (str | Unset): Mac address
        scores (list[TimeScoreItemVO] | Unset): Health score with time
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        mac_time_score_list_vo = cls(
            mac=mac,
            scores=scores,
        )

        mac_time_score_list_vo.additional_properties = d
        return mac_time_score_list_vo
