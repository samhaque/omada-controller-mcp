...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/url-filters/gateway".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get URL filtering template rule list for gateway
     ...
     Get URL filtering template rule list for gateway.<br/><br/>The interface requires one of the
