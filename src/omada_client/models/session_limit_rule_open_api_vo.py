...
T = TypeVar("T", bound="SessionLimitRuleOpenApiVO")


@_attrs_define
class SessionLimitRuleOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        session_limit_rule_open_api_vo = cls(
            name=name,
            status=status,
        ...
        session_limit_rule_open_api_vo.additional_properties = d
        return session_limit_rule_open_api_vo
