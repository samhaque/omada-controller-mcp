...
from ...models.tcont_list_query_dto import TcontListQueryDTO
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/{line_profile_id}/t-conts/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get t-cont list
     ...
     Get t-cont list<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
