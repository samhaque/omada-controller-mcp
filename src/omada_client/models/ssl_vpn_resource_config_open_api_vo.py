...
T = TypeVar("T", bound="SslVpnResourceConfigOpenApiVO")


@_attrs_define
class SslVpnResourceConfigOpenApiVO:
    """
    Attributes:
        name (str): Name of the SSL VPN resource should contain 1 to 20 characters.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ssl_vpn_resource_config_open_api_vo = cls(
            name=name,
            type_=type_,
            ip=ip,
            mask=mask,
        ...
        ssl_vpn_resource_config_open_api_vo.additional_properties = d
        return ssl_vpn_resource_config_open_api_vo
