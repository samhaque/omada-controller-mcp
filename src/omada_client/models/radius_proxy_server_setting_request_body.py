...
T = TypeVar("T", bound="RadiusProxyServerSettingRequestBody")


@_attrs_define
class RadiusProxyServerSettingRequestBody:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        radius_proxy_server_setting_request_body = cls(
            enable=enable,
            port=port,
        ...
        radius_proxy_server_setting_request_body.additional_properties = d
        return radius_proxy_server_setting_request_body
