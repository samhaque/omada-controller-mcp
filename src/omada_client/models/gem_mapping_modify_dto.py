...
from ..models.gem_mapping_modify_dto_port_mapping_type import (
    GemMappingModifyDTOPortMappingType,
)
from ..models.gem_mapping_modify_dto_vlan_type import GemMappingModifyDTOVlanType
from ..types import UNSET, Unset

T = TypeVar("T", bound="GemMappingModifyDTO")


@_attrs_define
class GemMappingModifyDTO:
    """
    Attributes:
        ...
        line_profile_id (int | Unset): The ID of the associated Line Profile,lineProfileId should be within the range of
            1 to 512.
        vlan_type (GemMappingModifyDTOVlanType | Unset): The mapping relationship between Gem Port and VLAN is valid
            when the Line Profile's mappingMode is set to: Vlan, Vlan-Priority, Port-Vlan, or Port-VLAN-Priority. VlanType
            should be a value as follows: TAGGED;UNTAGGED, with the default value being TAGGED.
        ...
        port_mapping_type (GemMappingModifyDTOPortMappingType | Unset): The mapping relationship between Gem Port and
            ONT Port ID is valid when the Line Profile's mappingMode is set to: Port, Port-Vlan, Port-Priority, or Port-
            Vlan-Priority. PortMappingType should be a value as follows: ETH, with the default value being ETH.
    ...
    vlan_type: GemMappingModifyDTOVlanType | Unset = UNSET
    vlan_id: int | Unset = UNSET
    priority: int | Unset = UNSET
    port_mapping_type: GemMappingModifyDTOPortMappingType | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        vlan_type: GemMappingModifyDTOVlanType | Unset
        if isinstance(_vlan_type, Unset):
            vlan_type = UNSET
        else:
            vlan_type = GemMappingModifyDTOVlanType(_vlan_type)
        ...
        port_mapping_type: GemMappingModifyDTOPortMappingType | Unset
        if isinstance(_port_mapping_type, Unset):
            port_mapping_type = UNSET
        else:
            port_mapping_type = GemMappingModifyDTOPortMappingType(_port_mapping_type)

        port_id = d.pop("portId", UNSET)

        gem_mapping_modify_dto = cls(
        ...
        gem_mapping_modify_dto.additional_properties = d
        return gem_mapping_modify_dto
