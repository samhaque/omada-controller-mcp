...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/lan/dns".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create LAN Dns template
     ...
     Create lan Dns template<br/><br/>The interface requires one of the permissions: <br/>Global Site
    ...
    duplicate DNS servers.<br/>-35311  -  Domain name and alias are duplicate.<br/>-35312  -  The
    gateway does not support LAN DNS.<br/>-35313  -  The gateway does not support configuring TTL in LAN
    DNS.
