...
def sync_detailed(
    ...
    *,
    ...
    """Modify an existing Bonjour Service Template
     ...
     Modify an existing Bonjour Service Template.<br/><br/>The interface requires one of the permissions:
    ...
    request parameters.<br/>-33756  -  This Bonjour Service name already exists.<br/>-33758  -  One or
    more Bonjour Services do not exist.<br/>-33759  -  Build-in Bonjour Service cannot be edited or
    deleted.
