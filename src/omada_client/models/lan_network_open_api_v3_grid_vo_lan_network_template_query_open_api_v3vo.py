...
if TYPE_CHECKING:
    from ..models.lan_network_template_query_open_api_v3vo import (
        LanNetworkTemplateQueryOpenApiV3VO,
    )


T = TypeVar("T", bound="LanNetworkOpenApiV3GridVOLanNetworkTemplateQueryOpenApiV3VO")


@_attrs_define
class LanNetworkOpenApiV3GridVOLanNetworkTemplateQueryOpenApiV3VO:
    """
    Attributes:
        ...
        data (list[LanNetworkTemplateQueryOpenApiV3VO] | Unset):
    ...
    data: list[LanNetworkTemplateQueryOpenApiV3VO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = LanNetworkTemplateQueryOpenApiV3VO.from_dict(data_item_data)
        ...
        lan_network_open_api_v3_grid_vo_lan_network_template_query_open_api_v3vo = cls(
        ...
        lan_network_open_api_v3_grid_vo_lan_network_template_query_open_api_v3vo.additional_properties = d
        return lan_network_open_api_v3_grid_vo_lan_network_template_query_open_api_v3vo
