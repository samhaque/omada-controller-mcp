...
T = TypeVar("T", bound="FloatSubHealthInfoDetailVO")


@_attrs_define
class FloatSubHealthInfoDetailVO:
    """Error frame health info and score
    ...
    Attributes:
        ...
        average_float (float | Unset): Average float value of common dimension
        past_floats (list[TimeFloatValueItemVO] | Unset): List of common dimension float value
    """
    ...
    average_float: float | Unset = UNSET
    past_floats: list[TimeFloatValueItemVO] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        average_float = self.average_float

        past_floats: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.past_floats, Unset):
            past_floats = []
            for past_floats_item_data in self.past_floats:
                past_floats_item = past_floats_item_data.to_dict()
                past_floats.append(past_floats_item)
        ...
        if average_float is not UNSET:
            field_dict["averageFloat"] = average_float
        if past_floats is not UNSET:
            field_dict["pastFloats"] = past_floats
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        average_float = d.pop("averageFloat", UNSET)

        _past_floats = d.pop("pastFloats", UNSET)
        past_floats: list[TimeFloatValueItemVO] | Unset = UNSET
        if _past_floats is not UNSET:
            past_floats = []
            for past_floats_item_data in _past_floats:
                past_floats_item = TimeFloatValueItemVO.from_dict(past_floats_item_data)

                past_floats.append(past_floats_item)

        float_sub_health_info_detail_vo = cls(
            ...
            past_floats=past_floats,
        )

        float_sub_health_info_detail_vo.additional_properties = d
        return float_sub_health_info_detail_vo
