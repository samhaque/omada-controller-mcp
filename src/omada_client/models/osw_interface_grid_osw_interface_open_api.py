...
if TYPE_CHECKING:
    from ..models.osw_interface_open_api import OswInterfaceOpenApi


T = TypeVar("T", bound="OswInterfaceGridOswInterfaceOpenApi")


@_attrs_define
class OswInterfaceGridOswInterfaceOpenApi:
    """
    Attributes:
        ...
        data (list[OswInterfaceOpenApi] | Unset):
        support_ipv_6 (bool | Unset): Switch supports ipv6 or not.
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[OswInterfaceOpenApi] | Unset = UNSET
    support_ipv_6: bool | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswInterfaceOpenApi.from_dict(data_item_data)

                data.append(data_item)

        support_ipv_6 = d.pop("supportIpv6", UNSET)

        osw_interface_grid_osw_interface_open_api = cls(
        ...
        osw_interface_grid_osw_interface_open_api.additional_properties = d
        return osw_interface_grid_osw_interface_open_api
