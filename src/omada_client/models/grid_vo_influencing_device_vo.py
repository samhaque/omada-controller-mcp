...
if TYPE_CHECKING:
    from ..models.influencing_device_vo import InfluencingDeviceVO


T = TypeVar("T", bound="GridVOInfluencingDeviceVO")


@_attrs_define
class GridVOInfluencingDeviceVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = InfluencingDeviceVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_influencing_device_vo = cls(
        ...
        grid_vo_influencing_device_vo.additional_properties = d
        return grid_vo_influencing_device_vo
