...
T = TypeVar("T", bound="PageResponseServiceProfileVO")


@_attrs_define
class PageResponseServiceProfileVO:
    """
    Attributes:
        content (list[ServiceProfileVO] | Unset): Content
    ...
    content: list[ServiceProfileVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ServiceProfileVO.from_dict(content_item_data)
        ...
        page_response_service_profile_vo = cls(
            content=content,
        ...
        page_response_service_profile_vo.additional_properties = d
        return page_response_service_profile_vo
