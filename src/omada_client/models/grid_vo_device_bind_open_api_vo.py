...
T = TypeVar("T", bound="GridVODeviceBindOpenApiVO")


@_attrs_define
class GridVODeviceBindOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = DeviceBindOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_device_bind_open_api_vo = cls(
        ...
        grid_vo_device_bind_open_api_vo.additional_properties = d
        return grid_vo_device_bind_open_api_vo
