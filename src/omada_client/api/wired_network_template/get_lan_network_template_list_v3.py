...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v3/{omadac_id}/sitetemplates/{site_template_id}/lan-networks".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get LAN network template list
     ...
     Get LAN network template list.(Pagination)<br/><br/>The interface requires one of the permissions:
