...
if TYPE_CHECKING:
    from ..models.class_rule_template_detail_open_api_vo import (
        ClassRuleTemplateDetailOpenApiVO,
    )


T = TypeVar("T", bound="GridVOClassRuleTemplateDetailOpenApiVO")


@_attrs_define
class GridVOClassRuleTemplateDetailOpenApiVO:
    """
    Attributes:
        ...
        data (list[ClassRuleTemplateDetailOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[ClassRuleTemplateDetailOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ClassRuleTemplateDetailOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_class_rule_template_detail_open_api_vo = cls(
        ...
        grid_vo_class_rule_template_detail_open_api_vo.additional_properties = d
        return grid_vo_class_rule_template_detail_open_api_vo
