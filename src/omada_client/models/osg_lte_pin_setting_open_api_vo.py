...
T = TypeVar("T", bound="OsgLtePinSettingOpenApiVO")


@_attrs_define
class OsgLtePinSettingOpenApiVO:
    """PIN settings.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osg_lte_pin_setting_open_api_vo = cls(
        ...
        osg_lte_pin_setting_open_api_vo.additional_properties = d
        return osg_lte_pin_setting_open_api_vo
