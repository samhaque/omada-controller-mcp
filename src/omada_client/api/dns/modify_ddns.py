...
def sync_detailed(
    ...
    *,
    ...
    """Modify an exist Dynamic DNS entry
     ...
     Modify an exist Dynamic DNS entry with the given params.<br/><br/>The interface requires one of the
    ...
    provider.<br/>-34564  -  The TP-Link Dynamic DNS domain name cannot contain sensitive fields such as
    email, tp-link, tplink, and www.<br/>-34565  -  The TP-Link Dynamic DNS domain name should end with
    ".tplinkdns.com".<br/>-34566  -  The TP-Link Dynamic DNS domain name is invalid.
