...
T = TypeVar("T", bound="ConnectScoreSubHealthInfoDetailVO")


@_attrs_define
class ConnectScoreSubHealthInfoDetailVO:
    """Connect score and status (wired clients only)
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if connect_status is not UNSET:
            field_dict["connectStatus"] = connect_status
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        connect_status = d.pop("connectStatus", UNSET)

        connect_score_sub_health_info_detail_vo = cls(
        ...
        connect_score_sub_health_info_detail_vo.additional_properties = d
        return connect_score_sub_health_info_detail_vo
