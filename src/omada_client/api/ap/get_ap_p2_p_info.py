...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/p2pInfo".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get P2P bridge group info
     ...
     Get P2P bridge group info<br/><br/>The interface requires one of the permissions: <br/>Site Device
