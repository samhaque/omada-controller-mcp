...
T = TypeVar("T", bound="UpdateApVlanOpenApiVO")


@_attrs_define
class UpdateApVlanOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_ap_vlan_open_api_vo = cls(
            mvlan_setting=mvlan_setting,
            voip_vlan_setting=voip_vlan_setting,
        )

        update_ap_vlan_open_api_vo.additional_properties = d
        return update_ap_vlan_open_api_vo
