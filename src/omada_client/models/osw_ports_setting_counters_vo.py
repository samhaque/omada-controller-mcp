...
T = TypeVar("T", bound="OswPortsSettingCountersVO")


@_attrs_define
class OswPortsSettingCountersVO:
    """
    Attributes:
        port (int | Unset): Port
        ...
        tx_bytes (int | Unset): Total Tx Bytes
        tx_frames (int | Unset): Total TX Packets
        tx_multicast (int | Unset): Total TX Multicast Packets
        tx_broadcast (int | Unset): Total TX Broadcast Packets
        tx_errors (int | Unset): Total TX Errors
        rx_bytes (int | Unset): Total Rx Bytes
        rx_frames (int | Unset): Total RX Packets
        rx_multicast (int | Unset): Total RX Multicast Packets
        rx_broadcast (int | Unset): Total RX Broadcast Packets
        rx_errors (int | Unset): Total RX Errors
    """
    ...
    tx_frames: int | Unset = UNSET
    tx_multicast: int | Unset = UNSET
    tx_broadcast: int | Unset = UNSET
    tx_errors: int | Unset = UNSET
    rx_bytes: int | Unset = UNSET
    rx_frames: int | Unset = UNSET
    rx_multicast: int | Unset = UNSET
    rx_broadcast: int | Unset = UNSET
    rx_errors: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if tx_bytes is not UNSET:
            field_dict["txBytes"] = tx_bytes
        if tx_frames is not UNSET:
            field_dict["txFrames"] = tx_frames
        if tx_multicast is not UNSET:
            field_dict["txMulticast"] = tx_multicast
        if tx_broadcast is not UNSET:
            field_dict["txBroadcast"] = tx_broadcast
        if tx_errors is not UNSET:
            field_dict["txErrors"] = tx_errors
        if rx_bytes is not UNSET:
            field_dict["rxBytes"] = rx_bytes
        if rx_frames is not UNSET:
            field_dict["rxFrames"] = rx_frames
        if rx_multicast is not UNSET:
            field_dict["rxMulticast"] = rx_multicast
        if rx_broadcast is not UNSET:
            field_dict["rxBroadcast"] = rx_broadcast
        if rx_errors is not UNSET:
            field_dict["rxErrors"] = rx_errors
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        tx_bytes = d.pop("txBytes", UNSET)

        tx_frames = d.pop("txFrames", UNSET)

        tx_multicast = d.pop("txMulticast", UNSET)

        tx_broadcast = d.pop("txBroadcast", UNSET)

        tx_errors = d.pop("txErrors", UNSET)

        rx_bytes = d.pop("rxBytes", UNSET)

        rx_frames = d.pop("rxFrames", UNSET)

        rx_multicast = d.pop("rxMulticast", UNSET)

        rx_broadcast = d.pop("rxBroadcast", UNSET)

        rx_errors = d.pop("rxErrors", UNSET)

        osw_ports_setting_counters_vo = cls(
            port=port,
        ...
        osw_ports_setting_counters_vo.additional_properties = d
        return osw_ports_setting_counters_vo
