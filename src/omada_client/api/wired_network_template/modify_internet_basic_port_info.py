...
from ...models.internet_base_config_template_open_api_vo import (
...
def _get_kwargs(
    ...
    *,
    body: InternetBaseConfigTemplateOpenApiVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/internet/basic-info".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify site template internet basic configuration
     ...
     Modify site template internet basic configuration.<br/><br/>The interface requires one of the
    ...
    <br/>-33400  -  Current site has no WAN.<br/>-33531  -  This WAN port has been used by other
    networks.
