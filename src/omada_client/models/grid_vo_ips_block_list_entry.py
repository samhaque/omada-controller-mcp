...
if TYPE_CHECKING:
    from ..models.ips_block_list_entry import IpsBlockListEntry


T = TypeVar("T", bound="GridVOIpsBlockListEntry")


@_attrs_define
class GridVOIpsBlockListEntry:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = IpsBlockListEntry.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ips_block_list_entry = cls(
        ...
        grid_vo_ips_block_list_entry.additional_properties = d
        return grid_vo_ips_block_list_entry
