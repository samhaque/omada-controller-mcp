...
T = TypeVar("T", bound="LanNetworkQueryOpenApiV3VO")


@_attrs_define
class LanNetworkQueryOpenApiV3VO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        lan_network_query_open_api_v3vo = cls(
            name=name,
            purpose=purpose,
        ...
        lan_network_query_open_api_v3vo.additional_properties = d
        return lan_network_query_open_api_v3vo
