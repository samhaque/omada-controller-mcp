...
T = TypeVar("T", bound="ClassRuleDetailOpenApiVO")


@_attrs_define
class ClassRuleDetailOpenApiVO:
    """
    Attributes:
        ...
        service_type (str | Unset): The ID of Gateway Qos Service selected in the Service Name configuration. The ID can
            be obtained from 'Get all Gateway QoS Service's ID and name info' interface.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        class_rule_detail_open_api_vo = cls(
            id=id,
            enable=enable,
        ...
        class_rule_detail_open_api_vo.additional_properties = d
        return class_rule_detail_open_api_vo
