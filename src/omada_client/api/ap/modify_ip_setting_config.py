...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/ip-setting".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify AP ip setting
     ...
     Modify AP IP setting<br/><br/>The interface requires one of the permissions: <br/>Site Device
