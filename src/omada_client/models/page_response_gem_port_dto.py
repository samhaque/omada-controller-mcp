...
T = TypeVar("T", bound="PageResponseGemPortDTO")


@_attrs_define
class PageResponseGemPortDTO:
    """
    Attributes:
        content (list[GemPortDTO] | Unset): Content
    ...
    content: list[GemPortDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = GemPortDTO.from_dict(content_item_data)
        ...
        page_response_gem_port_dto = cls(
            content=content,
        ...
        page_response_gem_port_dto.additional_properties = d
        return page_response_gem_port_dto
