...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/stack/{stack_id}/interfaces/pmtud".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify Stack Path MTU Discovery
     ...
     modify Stack Path MTU Discovery.<br/><br/>The interface requires one of the permissions: <br/>Site
