...
if TYPE_CHECKING:
    from ..models.provider_profile_entity import ProviderProfileEntity


T = TypeVar("T", bound="GridVOProviderProfileEntity")


@_attrs_define
class GridVOProviderProfileEntity:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.provider_profile_entity import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ProviderProfileEntity.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_provider_profile_entity = cls(
        ...
        grid_vo_provider_profile_entity.additional_properties = d
        return grid_vo_provider_profile_entity
