...
class SitesSite:
    ...
    Attributes:
        ...
        data (list[Site] | Unset):
        all_site_ids (list[str] | Unset): all sites id.
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[Site] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = Site.from_dict(data_item_data)
        ...
        sites_site.additional_properties = d
        return sites_site
