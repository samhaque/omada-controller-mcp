...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/system/system-info/configs/edit".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify OLT description info
     ...
     Modify OLT description info<br/><br/>The interface requires one of the permissions: <br/>Site Device
