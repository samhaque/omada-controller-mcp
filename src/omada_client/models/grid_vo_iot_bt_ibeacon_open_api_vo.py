...
if TYPE_CHECKING:
    from ..models.iot_bt_ibeacon_open_api_vo import IotBtIbeaconOpenApiVO


T = TypeVar("T", bound="GridVOIotBtIbeaconOpenApiVO")


@_attrs_define
class GridVOIotBtIbeaconOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.iot_bt_ibeacon_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = IotBtIbeaconOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_iot_bt_ibeacon_open_api_vo = cls(
        ...
        grid_vo_iot_bt_ibeacon_open_api_vo.additional_properties = d
        return grid_vo_iot_bt_ibeacon_open_api_vo
