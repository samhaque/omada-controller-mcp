...
from ...models.line_profile_list_query_dto import LineProfileListQueryDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: LineProfileListQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/profiles/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get line profile list
     ...
     Get line profile list<br/><br/>The interface requires one of the permissions: <br/>Site Device
