...
T = TypeVar("T", bound="PageResponseTcontVO")


@_attrs_define
class PageResponseTcontVO:
    """
    Attributes:
        content (list[TcontVO] | Unset): Content
    ...
    content: list[TcontVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = TcontVO.from_dict(content_item_data)
        ...
        page_response_tcont_vo.additional_properties = d
        return page_response_tcont_vo
