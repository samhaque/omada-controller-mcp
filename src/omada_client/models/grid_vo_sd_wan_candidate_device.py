...
T = TypeVar("T", bound="GridVOSdWanCandidateDevice")


@_attrs_define
class GridVOSdWanCandidateDevice:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SdWanCandidateDevice.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_sd_wan_candidate_device = cls(
        ...
        grid_vo_sd_wan_candidate_device.additional_properties = d
        return grid_vo_sd_wan_candidate_device
