...
if TYPE_CHECKING:
    from ..models.osw_lldp_neighbor_vo import OswLldpNeighborVO


T = TypeVar("T", bound="GridVOOswLldpNeighborVO")


@_attrs_define
class GridVOOswLldpNeighborVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswLldpNeighborVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osw_lldp_neighbor_vo = cls(
        ...
        grid_vo_osw_lldp_neighbor_vo.additional_properties = d
        return grid_vo_osw_lldp_neighbor_vo
