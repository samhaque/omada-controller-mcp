...
T = TypeVar("T", bound="PartnerLinkDTO")


@_attrs_define
class PartnerLinkDTO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        partner_link_dto.additional_properties = d
        return partner_link_dto
