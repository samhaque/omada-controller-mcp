...
T = TypeVar("T", bound="LineProfilePageQueryDTO")


@_attrs_define
class LineProfilePageQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        line_profile_page_query_dto = cls(
        ...
        line_profile_page_query_dto.additional_properties = d
        return line_profile_page_query_dto
