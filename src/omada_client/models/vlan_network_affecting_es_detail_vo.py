...
if TYPE_CHECKING:
    from ..models.es_detail_vo import ESDetailVO
    from ..models.osw_client_vo import OswClientVO
    from ..models.osw_port_and_lag_network_vo import OswPortAndLagNetworkVO


T = TypeVar("T", bound="VlanNetworkAffectingEsDetailVO")


@_attrs_define
class VlanNetworkAffectingEsDetailVO:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        es_detail: dict[str, Any] | Unset = UNSET
        if not isinstance(self.es_detail, Unset):
            es_detail = self.es_detail.to_dict()
        ...
        if es_detail is not UNSET:
            field_dict["esDetail"] = es_detail
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        _es_detail = d.pop("esDetail", UNSET)
        es_detail: ESDetailVO | Unset
        if isinstance(_es_detail, Unset):
            es_detail = UNSET
        else:
            es_detail = ESDetailVO.from_dict(_es_detail)

        vlan_network_affecting_es_detail_vo = cls(
        ...
        vlan_network_affecting_es_detail_vo.additional_properties = d
        return vlan_network_affecting_es_detail_vo
