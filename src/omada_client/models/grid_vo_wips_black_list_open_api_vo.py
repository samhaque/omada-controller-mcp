...
if TYPE_CHECKING:
    from ..models.wips_black_list_open_api_vo import WipsBlackListOpenApiVO


T = TypeVar("T", bound="GridVOWipsBlackListOpenApiVO")


@_attrs_define
class GridVOWipsBlackListOpenApiVO:
    """
    Attributes:
        ...
        data (list[WipsBlackListOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[WipsBlackListOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.wips_black_list_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = WipsBlackListOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_wips_black_list_open_api_vo = cls(
        ...
        grid_vo_wips_black_list_open_api_vo.additional_properties = d
        return grid_vo_wips_black_list_open_api_vo
