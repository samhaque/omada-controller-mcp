...
if TYPE_CHECKING:
    from ..models.plan_upgrade_info import PlanUpgradeInfo


T = TypeVar("T", bound="GridVOPlanUpgradeInfo")


@_attrs_define
class GridVOPlanUpgradeInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = PlanUpgradeInfo.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_plan_upgrade_info = cls(
        ...
        grid_vo_plan_upgrade_info.additional_properties = d
        return grid_vo_plan_upgrade_info
