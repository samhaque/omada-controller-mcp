...
T = TypeVar("T", bound="OswStackLagVO")
...
class OswStackLagVO:
    ...
    Attributes:
        ...
        stand_ports (list[OswStandPortVO] | Unset): Standard LAG Ports
    """
    ...
    stand_ports: list[OswStandPortVO] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        stand_ports: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.stand_ports, Unset):
            stand_ports = []
            for stand_ports_item_data in self.stand_ports:
                stand_ports_item = stand_ports_item_data.to_dict()
                stand_ports.append(stand_ports_item)
        ...
        if stand_ports is not UNSET:
            field_dict["standPorts"] = stand_ports
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        _stand_ports = d.pop("standPorts", UNSET)
        stand_ports: list[OswStandPortVO] | Unset = UNSET
        if _stand_ports is not UNSET:
            stand_ports = []
            for stand_ports_item_data in _stand_ports:
                stand_ports_item = OswStandPortVO.from_dict(stand_ports_item_data)

                stand_ports.append(stand_ports_item)

        osw_stack_lag_vo = cls(
            lag_id=lag_id,
            ports=ports,
            lag_type=lag_type,
            mlag_name=mlag_name,
            ...
            stack_id=stack_id,
            stand_ports=stand_ports,
        )

        osw_stack_lag_vo.additional_properties = d
        return osw_stack_lag_vo
