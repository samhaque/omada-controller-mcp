...
T = TypeVar("T", bound="RoleDetailOpenApiVO")


@_attrs_define
class RoleDetailOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        role_detail_open_api_vo.additional_properties = d
        return role_detail_open_api_vo
