...
T = TypeVar("T", bound="ClientIncidentCountResultOpenApiVO")


@_attrs_define
class ClientIncidentCountResultOpenApiVO:
    """
    Attributes:
        incidents (list[Incident] | Unset): Incident counts for the requested clients.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        client_incident_count_result_open_api_vo = cls(
            incidents=incidents,
        )

        client_incident_count_result_open_api_vo.additional_properties = d
        return client_incident_count_result_open_api_vo
