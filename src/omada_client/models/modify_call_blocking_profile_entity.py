...
T = TypeVar("T", bound="ModifyCallBlockingProfileEntity")


@_attrs_define
class ModifyCallBlockingProfileEntity:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        modify_call_blocking_profile_entity = cls(
        ...
        modify_call_blocking_profile_entity.additional_properties = d
        return modify_call_blocking_profile_entity
