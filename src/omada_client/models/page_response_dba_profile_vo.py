...
T = TypeVar("T", bound="PageResponseDBAProfileVO")


@_attrs_define
class PageResponseDBAProfileVO:
    """
    Attributes:
        content (list[DBAProfileVO] | Unset): Content
    ...
    content: list[DBAProfileVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = DBAProfileVO.from_dict(content_item_data)
        ...
        page_response_dba_profile_vo = cls(
            content=content,
        ...
        page_response_dba_profile_vo.additional_properties = d
        return page_response_dba_profile_vo
