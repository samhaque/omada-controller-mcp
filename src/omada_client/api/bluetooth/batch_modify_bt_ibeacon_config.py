...
from ...models.batch_modify_ibeacon_open_api_vo import BatchModifyIbeaconOpenApiVO
...
def _get_kwargs(
    ...
    site_id: str,
    *,
    body: BatchModifyIbeaconOpenApiVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/setting/iot/devices/config/batch-config".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Batch modify Bluetooth Advertising
     ...
     Batch modify Bluetooth Advertising. Note:The parameter [transmitPower] is deprecated, all devices
