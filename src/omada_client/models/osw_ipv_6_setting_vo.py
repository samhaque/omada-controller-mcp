...
T = TypeVar("T", bound="OswIpv6SettingVO")


@_attrs_define
class OswIpv6SettingVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osw_ipv_6_setting_vo.additional_properties = d
        return osw_ipv_6_setting_vo
