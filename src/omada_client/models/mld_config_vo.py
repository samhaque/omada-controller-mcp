...
class MldConfigVO:
    ...
    Attributes:
        ...
        query_interval (int | Unset): The time interval for the MLD query to send query messages (unit: s).
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        mld_config_vo.additional_properties = d
        return mld_config_vo
