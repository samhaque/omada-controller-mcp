...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/setting/virtual-wans".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create virtual WAN
     ...
     Create virtual WAN.<br/><br/>The interface requires one of the permissions: <br/>Site Settings
    ...
    This feature is not supported for the DS-Lite or Map-E WAN connection types.<br/>-44701  -  This
    VLAN ID is already used by the Virtual WAN interface.<br/>-44702  -  Duplicate names of the virtual
