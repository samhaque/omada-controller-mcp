...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/grid/allow-list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get site template grid ips allow list
     ...
     Obtain site template grid allow list.<br/><br/>The interface requires one of the permissions:
