...
T = TypeVar("T", bound="GridVOApplicationEntity")


@_attrs_define
class GridVOApplicationEntity:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ApplicationEntity.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_application_entity = cls(
        ...
        grid_vo_application_entity.additional_properties = d
        return grid_vo_application_entity
