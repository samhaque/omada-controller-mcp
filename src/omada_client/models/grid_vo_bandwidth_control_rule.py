...
if TYPE_CHECKING:
    from ..models.bandwidth_control_rule import BandwidthControlRule


T = TypeVar("T", bound="GridVOBandwidthControlRule")


@_attrs_define
class GridVOBandwidthControlRule:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.bandwidth_control_rule import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = BandwidthControlRule.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_bandwidth_control_rule = cls(
        ...
        grid_vo_bandwidth_control_rule.additional_properties = d
        return grid_vo_bandwidth_control_rule
