...
if TYPE_CHECKING:
    from ..models.cli_template_open_api_vo import CliTemplateOpenApiVO


T = TypeVar("T", bound="GridVOCliTemplateOpenApiVO")


@_attrs_define
class GridVOCliTemplateOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.cli_template_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = CliTemplateOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_cli_template_open_api_vo = cls(
        ...
        grid_vo_cli_template_open_api_vo.additional_properties = d
        return grid_vo_cli_template_open_api_vo
