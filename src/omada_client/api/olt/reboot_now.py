...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/system/system-tools/reboot/now".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Reboot OLT
     ...
     Reboot OLT<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
