...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/stacks".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create Switch Stack
     ...
     Create Switch Stack.<br/><br/>The interface requires one of the permissions: <br/>Site Device
    ...
    controller.<br/>-39700  -  Switch does not exist<br/>-39715  -  The member port in the LAG is
    invalid.<br/>-40201  -  Incompatible stack device exists. Please check the stack compatibility.
