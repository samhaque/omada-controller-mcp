...
T = TypeVar("T", bound="GridVOMonitorDevice")


@_attrs_define
class GridVOMonitorDevice:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = MonitorDevice.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_monitor_device = cls(
        ...
        grid_vo_monitor_device.additional_properties = d
        return grid_vo_monitor_device
