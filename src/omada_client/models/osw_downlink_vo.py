...
T = TypeVar("T", bound="OswDownlinkVO")
...
class OswDownlinkVO:
    ...
    Attributes:
        ...
        type_ (str | Unset): The type of downlink device, it should be a value as follows: ap, gateway, switch(stack)
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osw_downlink_vo.additional_properties = d
        return osw_downlink_vo
