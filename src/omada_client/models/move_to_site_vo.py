...
T = TypeVar("T", bound="MoveToSiteVO")
...
class MoveToSiteVO:
    ...
    Attributes:
        ...
        device_macs (list[str] | Unset): Device macs.If only stacking is migrated, then it is empty.
        stack_ids (list[str] | Unset): The stack to be migrated; all stack members are migrated together during the
            migration.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        move_to_site_vo.additional_properties = d
        return move_to_site_vo
