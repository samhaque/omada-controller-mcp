...
from ...models.onu_management_list_query_request_dto import (
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: OnuManagementListQueryRequestDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/onu-management/informations/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ONU information config list
     ...
     Get ONU information config list<br/><br/>The interface requires one of the permissions: <br/>Site
