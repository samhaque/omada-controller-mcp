...
T = TypeVar("T", bound="GemPortPageQueryDTO")


@_attrs_define
class GemPortPageQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        gem_port_page_query_dto.additional_properties = d
        return gem_port_page_query_dto
