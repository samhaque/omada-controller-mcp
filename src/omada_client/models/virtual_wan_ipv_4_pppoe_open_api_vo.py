...
if TYPE_CHECKING:
    from ..models.virtual_wan_ipv_4_connection_2_open_api_vo import (
        VirtualWanIpv4Connection2OpenApiVO,
    )


T = TypeVar("T", bound="VirtualWanIpv4PppoeOpenApiVO")


@_attrs_define
class VirtualWanIpv4PppoeOpenApiVO:
    ...
    Attributes:
        ...
        redial_interval (int): It is required when [linkType] is auto. Unit: Second
        mtu (int): Parameter [mtu] should be a value between 576 and 1492
        mru (int): Parameter [mru] should be a value between 576 and 1492
        ipv_4_connection_2 (VirtualWanIpv4Connection2OpenApiVO): VirtualWanIpv4Connection2OpenApiVO
        ...
        service (str | Unset): Service name. Keep parameter [service] blank unless your ISP requires you to configure
            it.
        netmask (str | Unset): Subnet mask.
        dns1 (str | Unset): Primary DNS
        dns2 (str | Unset): Secondary DNS
        mss_clamping_value (int | Unset):
    """
    ...
    mtu: int
    mru: int
    ipv_4_connection_2: VirtualWanIpv4Connection2OpenApiVO
    mss_clamping_type: int
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ipv_4_connection_2 = VirtualWanIpv4Connection2OpenApiVO.from_dict(
        ...
        virtual_wan_ipv_4_pppoe_open_api_vo = cls(
            user_name=user_name,
            password=password,
        ...
        virtual_wan_ipv_4_pppoe_open_api_vo.additional_properties = d
        return virtual_wan_ipv_4_pppoe_open_api_vo
