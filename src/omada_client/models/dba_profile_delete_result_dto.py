...
T = TypeVar("T", bound="DBAProfileDeleteResultDTO")


@_attrs_define
class DBAProfileDeleteResultDTO:
    """Device configuration information.If the type of data is 'Object',ignore this field

    Attributes:
        profiles_in_use (list[int] | Unset): List of DBA Profile IDs that failed to delete due to being in use.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dba_profile_delete_result_dto = cls(
            profiles_in_use=profiles_in_use,
        )

        dba_profile_delete_result_dto.additional_properties = d
        return dba_profile_delete_result_dto
