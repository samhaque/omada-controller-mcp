...
T = TypeVar("T", bound="SwitchBatchLoopbackControl")


@_attrs_define
class SwitchBatchLoopbackControl:
    """
    Attributes:
        ...
        max_hops (int | Unset): maxHops should be between 1 and 40.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        switch_batch_loopback_control = cls(
        ...
        switch_batch_loopback_control.additional_properties = d
        return switch_batch_loopback_control
