...
T = TypeVar("T", bound="DeleteAnomalyListSettingVO")


@_attrs_define
class DeleteAnomalyListSettingVO:
    """
    Attributes:
        incidents (list[str] | Unset): List of anomaly event IDs to operate on.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        delete_anomaly_list_setting_vo = cls(
            incidents=incidents,
        ...
        delete_anomaly_list_setting_vo.additional_properties = d
        return delete_anomaly_list_setting_vo
