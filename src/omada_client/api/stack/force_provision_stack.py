...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/cmd/stack/{stack_id}/forceProvision".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Force provision stack
     ...
     Force provision stack.<br/><br/>The interface requires one of the permissions: <br/>Site Device
