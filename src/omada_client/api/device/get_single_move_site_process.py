...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/devices/{device_mac}/move/{move_site_id}/status".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get move site process of device
     ...
     Get move site process of one device from batch-move-site. The expire time of result for each device
    is 300 seconds<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
