...
T = TypeVar("T", bound="ClientsWithOnBoardingTimes")


@_attrs_define
class ClientsWithOnBoardingTimes:
    """Client distribution with association times.

    Attributes:
        less_than_2_s_num (int | Unset): Number of clients with association time less than 2 seconds.
        from_2_to_4_s_num (int | Unset): Number of clients with association time less than 4 seconds and greater than or
            equal to 2 seconds.
        from_4_to_6_s_num (int | Unset): Number of clients with association time less than 6 seconds and greater than or
            equal to 4 seconds.
        from_6_to_8_s_num (int | Unset): Number of clients with association time less than 8 seconds and greater than or
            equal to 6 seconds.
        from_8_to_10_s_num (int | Unset): Number of clients with association time less than 10 seconds and greater than
            or equal to 8 seconds.
        more_than_10_s_num (int | Unset): Number of clients with association time greater than or equal to 10 seconds.
        fails (int | Unset): Number of clients with failed association,
        less_than_10_s_percent (int | Unset): Percentage of association time less than 10 seconds.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        clients_with_on_boarding_times = cls(
        ...
        clients_with_on_boarding_times.additional_properties = d
        return clients_with_on_boarding_times
