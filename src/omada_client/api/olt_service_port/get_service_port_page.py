...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/service-ports/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get service port page
     ...
     Get service port page<br/><br/>The interface requires one of the permissions: <br/>Site Device
