...
T = TypeVar("T", bound="MspUnknownDeviceOpenApiVO")


@_attrs_define
class MspUnknownDeviceOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        msp_unknown_device_open_api_vo = cls(
            mac=mac,
            name=name,
            type_=type_,
            subtype=subtype,
        ...
        msp_unknown_device_open_api_vo.additional_properties = d
        return msp_unknown_device_open_api_vo
