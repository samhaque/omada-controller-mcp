...
T = TypeVar("T", bound="HotspotRadiusSetting")


@_attrs_define
class HotspotRadiusSetting:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        hotspot_radius_setting.additional_properties = d
        return hotspot_radius_setting
