...
if TYPE_CHECKING:
    ...
    from ..models.osw_lag_setting_vo_tag_bridge_vlan_map import (
        OswLagSettingVOTagBridgeVlanMap,
    )
    from ..models.osw_lag_setting_vo_untag_bridge_vlan_map import (
...
T = TypeVar("T", bound="OswLagSettingVO")


@_attrs_define
class OswLagSettingVO:
    """
    Attributes:
        ...
        tag_bridge_vlan_map (OswLagSettingVOTagBridgeVlanMap | Unset): Tag Network Bridge Vlan Map
        untag_network_ids (list[str] | Unset): Untag Network IDs
        untag_bridge_vlan_map (OswLagSettingVOUntagBridgeVlanMap | Unset): Untag Network Bridge Vlan Map
    ...
    tag_bridge_vlan_map: OswLagSettingVOTagBridgeVlanMap | Unset = UNSET
    untag_network_ids: list[str] | Unset = UNSET
    untag_bridge_vlan_map: OswLagSettingVOUntagBridgeVlanMap | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        tag_bridge_vlan_map: OswLagSettingVOTagBridgeVlanMap | Unset
        if isinstance(_tag_bridge_vlan_map, Unset):
            tag_bridge_vlan_map = UNSET
        else:
            tag_bridge_vlan_map = OswLagSettingVOTagBridgeVlanMap.from_dict(
        ...
        untag_bridge_vlan_map: OswLagSettingVOUntagBridgeVlanMap | Unset
        if isinstance(_untag_bridge_vlan_map, Unset):
            untag_bridge_vlan_map = UNSET
        else:
            untag_bridge_vlan_map = OswLagSettingVOUntagBridgeVlanMap.from_dict(
        ...
        osw_lag_setting_vo.additional_properties = d
        return osw_lag_setting_vo
