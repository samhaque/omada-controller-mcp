...
T = TypeVar("T", bound="DBAProfilePageQueryDTO")


@_attrs_define
class DBAProfilePageQueryDTO:
    """
    Attributes:
        ...
        search_fields (list[str] | Unset): SearchFields
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dba_profile_page_query_dto = cls(
        ...
        dba_profile_page_query_dto.additional_properties = d
        return dba_profile_page_query_dto
