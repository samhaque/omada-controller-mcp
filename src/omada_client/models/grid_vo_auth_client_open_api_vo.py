...
if TYPE_CHECKING:
    from ..models.auth_client_open_api_vo import AuthClientOpenApiVO


T = TypeVar("T", bound="GridVOAuthClientOpenApiVO")


@_attrs_define
class GridVOAuthClientOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.auth_client_open_api_vo import (
            AuthClientOpenApiVO,
        )
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = AuthClientOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_auth_client_open_api_vo = cls(
        ...
        grid_vo_auth_client_open_api_vo.additional_properties = d
        return grid_vo_auth_client_open_api_vo
