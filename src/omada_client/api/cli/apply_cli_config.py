...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/cli/configs/config-id/{config_id}/apply".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Apply the CLI configuration
     ...
     Apply the CLI configuration<br/><br/>The interface requires one of the permissions: <br/>Site
    ...
    wait and try again later.<br/>-39051  -  Operation failed. Please try again later.
