...
from ...models.select_ids_open_api_vo import SelectIdsOpenApiVO
...
def _get_kwargs(
    ...
    site_id: str,
    *,
    body: SelectIdsOpenApiVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/hotspot/vouchers/batch/delete".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete selected vouchers
     ...
     Delete selected vouchers with the given params.<br/><br/>The interface requires one of the
