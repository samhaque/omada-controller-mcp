...
def sync_detailed(
    ...
    *,
    ...
    """Delete an existing msp user
     ...
     Delete an existing msp user. This interface only supports the authorization code mode, not the
    ...
    <br/>-30112  -  This user does not exist.<br/>-30114  -  An error occurred while deleting the
    user.<br/>-30132  -  Are you sure you want to delete the account %Username%? Once deleted, all sub-
    users created by this account will be transferred to your account.<br/>-44118  -  This interface
