...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/hotspot/vouchers/statistics/summary/voucher-groups/{group_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get voucher summary for voucher group
     ...
     Get voucher summary of all time in the voucher group.<br/><br/>The interface requires one of the
