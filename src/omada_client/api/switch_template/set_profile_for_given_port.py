...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/switchtemplates/{device_template_id}/ports/{port}/profile".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Set profile for given switch template port
     ...
     Set profile for given switch template port.<br/><br/>The interface requires one of the permissions:
