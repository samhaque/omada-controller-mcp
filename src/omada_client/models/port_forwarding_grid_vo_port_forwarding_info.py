...
if TYPE_CHECKING:
    from ..models.port_forwarding_info import PortForwardingInfo


T = TypeVar("T", bound="PortForwardingGridVOPortForwardingInfo")


@_attrs_define
class PortForwardingGridVOPortForwardingInfo:
    """
    Attributes:
        ...
        data (list[PortForwardingInfo] | Unset):
        support_wan_ip (bool | Unset):
        support_virtual_wan (bool | Unset):
        support_by_ds_lite_and_map_e (bool | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[PortForwardingInfo] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = PortForwardingInfo.from_dict(data_item_data)
        ...
        port_forwarding_grid_vo_port_forwarding_info = cls(
        ...
        port_forwarding_grid_vo_port_forwarding_info.additional_properties = d
        return port_forwarding_grid_vo_port_forwarding_info
