...
T = TypeVar("T", bound="BatchStackPortSettingOpenApiVO")


@_attrs_define
class BatchStackPortSettingOpenApiVO:
    """
    Attributes:
        unit_list (list[OswStackUnitVO]): Unit List
        name (str | Unset): Port name
        profile_id (str | Unset): Lan Profile ID
        profile_override_enable (bool | Unset): Indicates whether to enable Profile Override
        operation (str | Unset): Operation should be a value as follows: SWITCHING;
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        batch_stack_port_setting_open_api_vo = cls(
            unit_list=unit_list,
            name=name,
        ...
        batch_stack_port_setting_open_api_vo.additional_properties = d
        return batch_stack_port_setting_open_api_vo
