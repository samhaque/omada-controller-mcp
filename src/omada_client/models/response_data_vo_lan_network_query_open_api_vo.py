...
T = TypeVar("T", bound="ResponseDataVOLanNetworkQueryOpenApiVO")


@_attrs_define
class ResponseDataVOLanNetworkQueryOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        response_data_vo_lan_network_query_open_api_vo = cls(
            data=data,
        )

        response_data_vo_lan_network_query_open_api_vo.additional_properties = d
        return response_data_vo_lan_network_query_open_api_vo
