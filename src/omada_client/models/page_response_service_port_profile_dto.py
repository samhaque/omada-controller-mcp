...
T = TypeVar("T", bound="PageResponseServicePortProfileDTO")


@_attrs_define
class PageResponseServicePortProfileDTO:
    """
    Attributes:
        content (list[ServicePortProfileDTO] | Unset): Content
    ...
    content: list[ServicePortProfileDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ServicePortProfileDTO.from_dict(content_item_data)
        ...
        page_response_service_port_profile_dto = cls(
            content=content,
        ...
        page_response_service_port_profile_dto.additional_properties = d
        return page_response_service_port_profile_dto
