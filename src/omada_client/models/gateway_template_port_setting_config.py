...
T = TypeVar("T", bound="GatewayTemplatePortSettingConfig")


@_attrs_define
class GatewayTemplatePortSettingConfig:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        gateway_template_port_setting_config = cls(
        ...
        gateway_template_port_setting_config.additional_properties = d
        return gateway_template_port_setting_config
