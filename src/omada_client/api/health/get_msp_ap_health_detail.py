...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/msp/{msp_id}/customers/{customer_id}/sites/{site_id}/eaps/{ap_mac}/health/detail".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get msp ap health detail
     ...
     Get msp ap health detail<br/><br/>The interface requires one of the permissions: <br/>MSP Device
