...
T = TypeVar("T", bound="PortForwardingInfo")
...
class PortForwardingInfo:
    ...
    Attributes:
        ...
        from_ (int): From corresponds with source IP in web. From should be a value as follows: 0: where; 1: limited
            address
        interface_wan_port_id (list[str]): This field represents WAN port ID. WAN port ID can be obtained from 'Get
        ...
        exist_wan_ip (bool | Unset): true: exist WAN IP config
        exist_virtual_wan (bool | Unset): true: exist virtual WAN config
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        port_forwarding_info.additional_properties = d
