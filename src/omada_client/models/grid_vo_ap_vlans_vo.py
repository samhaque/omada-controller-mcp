...
if TYPE_CHECKING:
    from ..models.ap_vlans_vo import ApVlansVO


T = TypeVar("T", bound="GridVOApVlansVO")


@_attrs_define
class GridVOApVlansVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ApVlansVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ap_vlans_vo = cls(
        ...
        grid_vo_ap_vlans_vo.additional_properties = d
        return grid_vo_ap_vlans_vo
