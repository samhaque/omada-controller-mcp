...
T = TypeVar("T", bound="MspGeneralSettingOpenApiVO")


@_attrs_define
class MspGeneralSettingOpenApiVO:
    """
    Attributes:
        name (str | Unset): Parameter [name] should be within the range of 1–32 visible ASCII characters.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        msp_general_setting_open_api_vo = cls(
            name=name,
            time_zone=time_zone,
            dst=dst,
        )

        msp_general_setting_open_api_vo.additional_properties = d
        return msp_general_setting_open_api_vo
