...
if TYPE_CHECKING:
    from ..models.osw_vrrp_open_api_vo import OswVrrpOpenApiVO


T = TypeVar("T", bound="GridVOOswVrrpOpenApiVO")


@_attrs_define
class GridVOOswVrrpOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswVrrpOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osw_vrrp_open_api_vo = cls(
        ...
        grid_vo_osw_vrrp_open_api_vo.additional_properties = d
        return grid_vo_osw_vrrp_open_api_vo
