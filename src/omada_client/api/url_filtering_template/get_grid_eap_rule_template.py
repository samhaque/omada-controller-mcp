...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/url-filters/eap".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get URL filtering template rule list for eap
     ...
     Get URL filtering template rule list for eap.<br/><br/>The interface requires one of the
