...
from ...models.gem_port_delete_dto import GemPortDeleteDTO
...
def _get_kwargs(
    ...
    line_profile_id: str,
    *,
    body: GemPortDeleteDTO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/{line_profile_id}/gem-ports/delete".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete an existing gem port
     ...
     Delete an existing gem port<br/><br/>The interface requires one of the permissions: <br/>Site Device
