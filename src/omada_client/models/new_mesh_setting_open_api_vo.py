...
T = TypeVar("T", bound="NewMeshSettingOpenApiVO")


@_attrs_define
class NewMeshSettingOpenApiVO:
    """Site mesh setting.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        new_mesh_setting_open_api_vo = cls(
        ...
        new_mesh_setting_open_api_vo.additional_properties = d
        return new_mesh_setting_open_api_vo
