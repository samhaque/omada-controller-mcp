...
from ...models.tcont_modify_dto import TcontModifyDTO
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/{line_profile_id}/t-conts/edit".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify an existing t-cont
     ...
     Modify an existing t-cont<br/><br/>The interface requires one of the permissions: <br/>Site Device
