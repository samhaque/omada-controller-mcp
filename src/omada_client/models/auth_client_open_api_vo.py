...
class AuthClientOpenApiVO:
    """
    Attributes:
        id (str | Unset): AuthRecord ID
        name (str | Unset): Client name
        mac (str | Unset): Client MAC
        wireless (bool | Unset): Is it wireless type
        ssid (str | Unset): SSID name
        network_name (str | Unset): Network name
        auth_type (int | Unset): Auth type should be a value as follows: 0: No Auth; 1: Simple Password; 2: Exrternal
            Radius; 3: Voucher; 4: External Portal Server; 5: Local User; 6: SMS; 7: Facebook; 8: Hotspot Radius; 9: Mac
            Auth (with fail over); 10: Admin auth; 12: Form auth
        fb_ver (int | Unset): Version of Facebook Wi-Fi (authType = Facebook or Facebook V2)
        download (int | Unset): Total Download (Byte)
        upload (int | Unset): Total Upload (Byte)
        duration (int | Unset): Total Duration (s)
        start (int | Unset): Start timestamp
        end (int | Unset): End timestamp
        valid (bool | Unset): Is the client valid
        local_user_name (str | Unset): LocalUser Name (authType = Local User)
        voucher_code (str | Unset): Voucher code (authType = Voucher)
        form_name (str | Unset): Form name (authType = form auth)
        radius_username (str | Unset): Radius userName (authType = External RADIUS or Hotspot RADIUS)
        admin_name (str | Unset): Admin name (authType = ADMIN)
        ip (str | Unset): IP address at the time of authentication
    """
    ...
    local_user_name: str | Unset = UNSET
    voucher_code: str | Unset = UNSET
    form_name: str | Unset = UNSET
    radius_username: str | Unset = UNSET
    admin_name: str | Unset = UNSET
    ip: str | Unset = UNSET
