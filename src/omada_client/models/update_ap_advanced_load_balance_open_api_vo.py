...
T = TypeVar("T", bound="UpdateApAdvancedLoadBalanceOpenApiVO")


@_attrs_define
class UpdateApAdvancedLoadBalanceOpenApiVO:
    """
    Attributes:
        ...
        max_clients_enable_5_g_1 (bool | Unset): Whether the device enable load balance 5g1.
        max_clients_5_g_1 (int | Unset): The maximum number of clients connected to the 5G1 band. MaxClients5g1 should
            be within the range of 1–512.
        rssi_enable_5_g_1 (bool | Unset): Whether the device enable rssi 5g1.
        threshold5g1 (int | Unset): The RSSI threshold for the 5G1 band. threshold5g1 should be within the range of
            -95–0.
    ...
    max_clients_enable_5_g_1: bool | Unset = UNSET
    max_clients_5_g_1: int | Unset = UNSET
    rssi_enable_5_g_1: bool | Unset = UNSET
    threshold5g1: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        max_clients_enable_5_g_1 = self.max_clients_enable_5_g_1

        max_clients_5_g_1 = self.max_clients_5_g_1

        rssi_enable_5_g_1 = self.rssi_enable_5_g_1

        threshold5g1 = self.threshold5g1
        ...
        if max_clients_enable_5_g_1 is not UNSET:
            field_dict["maxClientsEnable5g1"] = max_clients_enable_5_g_1
        if max_clients_5_g_1 is not UNSET:
            field_dict["maxClients5g1"] = max_clients_5_g_1
        if rssi_enable_5_g_1 is not UNSET:
            field_dict["rssiEnable5g1"] = rssi_enable_5_g_1
        if threshold5g1 is not UNSET:
            field_dict["threshold5g1"] = threshold5g1
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        max_clients_enable_5_g_1 = d.pop("maxClientsEnable5g1", UNSET)

        max_clients_5_g_1 = d.pop("maxClients5g1", UNSET)

        rssi_enable_5_g_1 = d.pop("rssiEnable5g1", UNSET)

        threshold5g1 = d.pop("threshold5g1", UNSET)
        ...
        update_ap_advanced_load_balance_open_api_vo = cls(
            ...
            max_clients_enable_5_g_1=max_clients_enable_5_g_1,
            max_clients_5_g_1=max_clients_5_g_1,
            rssi_enable_5_g_1=rssi_enable_5_g_1,
            threshold5g1=threshold5g1,
        ...
        update_ap_advanced_load_balance_open_api_vo.additional_properties = d
        return update_ap_advanced_load_balance_open_api_vo
