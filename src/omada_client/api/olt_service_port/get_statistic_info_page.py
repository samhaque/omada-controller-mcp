...
from ...models.statistic_info_query_dto import StatisticInfoQueryDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: StatisticInfoQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/service-port/statistics/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get statistic info page
     ...
     Get statistic info page<br/><br/>The interface requires one of the permissions: <br/>Site Device
