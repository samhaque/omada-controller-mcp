...
def sync_detailed(
    ...
    *,
    ...
    """Delete an existing Gateway QoS Service in siteTemplate
     ...
     Delete an existing Gateway QoS Service in siteTemplate.<br/><br/>The interface requires one of the
    ...
    <br/>-43302  -  The service type is used by the class rule.<br/>-43303  -  Cannot modify or delete
