...
T = TypeVar("T", bound="VpnOpenApiGridVOClientToSiteVpnClient")


@_attrs_define
class VpnOpenApiGridVOClientToSiteVpnClient:
    """
    Attributes:
        ...
        data (list[ClientToSiteVpnClient] | Unset):
    ...
    data: list[ClientToSiteVpnClient] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.client_to_site_vpn_client import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ClientToSiteVpnClient.from_dict(data_item_data)
        ...
        vpn_open_api_grid_vo_client_to_site_vpn_client = cls(
        ...
        vpn_open_api_grid_vo_client_to_site_vpn_client.additional_properties = d
        return vpn_open_api_grid_vo_client_to_site_vpn_client
