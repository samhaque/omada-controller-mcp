...
if TYPE_CHECKING:
    from ..models.batch_stack_port_setting_vo_tag_bridge_vlan_map import (
        BatchStackPortSettingVOTagBridgeVlanMap,
    )
    from ..models.batch_stack_port_setting_vo_untag_bridge_vlan_map import (
    ...
    from ..models.osw_stack_unit_vo import OswStackUnitVO
    from ..models.osw_storm_ctrl_vo import OswStormCtrlVO
    from ..models.spanning_tree_setting_vo import SpanningTreeSettingVO


T = TypeVar("T", bound="BatchStackPortSettingVO")


@_attrs_define
class BatchStackPortSettingVO:
    """
    Attributes:
        unit_list (list[OswStackUnitVO]):
        ...
        tag_bridge_vlan_map (BatchStackPortSettingVOTagBridgeVlanMap | Unset): Tag Network Bridge Vlan Map
        untag_network_ids (list[str] | Unset): Untag Network IDs
        untag_bridge_vlan_map (BatchStackPortSettingVOUntagBridgeVlanMap | Unset): Untag Network Bridge Vlan Map
        ...
        mac (str | Unset): Mac address of the port. This parameter can be null when batch modify stack ports, but not
            null when modify a single stack port
    ...
    tag_bridge_vlan_map: BatchStackPortSettingVOTagBridgeVlanMap | Unset = UNSET
    untag_network_ids: list[str] | Unset = UNSET
    untag_bridge_vlan_map: BatchStackPortSettingVOUntagBridgeVlanMap | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        unit_list = []
        for unit_list_item_data in self.unit_list:
            unit_list_item = unit_list_item_data.to_dict()
            unit_list.append(unit_list_item)
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        unit_list = []
        _unit_list = d.pop("unitList")
        for unit_list_item_data in _unit_list:
            unit_list_item = OswStackUnitVO.from_dict(unit_list_item_data)
        ...
        tag_bridge_vlan_map: BatchStackPortSettingVOTagBridgeVlanMap | Unset
        if isinstance(_tag_bridge_vlan_map, Unset):
            tag_bridge_vlan_map = UNSET
        else:
            tag_bridge_vlan_map = BatchStackPortSettingVOTagBridgeVlanMap.from_dict(
        ...
        untag_bridge_vlan_map: BatchStackPortSettingVOUntagBridgeVlanMap | Unset
        if isinstance(_untag_bridge_vlan_map, Unset):
            untag_bridge_vlan_map = UNSET
        else:
            untag_bridge_vlan_map = BatchStackPortSettingVOUntagBridgeVlanMap.from_dict(
        ...
        batch_stack_port_setting_vo = cls(
            unit_list=unit_list,
            name=name,
            tag_ids=tag_ids,
        ...
        batch_stack_port_setting_vo.additional_properties = d
        return batch_stack_port_setting_vo
