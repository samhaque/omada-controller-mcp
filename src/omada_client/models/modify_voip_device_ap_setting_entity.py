...
T = TypeVar("T", bound="ModifyVoipDeviceApSettingEntity")


@_attrs_define
class ModifyVoipDeviceApSettingEntity:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        modify_voip_device_ap_setting_entity = cls(
        ...
        modify_voip_device_ap_setting_entity.additional_properties = d
        return modify_voip_device_ap_setting_entity
