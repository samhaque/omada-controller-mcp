...
from ...models.batch_profile_override import BatchProfileOverride
...
def _get_kwargs(
    ...
    *,
    body: BatchProfileOverride,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/switchtemplates/{device_template_id}/multi-ports/profile-override".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Batch set profile-override for given switch template ports
     ...
     Batch set profile-override for given switch template ports.<br/><br/>The interface requires one of
    ...
    <br/>-39701  -  This port does not exist<br/>-44402  -  Device template does not exist.
