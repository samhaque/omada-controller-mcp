...
from ...models.service_port_query_dto import ServicePortQueryDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: ServicePortQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/service-ports/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get service port list
     ...
     Get service port list<br/><br/>The interface requires one of the permissions: <br/>Site Device
