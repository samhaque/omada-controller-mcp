...
T = TypeVar("T", bound="TimeValueItemVOInteger")


@_attrs_define
class TimeValueItemVOInteger:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        time_value_item_vo_integer = cls(
            time=time,
            past_num=past_num,
        )

        time_value_item_vo_integer.additional_properties = d
        return time_value_item_vo_integer
