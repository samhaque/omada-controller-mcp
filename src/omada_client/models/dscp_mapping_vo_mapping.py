...
T = TypeVar("T", bound="DscpMappingVOMapping")


@_attrs_define
class DscpMappingVOMapping:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dscp_mapping_vo_mapping.additional_properties = additional_properties
        return dscp_mapping_vo_mapping
