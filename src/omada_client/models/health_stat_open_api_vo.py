...
T = TypeVar("T", bound="HealthStatOpenApiVO")


@_attrs_define
class HealthStatOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        health_stat_open_api_vo.additional_properties = d
        return health_stat_open_api_vo
