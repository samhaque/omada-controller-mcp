...
T = TypeVar("T", bound="PlanFirmwareUpgradeCreateInfo")


@_attrs_define
class PlanFirmwareUpgradeCreateInfo:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        plan_firmware_upgrade_create_info = cls(
            sites=sites,
        ...
        plan_firmware_upgrade_create_info.additional_properties = d
        return plan_firmware_upgrade_create_info
