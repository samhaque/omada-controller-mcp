...
T = TypeVar("T", bound="PageResponsePonPortInformationDTO")


@_attrs_define
class PageResponsePonPortInformationDTO:
    """
    Attributes:
        content (list[PonPortInformationDTO] | Unset): Content
    ...
    content: list[PonPortInformationDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = PonPortInformationDTO.from_dict(content_item_data)
        ...
        page_response_pon_port_information_dto = cls(
            content=content,
        ...
        page_response_pon_port_information_dto.additional_properties = d
        return page_response_pon_port_information_dto
