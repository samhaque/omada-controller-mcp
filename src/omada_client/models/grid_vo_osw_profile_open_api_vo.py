...
if TYPE_CHECKING:
    from ..models.osw_profile_open_api_vo import OswProfileOpenApiVO


T = TypeVar("T", bound="GridVOOswProfileOpenApiVO")


@_attrs_define
class GridVOOswProfileOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.osw_profile_open_api_vo import (
            OswProfileOpenApiVO,
        )
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswProfileOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osw_profile_open_api_vo = cls(
        ...
        grid_vo_osw_profile_open_api_vo.additional_properties = d
        return grid_vo_osw_profile_open_api_vo
