...
T = TypeVar("T", bound="OntEthPortListQueryDTO")


@_attrs_define
class OntEthPortListQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ont_eth_port_list_query_dto = cls(
            search_key=search_key,
            sorts=sorts,
            service_id=service_id,
        )

        ont_eth_port_list_query_dto.additional_properties = d
        return ont_eth_port_list_query_dto
