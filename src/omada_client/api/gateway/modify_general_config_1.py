...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/gateways/{gateway_mac}/general-config".format(
...
def sync_detailed(
    ...
    *,
    ...
    interface instead: Modify gateway general config v2.<br/><br/>The interface requires one of the
