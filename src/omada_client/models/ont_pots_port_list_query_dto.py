...
T = TypeVar("T", bound="OntPotsPortListQueryDTO")


@_attrs_define
class OntPotsPortListQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ont_pots_port_list_query_dto = cls(
            search_key=search_key,
            sorts=sorts,
            service_id=service_id,
        )

        ont_pots_port_list_query_dto.additional_properties = d
        return ont_pots_port_list_query_dto
