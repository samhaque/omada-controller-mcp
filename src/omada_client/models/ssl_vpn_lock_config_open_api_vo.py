...
T = TypeVar("T", bound="SslVpnLockConfigOpenApiVO")


@_attrs_define
class SslVpnLockConfigOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ssl_vpn_lock_config_open_api_vo = cls(
            type_=type_,
        ...
        ssl_vpn_lock_config_open_api_vo.additional_properties = d
        return ssl_vpn_lock_config_open_api_vo
