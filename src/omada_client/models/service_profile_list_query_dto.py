...
T = TypeVar("T", bound="ServiceProfileListQueryDTO")


@_attrs_define
class ServiceProfileListQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        service_profile_list_query_dto = cls(
            search_key=search_key,
            sorts=sorts,
            search_fields=search_fields,
        )

        service_profile_list_query_dto.additional_properties = d
        return service_profile_list_query_dto
