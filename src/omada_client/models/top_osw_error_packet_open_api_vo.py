...
T = TypeVar("T", bound="TopOswErrorPacketOpenApiVO")


@_attrs_define
class TopOswErrorPacketOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        top_osw_error_packet_open_api_vo = cls(
            name=name,
            mac=mac,
            model=model,
        ...
        top_osw_error_packet_open_api_vo.additional_properties = d
        return top_osw_error_packet_open_api_vo
