...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/profiles/add".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create new line profile
     ...
     Create new line profile<br/><br/>The interface requires one of the permissions: <br/>Site Device
