...
T = TypeVar("T", bound="GridVOVoiceMail")


@_attrs_define
class GridVOVoiceMail:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = VoiceMail.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_voice_mail = cls(
        ...
        grid_vo_voice_mail.additional_properties = d
        return grid_vo_voice_mail
