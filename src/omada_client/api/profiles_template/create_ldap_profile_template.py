...
from ...models.create_ldap_profile_open_api_vo import CreateLdapProfileOpenApiVO
...
def _get_kwargs(
    ...
    *,
    body: CreateLdapProfileOpenApiVO,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Create a new LDAP profile template
     ...
     Create a new LDAP profile template with the given params.<br/><br/>The interface requires one of the
    ...
    Please wait and try again later.<br/>-43401  -  The LDAP profile does not exist.<br/>-43402  -  The
