...
if TYPE_CHECKING:
    from ..models.voucher_group_open_api_vo import VoucherGroupOpenApiVO


T = TypeVar("T", bound="GridVOVoucherGroupOpenApiVO")


@_attrs_define
class GridVOVoucherGroupOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.voucher_group_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = VoucherGroupOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_voucher_group_open_api_vo = cls(
        ...
        grid_vo_voucher_group_open_api_vo.additional_properties = d
        return grid_vo_voucher_group_open_api_vo
