...
T = TypeVar("T", bound="BatchUpdateApPowerSavingConfigOpenApiVO")


@_attrs_define
class BatchUpdateApPowerSavingConfigOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        batch_update_ap_power_saving_config_open_api_vo = cls(
        ...
        batch_update_ap_power_saving_config_open_api_vo.additional_properties = d
        return batch_update_ap_power_saving_config_open_api_vo
