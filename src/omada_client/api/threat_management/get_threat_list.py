...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/ips/grid/threat-management".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get grid threat list
     ...
     Get grid threat list.<br/><br/>The interface requires one of the permissions: <br/>Site Insight
