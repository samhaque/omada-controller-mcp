...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/setting/service/files/dhcp/export".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Export DHCP reservation list to file
     ...
     Export existed DHCP reservation list to file.<br/><br/>The interface requires one of the
    ...
    following error codes (non generic error codes): <br/>-1005  -  Operation forbidden.<br/>-33004  -
