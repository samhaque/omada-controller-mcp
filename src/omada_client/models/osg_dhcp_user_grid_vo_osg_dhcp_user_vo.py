...
if TYPE_CHECKING:
    from ..models.osg_dhcp_user_grid_vo_osg_dhcp_user_vo_net_name_to_id_map import (
        OsgDhcpUserGridVOOsgDhcpUserVONetNameToIdMap,
    )
    from ..models.osg_dhcp_user_vo import OsgDhcpUserVO


T = TypeVar("T", bound="OsgDhcpUserGridVOOsgDhcpUserVO")


@_attrs_define
class OsgDhcpUserGridVOOsgDhcpUserVO:
    """
    Attributes:
        ...
        data (list[OsgDhcpUserVO] | Unset):
        net_name_to_id_map (OsgDhcpUserGridVOOsgDhcpUserVONetNameToIdMap | Unset): Mapping between lan network name and
            lan network ID
    """
    ...
    data: list[OsgDhcpUserVO] | Unset = UNSET
    net_name_to_id_map: OsgDhcpUserGridVOOsgDhcpUserVONetNameToIdMap | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OsgDhcpUserVO.from_dict(data_item_data)

                data.append(data_item)

        _net_name_to_id_map = d.pop("netNameToIdMap", UNSET)
        net_name_to_id_map: OsgDhcpUserGridVOOsgDhcpUserVONetNameToIdMap | Unset
        if isinstance(_net_name_to_id_map, Unset):
            net_name_to_id_map = UNSET
        else:
            net_name_to_id_map = OsgDhcpUserGridVOOsgDhcpUserVONetNameToIdMap.from_dict(
                _net_name_to_id_map
            )

        osg_dhcp_user_grid_vo_osg_dhcp_user_vo = cls(
        ...
        osg_dhcp_user_grid_vo_osg_dhcp_user_vo.additional_properties = d
        return osg_dhcp_user_grid_vo_osg_dhcp_user_vo
