...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/spectral-scan/aps/{ap_mac}/spectral-scan-result/history".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get history results of environment scanning
     ...
     Get history results of environment scanning. The results of the environment scan are compressed by
