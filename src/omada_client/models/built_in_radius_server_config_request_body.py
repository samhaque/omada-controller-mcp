...
T = TypeVar("T", bound="BuiltInRADIUSServerConfigRequestBody")


@_attrs_define
class BuiltInRADIUSServerConfigRequestBody:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        built_in_radius_server_config_request_body = cls(
            enable=enable,
        ...
        built_in_radius_server_config_request_body.additional_properties = d
        return built_in_radius_server_config_request_body
