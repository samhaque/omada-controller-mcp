...
if TYPE_CHECKING:
    from ..models.batch_wifi_interference_open_api_vo import (
        BatchWifiInterferenceOpenApiVO,
    )


T = TypeVar("T", bound="GridVOBatchWifiInterferenceOpenApiVO")


@_attrs_define
class GridVOBatchWifiInterferenceOpenApiVO:
    """
    Attributes:
        ...
        data (list[BatchWifiInterferenceOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[BatchWifiInterferenceOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = BatchWifiInterferenceOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_batch_wifi_interference_open_api_vo = cls(
        ...
        grid_vo_batch_wifi_interference_open_api_vo.additional_properties = d
        return grid_vo_batch_wifi_interference_open_api_vo
