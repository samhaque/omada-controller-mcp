...
if TYPE_CHECKING:
    from ..models.use_profile_osw_open_api_vo import UseProfileOswOpenApiVO


T = TypeVar("T", bound="GridVOUseProfileOswOpenApiVO")


@_attrs_define
class GridVOUseProfileOswOpenApiVO:
    """
    Attributes:
        ...
        data (list[UseProfileOswOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[UseProfileOswOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.use_profile_osw_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = UseProfileOswOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_use_profile_osw_open_api_vo = cls(
        ...
        grid_vo_use_profile_osw_open_api_vo.additional_properties = d
        return grid_vo_use_profile_osw_open_api_vo
