...
def _get_kwargs(
    ...
    *,
    body: SiteServiceGeneralConfigOpenApiVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/general/config".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify the general configuration settings of the Site template
     ...
     Modify the general configuration settings of the Site template.<br/><br/>The interface requires one
