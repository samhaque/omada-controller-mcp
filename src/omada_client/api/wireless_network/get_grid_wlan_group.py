...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v2/{omadac_id}/sites/{site_id}/wireless-network/wlans".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get WLAN Group list paging query
     ...
     Get WLAN Group list paging query, Legacy note: “WLAN Group” is the legacy name of “AP Group”. This
    endpoint will be deprecated in future releases. Please use Get AP Group list.<br/><br/>The interface
