...
if TYPE_CHECKING:
    from ..models.oui_profile_query_open_api_vo import OuiProfileQueryOpenApiVO


T = TypeVar("T", bound="OuiGridVOOuiProfileQueryOpenApiVO")


@_attrs_define
class OuiGridVOOuiProfileQueryOpenApiVO:
    """
    Attributes:
        ...
        data (list[OuiProfileQueryOpenApiVO] | Unset):
    ...
    data: list[OuiProfileQueryOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.oui_profile_query_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OuiProfileQueryOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        total_count = d.pop("totalCount", UNSET)

        oui_grid_vo_oui_profile_query_open_api_vo = cls(
        ...
        oui_grid_vo_oui_profile_query_open_api_vo.additional_properties = d
        return oui_grid_vo_oui_profile_query_open_api_vo
