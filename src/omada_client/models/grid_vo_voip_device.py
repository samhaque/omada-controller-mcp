...
if TYPE_CHECKING:
    from ..models.voip_device import VoipDevice


T = TypeVar("T", bound="GridVOVoipDevice")


@_attrs_define
class GridVOVoipDevice:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = VoipDevice.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_voip_device = cls(
        ...
        grid_vo_voip_device.additional_properties = d
        return grid_vo_voip_device
