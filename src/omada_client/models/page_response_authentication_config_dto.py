...
T = TypeVar("T", bound="PageResponseAuthenticationConfigDTO")


@_attrs_define
class PageResponseAuthenticationConfigDTO:
    """
    Attributes:
        content (list[AuthenticationConfigDTO] | Unset): Content
    ...
    content: list[AuthenticationConfigDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = AuthenticationConfigDTO.from_dict(content_item_data)
        ...
        page_response_authentication_config_dto = cls(
            content=content,
        ...
        page_response_authentication_config_dto.additional_properties = d
        return page_response_authentication_config_dto
