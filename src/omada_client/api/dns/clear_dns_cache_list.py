...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/setting/dns-cache-data/clear".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Clear DNS cache list
     ...
     Clear DNS cache list with the given params.<br/><br/>The interface requires one of the permissions:
