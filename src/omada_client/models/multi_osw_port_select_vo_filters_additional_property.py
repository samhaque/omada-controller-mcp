...
T = TypeVar("T", bound="MultiOswPortSelectVOFiltersAdditionalProperty")


@_attrs_define
class MultiOswPortSelectVOFiltersAdditionalProperty:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        multi_osw_port_select_vo_filters_additional_property = cls()

        multi_osw_port_select_vo_filters_additional_property.additional_properties = d
        return multi_osw_port_select_vo_filters_additional_property
