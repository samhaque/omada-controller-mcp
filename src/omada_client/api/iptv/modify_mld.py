...
from ...models.mld_open_api_vo import MldOpenApiVO
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/setting/service/mld".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify the MLD settings
     ...
     Modify the MLD settings of the site with the given parameters.<br/><br/>The interface requires one
    ...
    connection types.<br/>-33477  -  Only IPv6-enabled WAN ports can be selected as MLD
    Interface.<br/>-33478  -  MLD does not support the 6to4 Tunnel and Pass-Through(Bridge) IPv6 dial-up
    modes.
