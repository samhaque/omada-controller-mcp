...
if TYPE_CHECKING:
    from ..models.ap_group_open_api_vo_remaining_binding import (
        ApGroupOpenApiVORemainingBinding,
    )


T = TypeVar("T", bound="ApGroupOpenApiVO")


@_attrs_define
class ApGroupOpenApiVO:
    """
    Attributes:
        id (str | Unset): AP group ID
        name (str | Unset): ap group name should contain 1 to 128 characters.
        primary (bool | Unset): Whether it is the default ap group
        ap_num (int | Unset): Number of APs in this group
        remaining_binding (ApGroupOpenApiVORemainingBinding | Unset): Number of SSID remaining bindings for this group,
            0:2g, 1:5g, 2:6g
        ssid_name_list (list[str] | Unset): SSID name list bound to this group
    """
    ...
    remaining_binding: ApGroupOpenApiVORemainingBinding | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        remaining_binding: ApGroupOpenApiVORemainingBinding | Unset
        if isinstance(_remaining_binding, Unset):
            remaining_binding = UNSET
        else:
            remaining_binding = ApGroupOpenApiVORemainingBinding.from_dict(
                _remaining_binding
            )

        ssid_name_list = cast(list[str], d.pop("ssidNameList", UNSET))

        ap_group_open_api_vo = cls(
            id=id,
            name=name,
            primary=primary,
            ap_num=ap_num,
        ...
        ap_group_open_api_vo.additional_properties = d
        return ap_group_open_api_vo
