...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/service-port/profiles/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get service port profile list
     ...
     Get service port profile list<br/><br/>The interface requires one of the permissions: <br/>MSP
