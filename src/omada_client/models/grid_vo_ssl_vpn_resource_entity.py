...
if TYPE_CHECKING:
    from ..models.ssl_vpn_resource_entity import SslVpnResourceEntity


T = TypeVar("T", bound="GridVOSslVpnResourceEntity")


@_attrs_define
class GridVOSslVpnResourceEntity:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.ssl_vpn_resource_entity import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SslVpnResourceEntity.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ssl_vpn_resource_entity = cls(
        ...
        grid_vo_ssl_vpn_resource_entity.additional_properties = d
        return grid_vo_ssl_vpn_resource_entity
