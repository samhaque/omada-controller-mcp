...
T = TypeVar("T", bound="VoipTelephoneBookSetting")


@_attrs_define
class VoipTelephoneBookSetting:
    """
    Attributes:
        contact_id (str | Unset): The contact ID of contact person.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        voip_telephone_book_setting = cls(
        ...
        voip_telephone_book_setting.additional_properties = d
        return voip_telephone_book_setting
