...
if TYPE_CHECKING:
    from ..models.gateway_infos import GatewayInfos


T = TypeVar("T", bound="GridVOGatewayInfos")


@_attrs_define
class GridVOGatewayInfos:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = GatewayInfos.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_gateway_infos = cls(
        ...
        grid_vo_gateway_infos.additional_properties = d
        return grid_vo_gateway_infos
