...
if TYPE_CHECKING:
    from ..models.msp_known_device_open_api_vo import MspKnownDeviceOpenApiVO


T = TypeVar("T", bound="GridVOMspKnownDeviceOpenApiVO")


@_attrs_define
class GridVOMspKnownDeviceOpenApiVO:
    """
    Attributes:
        ...
        data (list[MspKnownDeviceOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[MspKnownDeviceOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.msp_known_device_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = MspKnownDeviceOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_msp_known_device_open_api_vo = cls(
        ...
        grid_vo_msp_known_device_open_api_vo.additional_properties = d
        return grid_vo_msp_known_device_open_api_vo
