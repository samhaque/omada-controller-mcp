...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/wireless-network/ssids/{ssid_id}/mac-filter".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update SSID Template mac filter config by site
     ...
     Update SSID Template MAC filter config<br/><br/>The interface requires one of the permissions:
    ...
    codes): <br/>-33009  -  This site template does not exist.
