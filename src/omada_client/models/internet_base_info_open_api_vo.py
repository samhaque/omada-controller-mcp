...
T = TypeVar("T", bound="InternetBaseInfoOpenApiVO")


@_attrs_define
class InternetBaseInfoOpenApiVO:
    """
    Attributes:
        pre_configuration (bool): You can pre-configure the model-relative settings when it is true.
        gateway_model (int): Gateway model. The model number refers to function can be obtained from 'Get supported
            gateway model list for pre-configuration' interface.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        internet_base_info_open_api_vo = cls(
        ...
        internet_base_info_open_api_vo.additional_properties = d
        return internet_base_info_open_api_vo
