...
def sync_detailed(
    ...
    *,
    ...
    """Delete an existing WLAN Group
     ...
     Delete an existing WLAN Group, Legacy note: “WLAN Group” is the legacy name of “AP Group”. This
    endpoint will be deprecated in future releases. Please use Delete an existing AP Group.<br/><br/>The
