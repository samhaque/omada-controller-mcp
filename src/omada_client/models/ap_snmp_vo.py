...
class ApSnmpVO:
    ...
    Attributes:
        ...
        type_ (int | Unset): SNMP parameter [type] should not be null and should be a value as follows: 0: Use Site
            Settings; 1: Custom.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ap_snmp_vo.additional_properties = d
        return ap_snmp_vo
