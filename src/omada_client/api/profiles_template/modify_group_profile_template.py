...
def sync_detailed(
    ...
    *,
    ...
    """Modify an exist group profile template
     ...
     Modify an exist group profile template with the given params.<br/><br/>The interface requires one of
    ...
    <br/>-33009  -  This site template does not exist.<br/>-33702  -  This group name already
    exists.<br/>-33707  -  This MAC List already exists.<br/>-33729  -  Default IpGroup not allowed to
    be edited.<br/>-33749  -  Duplicate MAC addresses exist in the MAC address list of the MAC
    group.<br/>-33816  -  Default domain group not allowed to be edited.<br/>-33819  -  This domain
    group has wrong type of domain.<br/>-33822  -  This domain group has wrong domain or invalid format
    port.
