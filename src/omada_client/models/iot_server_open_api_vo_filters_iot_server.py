...
T = TypeVar("T", bound="IotServerOpenApiVOFiltersIotServer")


@_attrs_define
class IotServerOpenApiVOFiltersIotServer:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        iot_server_open_api_vo_filters_iot_server = cls()
        ...
        iot_server_open_api_vo_filters_iot_server.additional_properties = (
            additional_properties
        )
        return iot_server_open_api_vo_filters_iot_server
