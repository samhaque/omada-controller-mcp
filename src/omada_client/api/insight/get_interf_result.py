...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/aps/{ap_mac}/full-channel-detect/grid/interference".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Interference result
     ...
     Get Interference result<br/><br/>The interface requires one of the permissions: <br/>Site Device
