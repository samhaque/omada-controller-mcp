...
if TYPE_CHECKING:
    from ..models.lan_profile_open_api_vo import LanProfileOpenApiVO


T = TypeVar("T", bound="GridVOLanProfileOpenApiVO")


@_attrs_define
class GridVOLanProfileOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.lan_profile_open_api_vo import (
            LanProfileOpenApiVO,
        )
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = LanProfileOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_lan_profile_open_api_vo = cls(
        ...
        grid_vo_lan_profile_open_api_vo.additional_properties = d
        return grid_vo_lan_profile_open_api_vo
