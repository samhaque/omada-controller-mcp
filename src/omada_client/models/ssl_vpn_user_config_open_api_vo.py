...
T = TypeVar("T", bound="SslVpnUserConfigOpenApiVO")


@_attrs_define
class SslVpnUserConfigOpenApiVO:
    """
    Attributes:
        name (str): Name of the SSL VPN user should contain 1 to 20 characters.
        ...
        concurrent_number (int): Concurrent number of the SSL VPN user should be within the range of 1–100
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ssl_vpn_user_config_open_api_vo = cls(
            name=name,
            status=status,
            password=password,
            validity=validity,
        ...
        ssl_vpn_user_config_open_api_vo.additional_properties = d
        return ssl_vpn_user_config_open_api_vo
