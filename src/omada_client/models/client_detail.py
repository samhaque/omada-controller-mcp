...
class ClientDetail:
    ...
    Attributes:
        ...
        upload_activity (int | Unset): Real-time downlink rate (Byte/s).
        ...
        st_ports_in_lag (list[str] | Unset): Standard switch ports in Lag. Exists only when lagId exists and stackId
            exists
        client_support_nat_traversal (bool | Unset): Whether client support NAT traversal
    """
    ...
    client_support_nat_traversal: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        client_support_nat_traversal = self.client_support_nat_traversal
        ...
        if client_support_nat_traversal is not UNSET:
            field_dict["clientSupportNatTraversal"] = client_support_nat_traversal
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        client_support_nat_traversal = d.pop("clientSupportNatTraversal", UNSET)
        ...
        client_detail = cls(
            ...
            client_support_nat_traversal=client_support_nat_traversal,
        )
