...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/service-port/statistic/configs".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get auto refresh config
     ...
     Get auto refresh config<br/><br/>The interface requires one of the permissions: <br/>Site Device
