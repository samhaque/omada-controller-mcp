...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/setting/vpn/stats/s2s/{vpn_id}/peer".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get VPN Site-to-Site's peers status list
     ...
     Get VPN Site-to-Site's peers status list by VPN ID.<br/><br/>The interface requires one of the
