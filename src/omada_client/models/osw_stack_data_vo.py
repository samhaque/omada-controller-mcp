...
if TYPE_CHECKING:
    ...
    from ..models.osw_stack_data_vo_member_item import OswStackDataVOMemberItem
    from ..models.port_vo import PortVO


T = TypeVar("T", bound="OswStackDataVO")


@_attrs_define
class OswStackDataVO:
    """oswStackData
    ...
    Attributes:
        ...
        member (list[OswStackDataVOMemberItem] | Unset):
    ...
    member: list[OswStackDataVOMemberItem] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.osw_dev_cap_vo import OswDevCapVO
        from ..models.osw_lag_status_vo import OswLagStatusVO
        from ..models.osw_stack_data_vo_member_item import (
        ...
        if _member is not UNSET:
            ...
            for member_item_data in _member:
                member_item = OswStackDataVOMemberItem.from_dict(member_item_data)
        ...
        osw_stack_data_vo.additional_properties = d
        return osw_stack_data_vo
