...
T = TypeVar("T", bound="DnsProxySettingOpenApiVO")


@_attrs_define
class DnsProxySettingOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dns_proxy_setting_open_api_vo = cls(
            enable=enable,
            type_=type_,
        ...
        dns_proxy_setting_open_api_vo.additional_properties = d
        return dns_proxy_setting_open_api_vo
