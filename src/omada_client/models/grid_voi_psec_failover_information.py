...
if TYPE_CHECKING:
    from ..models.i_psec_failover_information import IPsecFailoverInformation


T = TypeVar("T", bound="GridVOIPsecFailoverInformation")


@_attrs_define
class GridVOIPsecFailoverInformation:
    """
    Attributes:
        ...
        data (list[IPsecFailoverInformation] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[IPsecFailoverInformation] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.i_psec_failover_information import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = IPsecFailoverInformation.from_dict(data_item_data)

                data.append(data_item)

        grid_voi_psec_failover_information = cls(
        ...
        grid_voi_psec_failover_information.additional_properties = d
        return grid_voi_psec_failover_information
