...
T = TypeVar("T", bound="ServicePortProfileDetailPageQueryDTO")


@_attrs_define
class ServicePortProfileDetailPageQueryDTO:
    """
    Attributes:
        service_port_profile_id (str): Service Port Profile ID. The servicePortProfileId should be within the range of 1
            to 127.
        ...
        search_fields (list[str] | Unset): Query Filter Fields.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        service_port_profile_detail_page_query_dto = cls(
        ...
        service_port_profile_detail_page_query_dto.additional_properties = d
        return service_port_profile_detail_page_query_dto
