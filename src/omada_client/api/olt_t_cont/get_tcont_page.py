...
from ...models.tcont_page_query_dto import TcontPageQueryDTO
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/{line_profile_id}/t-conts/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get t-cont page
     ...
     Get t-cont page<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
