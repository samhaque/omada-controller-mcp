...
if TYPE_CHECKING:
    from ..models.dns_cache_info_vo import DnsCacheInfoVO


T = TypeVar("T", bound="GridVODnsCacheInfoVO")


@_attrs_define
class GridVODnsCacheInfoVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = DnsCacheInfoVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_dns_cache_info_vo = cls(
        ...
        grid_vo_dns_cache_info_vo.additional_properties = d
        return grid_vo_dns_cache_info_vo
