...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    body: ServiceProfileDTO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/service/profiles/add".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create new service profile
     ...
     Create new service profile<br/><br/>The interface requires one of the permissions: <br/>Site Device
