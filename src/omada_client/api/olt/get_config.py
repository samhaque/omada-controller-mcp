...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/system/system-info/configs".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get OLT description info
     ...
     Get OLT description info<br/><br/>The interface requires one of the permissions: <br/>Site Device
