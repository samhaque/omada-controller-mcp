...
T = TypeVar("T", bound="GridVOSdWanGroupDetail")


@_attrs_define
class GridVOSdWanGroupDetail:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SdWanGroupDetail.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_sd_wan_group_detail = cls(
        ...
        grid_vo_sd_wan_group_detail.additional_properties = d
        return grid_vo_sd_wan_group_detail
