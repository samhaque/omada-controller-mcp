...
def _get_kwargs(
    omadac_id: str,
    *,
    body: ModelUpgradeInfo,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/upgrade/plan/firmware".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get the upgradeable information of the selected model
     ...
     Get the upgradeable information of the selected model.<br/><br/>The interface requires one of the
