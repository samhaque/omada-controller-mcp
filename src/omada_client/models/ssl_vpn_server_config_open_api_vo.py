...
T = TypeVar("T", bound="SslVpnServerConfigOpenApiVO")


@_attrs_define
class SslVpnServerConfigOpenApiVO:
    """
    Attributes:
        status (bool): Status of the SSL VPN server.
        wan_port (str | Unset): WAN port ID of the SSL VPN server. It is required when parameter [status] is true. WAN
            port ID can be obtained from 'Get internet basic info' interface
        ip_pool_start (str | Unset): The start IP of the IP pool. It is required when parameter [status] is true.
        ip_pool_end (str | Unset): The end IP of the IP pool. It is required when parameter [status] is true.
        primary_dns (str | Unset): Primary DNS Server of the SSL VPN server. It is required when parameter [status] is
            true.
        secondary_dns (str | Unset): Secondary DNS Server of the SSL VPN server.
        service_port (int | Unset): Service port of the SSL VPN server. Default value is 1194. It is required when
            parameter [status] is true, and it should be within the range of 1–65535
        auth_type (int | Unset): Authentication type of the SSL VPN server should be a value as follows: 0: local; 1:
            radius; 2: LDAP. It is required when parameter [status] is true.
        ...
        exit_at_idle (bool | Unset): Whether to exit when idle.  It is required when parameter [status] is true.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ssl_vpn_server_config_open_api_vo = cls(
            status=status,
            wan_port=wan_port,
        ...
        ssl_vpn_server_config_open_api_vo.additional_properties = d
        return ssl_vpn_server_config_open_api_vo
