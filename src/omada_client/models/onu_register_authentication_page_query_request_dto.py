...
T = TypeVar("T", bound="OnuRegisterAuthenticationPageQueryRequestDTO")


@_attrs_define
class OnuRegisterAuthenticationPageQueryRequestDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        onu_register_authentication_page_query_request_dto = cls(
            pon_port=pon_port,
        ...
        onu_register_authentication_page_query_request_dto.additional_properties = d
        return onu_register_authentication_page_query_request_dto
