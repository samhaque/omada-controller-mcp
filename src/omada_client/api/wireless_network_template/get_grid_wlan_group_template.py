...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v2/{omadac_id}/sitetemplates/{site_template_id}/wireless-network/wlans".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get WLAN Group template list paging query
     ...
     Get WLAN Group template list paging query, Legacy note: “WLAN Group” is the legacy name of “AP
    Group”. This endpoint will be deprecated in future releases. Please use Get AP Group template
    list.<br/><br/>The interface requires one of the permissions: <br/>Global Site Template Manager View
