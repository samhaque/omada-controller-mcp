...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/rrm/config".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify Rrm template setting
     ...
     Modify Rrm template setting<br/><br/>The interface requires one of the permissions: <br/>Site
