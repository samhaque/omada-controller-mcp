...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/onu-register/autofinds/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ONU auto find config list
     ...
     Get ONU auto find config list<br/><br/>The interface requires one of the permissions: <br/>Site
