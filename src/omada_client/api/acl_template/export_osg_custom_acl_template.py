...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/files/sitetemplates/{site_template_id}/acls/export".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Export gateway custom ACL template rules
     ...
     Export gateway custom ACL template rules<br/><br/>The interface requires one of the permissions:
