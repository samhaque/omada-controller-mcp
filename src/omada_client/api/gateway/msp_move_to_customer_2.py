...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/msp/{msp_id}/customers/{customer_id}/sites/{site_id}/cmd/gateways/move".format(
...
def sync_detailed(
    ...
    *,
    ...
    because the devices are provisioning.<br/>-39050  -  This device does not exist.<br/>-39502  -
    Failed to move the gateway. The target site already has a gateway.<br/>-44261  -  The device does
    not support cluster and can only be adopted to its own site.
