...
T = TypeVar("T", bound="VoipDeviceApConfigurationOpenApiVO")


@_attrs_define
class VoipDeviceApConfigurationOpenApiVO:
    """Telephony settings.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        voip_device_ap_configuration_open_api_vo = cls(
        ...
        voip_device_ap_configuration_open_api_vo.additional_properties = d
        return voip_device_ap_configuration_open_api_vo
