...
T = TypeVar("T", bound="ProviderSettingVO")


@_attrs_define
class ProviderSettingVO:
    """Telephony provider settings

    Attributes:
        provider (int): The telephony providers supported. The range is between 0 and 13. 0: Other Provider; 1: 1 & 1
            Internet; 2: Congstar; 3: Vodafone/Arcor; 4: DUS.net; 5: Easybell; 6: Kabel Deutschland; 7: QSC/Q-DSL home; 8:
            Sipgate.de; 9: Sipgate Team; 10: Sipload; 11: Ventengo; 12: Telekom; 13: Bellsip. The default value is 0.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        provider_setting_vo.additional_properties = d
        return provider_setting_vo
