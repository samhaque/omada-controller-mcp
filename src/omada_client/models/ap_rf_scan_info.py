...
if TYPE_CHECKING:
    from ..models.rf_scan_radio import RFScanRadio


T = TypeVar("T", bound="ApRFScanInfo")
...
class ApRFScanInfo:
    """
    Attributes:
        channel2g (list[RFScanRadio] | Unset): Channel 2g
        channel5g (list[RFScanRadio] | Unset): Channel 5g
        channel5g2 (list[RFScanRadio] | Unset): Channel 5g2
        channel6g (list[RFScanRadio] | Unset): Channel 6g
    ...
    channel2g: list[RFScanRadio] | Unset = UNSET
    channel5g: list[RFScanRadio] | Unset = UNSET
    channel5g2: list[RFScanRadio] | Unset = UNSET
    channel6g: list[RFScanRadio] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _channel2g is not UNSET:
            ...
            for channel2g_item_data in _channel2g:
                channel2g_item = RFScanRadio.from_dict(channel2g_item_data)
        ...
        if _channel5g is not UNSET:
            ...
            for channel5g_item_data in _channel5g:
                channel5g_item = RFScanRadio.from_dict(channel5g_item_data)
        ...
        if _channel5g2 is not UNSET:
            ...
            for channel5g2_item_data in _channel5g2:
                channel5g2_item = RFScanRadio.from_dict(channel5g2_item_data)
        ...
        if _channel6g is not UNSET:
            ...
            for channel6g_item_data in _channel6g:
                channel6g_item = RFScanRadio.from_dict(channel6g_item_data)
        ...
        ap_rf_scan_info.additional_properties = d
        return ap_rf_scan_info
