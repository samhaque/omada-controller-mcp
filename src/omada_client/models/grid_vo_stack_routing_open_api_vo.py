...
if TYPE_CHECKING:
    from ..models.stack_routing_open_api_vo import StackRoutingOpenApiVO


T = TypeVar("T", bound="GridVOStackRoutingOpenApiVO")


@_attrs_define
class GridVOStackRoutingOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.stack_routing_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = StackRoutingOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_stack_routing_open_api_vo = cls(
        ...
        grid_vo_stack_routing_open_api_vo.additional_properties = d
        return grid_vo_stack_routing_open_api_vo
