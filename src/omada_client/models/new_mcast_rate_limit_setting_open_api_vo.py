...
T = TypeVar("T", bound="NewMcastRateLimitSettingOpenApiVO")


@_attrs_define
class NewMcastRateLimitSettingOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        new_mcast_rate_limit_setting_open_api_vo = cls(
            enable=enable,
        ...
        new_mcast_rate_limit_setting_open_api_vo.additional_properties = d
        return new_mcast_rate_limit_setting_open_api_vo
