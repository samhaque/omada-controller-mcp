...
T = TypeVar("T", bound="TopMemUsageHealthOpenApiVO")


@_attrs_define
class TopMemUsageHealthOpenApiVO:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        top_mem_usage_health_open_api_vo = cls(
            name=name,
            mac=mac,
            model=model,
        ...
        top_mem_usage_health_open_api_vo.additional_properties = d
        return top_mem_usage_health_open_api_vo
