...
def _get_kwargs(
    ...
    *,
    body: PortOrPoeScheduleOpenApiVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/setting/service/port-schedules".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create a new Port Schedule Template
     ...
     Create a new Port Schedule Template with the given params.<br/><br/>The interface requires one of
