...
from ...models.base_device_page_query_request import BaseDevicePageQueryRequest
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: BaseDevicePageQueryRequest,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/pon-port/informations/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get pon port information page
     ...
     Get pon port information page<br/><br/>The interface requires one of the permissions: <br/>Site
