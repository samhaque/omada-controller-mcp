...
T = TypeVar("T", bound="MailServerOpenApiVO")


@_attrs_define
class MailServerOpenApiVO:
    """
    Attributes:
        ...
        resource (int | Unset): Mail server setting creation resource, such as: 0: new created, 1: from template, 2:
            override.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        mail_server_open_api_vo.additional_properties = d
        return mail_server_open_api_vo
