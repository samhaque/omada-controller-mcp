...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/devicetemplates/{device_template_id}/available-bind-devices".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get deviceTemplate's available devices
     ...
     Get deviceTemplate's available devices.<br/><br/>The interface requires one of the permissions:
