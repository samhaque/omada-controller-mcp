...
T = TypeVar("T", bound="CreateRateLimitProfileOpenApiVO")


@_attrs_define
class CreateRateLimitProfileOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_rate_limit_profile_open_api_vo = cls(
            name=name,
        ...
        create_rate_limit_profile_open_api_vo.additional_properties = d
        return create_rate_limit_profile_open_api_vo
