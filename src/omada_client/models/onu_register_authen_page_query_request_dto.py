...
T = TypeVar("T", bound="OnuRegisterAuthenPageQueryRequestDTO")


@_attrs_define
class OnuRegisterAuthenPageQueryRequestDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        onu_register_authen_page_query_request_dto = cls(
            pon_port=pon_port,
        ...
        onu_register_authen_page_query_request_dto.additional_properties = d
        return onu_register_authen_page_query_request_dto
