...
if TYPE_CHECKING:
    from ..models.osw_stack_vo import OswStackVO


T = TypeVar("T", bound="GridVOOswStackVO")


@_attrs_define
class GridVOOswStackVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswStackVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osw_stack_vo = cls(
        ...
        grid_vo_osw_stack_vo.additional_properties = d
        return grid_vo_osw_stack_vo
