...
T = TypeVar("T", bound="AutoServicePortQueryDTO")


@_attrs_define
class AutoServicePortQueryDTO:
    """
    Attributes:
        ...
        search_field (str | Unset): Field to search
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        auto_service_port_query_dto = cls(
        ...
        auto_service_port_query_dto.additional_properties = d
        return auto_service_port_query_dto
