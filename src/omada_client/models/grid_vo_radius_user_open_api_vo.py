...
if TYPE_CHECKING:
    from ..models.radius_user_open_api_vo import RadiusUserOpenApiVO


T = TypeVar("T", bound="GridVORadiusUserOpenApiVO")


@_attrs_define
class GridVORadiusUserOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.radius_user_open_api_vo import (
            RadiusUserOpenApiVO,
        )
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = RadiusUserOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_radius_user_open_api_vo = cls(
        ...
        grid_vo_radius_user_open_api_vo.additional_properties = d
        return grid_vo_radius_user_open_api_vo
