...
if TYPE_CHECKING:
    from ..models.ssid_device_open_api_vo import SsidDeviceOpenApiVO


T = TypeVar("T", bound="GridVOSsidDeviceOpenApiVO")


@_attrs_define
class GridVOSsidDeviceOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.ssid_device_open_api_vo import (
            SsidDeviceOpenApiVO,
        )
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SsidDeviceOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ssid_device_open_api_vo = cls(
        ...
        grid_vo_ssid_device_open_api_vo.additional_properties = d
        return grid_vo_ssid_device_open_api_vo
