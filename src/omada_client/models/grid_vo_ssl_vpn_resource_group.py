...
if TYPE_CHECKING:
    from ..models.ssl_vpn_resource_group import SslVpnResourceGroup


T = TypeVar("T", bound="GridVOSslVpnResourceGroup")


@_attrs_define
class GridVOSslVpnResourceGroup:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SslVpnResourceGroup.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ssl_vpn_resource_group = cls(
        ...
        grid_vo_ssl_vpn_resource_group.additional_properties = d
        return grid_vo_ssl_vpn_resource_group
