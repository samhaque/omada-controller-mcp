...
T = TypeVar("T", bound="ClientUplinkDevice")


@_attrs_define
class ClientUplinkDevice:
    """The client uplinkDevice

    Attributes:
        mac (str | Unset): The client UplinkDevice mac
        uplink_port (str | Unset): The client UplinkDevice port
        standard_port (str | Unset): The client UplinkDevice standard port
        name (str | Unset): The client UplinkDevice name
        device_type (int | Unset): The client UplinkDevice deviceType
        type_ (str | Unset): The client UplinkDevice type.Such as: ap, switch, gateway
        uplink_type (int | Unset): The client link type
        show_model (str | Unset): The client UplinkDevice showModel
        model (str | Unset): The client UplinkDevice model
        model_version (str | Unset): The client UplinkDevice modelVersion
        port (str | Unset): The client Uplink Device port number
        unit (int | Unset): The client Uplink StackDevice unit
        stack_id (str | Unset): The client Uplink StackDevice StackId
        stack_name (str | Unset): The client Uplink StackDevice StackName
        is_stack (bool | Unset): Whether The client Uplink StackDevice is Stack or not
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        client_uplink_device.additional_properties = d
        return client_uplink_device
