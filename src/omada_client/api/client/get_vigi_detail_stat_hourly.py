...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/vigi-stat-detail/{vigi_mac}/hourly".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get VIGI device statistical data details at a hourly interval.
     ...
     Get VIGI device statistical data details at a hourly interval.<br/><br/>The interface requires one
