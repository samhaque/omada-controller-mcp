...
T = TypeVar("T", bound="GridVOOswDetailVO")


@_attrs_define
class GridVOOswDetailVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswDetailVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osw_detail_vo = cls(
        ...
        grid_vo_osw_detail_vo.additional_properties = d
        return grid_vo_osw_detail_vo
