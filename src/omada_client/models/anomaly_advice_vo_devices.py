...
T = TypeVar("T", bound="AnomalyAdviceVODevices")


@_attrs_define
class AnomalyAdviceVODevices:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        anomaly_advice_vo_devices.additional_properties = additional_properties
        return anomaly_advice_vo_devices
