...
if TYPE_CHECKING:
    from ..models.wids_data_open_api_vo import WidsDataOpenApiVO


T = TypeVar("T", bound="GridVOWidsDataOpenApiVO")


@_attrs_define
class GridVOWidsDataOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = WidsDataOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_wids_data_open_api_vo = cls(
        ...
        grid_vo_wids_data_open_api_vo.additional_properties = d
        return grid_vo_wids_data_open_api_vo
