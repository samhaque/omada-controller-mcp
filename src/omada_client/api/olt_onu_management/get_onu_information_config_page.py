...
from ...models.onu_management_page_query_request_dto import (
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: OnuManagementPageQueryRequestDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/onu-management/informations/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ONU information config page
     ...
     Get ONU information config page<br/><br/>The interface requires one of the permissions: <br/>Site
