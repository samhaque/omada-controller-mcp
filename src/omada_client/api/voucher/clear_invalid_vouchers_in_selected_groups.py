...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/hotspot/voucher-groups/batch/clear-invalid".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete expired vouchers in voucher groups
     ...
     Delete expired vouchers in selected voucher group.<br/><br/>The interface requires one of the
