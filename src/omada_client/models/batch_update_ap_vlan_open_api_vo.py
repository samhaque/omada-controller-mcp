...
T = TypeVar("T", bound="BatchUpdateApVlanOpenApiVO")


@_attrs_define
class BatchUpdateApVlanOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        batch_update_ap_vlan_open_api_vo = cls(
            ap_mac_list=ap_mac_list,
            mvlan_setting=mvlan_setting,
            voip_vlan_setting=voip_vlan_setting,
        )

        batch_update_ap_vlan_open_api_vo.additional_properties = d
        return batch_update_ap_vlan_open_api_vo
