...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/devicetemplates/{device_template_id}/batch-unbinddevice".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Device template batch unbind devices
     ...
     Device template batch unbind devices.<br/><br/>The interface requires one of the permissions:
    ...
    request parameters.<br/>-44402  -  Device template does not exist.
