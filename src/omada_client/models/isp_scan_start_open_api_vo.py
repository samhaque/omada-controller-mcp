...
T = TypeVar("T", bound="IspScanStartOpenApiVO")


@_attrs_define
class IspScanStartOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        isp_scan_start_open_api_vo = cls(
            port_uuid=port_uuid,
            sim_card=sim_card,
        )

        isp_scan_start_open_api_vo.additional_properties = d
        return isp_scan_start_open_api_vo
