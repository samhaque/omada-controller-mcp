...
T = TypeVar("T", bound="SelectMacsWithVlanVO")


@_attrs_define
class SelectMacsWithVlanVO:
    """
    Attributes:
        macs (list[str]): Device mac list for Site Setting or device template ID list for Site Template Setting
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        select_macs_with_vlan_vo.additional_properties = d
        return select_macs_with_vlan_vo
