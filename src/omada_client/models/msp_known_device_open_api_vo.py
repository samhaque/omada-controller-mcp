...
T = TypeVar("T", bound="MspKnownDeviceOpenApiVO")


@_attrs_define
class MspKnownDeviceOpenApiVO:
    """
    Attributes:
        ...
        license_status (int | Unset): Device license status(Only for pro site) should be a value as follows: 0:unActive;
            1:Unbind; 2:Expired; 3:active
        need_active (bool | Unset): Device license status(Only for pro site).If the value is true, the device is ready
            to be activated;If the value is false, the device cannot be activated or has already been activated.
        customer_name (str | Unset): The name of the customer where the device is located
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        msp_known_device_open_api_vo = cls(
            mac=mac,
            name=name,
            type_=type_,
            subtype=subtype,
        ...
        msp_known_device_open_api_vo.additional_properties = d
        return msp_known_device_open_api_vo
