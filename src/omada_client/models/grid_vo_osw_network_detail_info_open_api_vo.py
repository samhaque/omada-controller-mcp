...
if TYPE_CHECKING:
    from ..models.osw_network_detail_info_open_api_vo import (
        OswNetworkDetailInfoOpenApiVO,
    )


T = TypeVar("T", bound="GridVOOswNetworkDetailInfoOpenApiVO")


@_attrs_define
class GridVOOswNetworkDetailInfoOpenApiVO:
    """
    Attributes:
        ...
        data (list[OswNetworkDetailInfoOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[OswNetworkDetailInfoOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswNetworkDetailInfoOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osw_network_detail_info_open_api_vo = cls(
        ...
        grid_vo_osw_network_detail_info_open_api_vo.additional_properties = d
        return grid_vo_osw_network_detail_info_open_api_vo
