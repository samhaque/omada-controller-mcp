...
from ...models.onu_register_auto_find_page_query_request_dto import (
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: OnuRegisterAutoFindPageQueryRequestDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/onu-register/autofinds/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """get ONU auto find config page
     ...
     get ONU auto find config page<br/><br/>The interface requires one of the permissions: <br/>Site
