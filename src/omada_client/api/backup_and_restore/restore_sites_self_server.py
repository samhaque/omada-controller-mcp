...
from ...models.batch_site_self_restore_vo import BatchSiteSelfRestoreVO
...
def _get_kwargs(
    omadac_id: str,
    *,
    body: BatchSiteSelfRestoreVO,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/maintenance/multi-restore/self-server".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Restore multi sites config from self server
     ...
     Restore multi sites config from self server. At most 300 sites can be restored.<br/><br/>The
