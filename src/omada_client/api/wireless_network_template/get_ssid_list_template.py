...
def sync_detailed(
    ...
    *,
    ...
    """Get SSID template list
     ...
     Get SSID template list, Legacy note: “wlanId” is the legacy name of “apGroupId”. This endpoint will
    be deprecated in future releases. Please use Get SSID template list v2.<br/><br/>The interface
