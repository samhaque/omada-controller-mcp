...
if TYPE_CHECKING:
    ...
    from ..models.osg_mdns_rule_open_api_vo import OsgMdnsRuleOpenApiVO


T = TypeVar("T", bound="CreateMdnsRuleOpenApiVO")


@_attrs_define
class CreateMdnsRuleOpenApiVO:
    """
    Attributes:
        ...
        osg (OsgMdnsRuleOpenApiVO | Unset): MDNS rule by network config, valid when parameter [type] is 1
    """
    ...
    osg: OsgMdnsRuleOpenApiVO | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        from ..models.osg_mdns_rule_open_api_vo import (
        ...
        osg: OsgMdnsRuleOpenApiVO | Unset
        if isinstance(_osg, Unset):
            osg = UNSET
        else:
            osg = OsgMdnsRuleOpenApiVO.from_dict(_osg)

        create_mdns_rule_open_api_vo = cls(
            name=name,
            status=status,
        ...
        create_mdns_rule_open_api_vo.additional_properties = d
        return create_mdns_rule_open_api_vo
