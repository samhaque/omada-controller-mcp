...
if TYPE_CHECKING:
    from ..models.nat_traversal_tunnel_vo import NatTraversalTunnelVO


T = TypeVar("T", bound="NatTraversalTunnelGridVONatTraversalTunnelVO")


@_attrs_define
class NatTraversalTunnelGridVONatTraversalTunnelVO:
    """
    Attributes:
        ...
        data (list[NatTraversalTunnelVO] | Unset):
        support_ssh_telnet_tunnel (bool | Unset): Whether to support SSH/Telnet tunnel
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[NatTraversalTunnelVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.nat_traversal_tunnel_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = NatTraversalTunnelVO.from_dict(data_item_data)

                data.append(data_item)

        support_ssh_telnet_tunnel = d.pop("supportSshTelnetTunnel", UNSET)

        nat_traversal_tunnel_grid_vo_nat_traversal_tunnel_vo = cls(
        ...
        nat_traversal_tunnel_grid_vo_nat_traversal_tunnel_vo.additional_properties = d
        return nat_traversal_tunnel_grid_vo_nat_traversal_tunnel_vo
