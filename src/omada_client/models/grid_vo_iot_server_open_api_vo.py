...
if TYPE_CHECKING:
    from ..models.iot_server_open_api_vo import IotServerOpenApiVO


T = TypeVar("T", bound="GridVOIotServerOpenApiVO")


@_attrs_define
class GridVOIotServerOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = IotServerOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_iot_server_open_api_vo = cls(
        ...
        grid_vo_iot_server_open_api_vo.additional_properties = d
        return grid_vo_iot_server_open_api_vo
