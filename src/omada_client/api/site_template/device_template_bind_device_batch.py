...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/devicetemplates/{device_template_id}/batch-binddevice".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Device template batch bind devices
     ...
     Device template batch bind devices.<br/><br/>The interface requires one of the permissions:
