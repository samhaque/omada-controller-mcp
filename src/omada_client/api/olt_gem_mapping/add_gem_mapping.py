...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/{line_profile_id}/gem-mappings/add".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create new gem mapping
     ...
     Create new gem mapping<br/><br/>The interface requires one of the permissions: <br/>Site Device
