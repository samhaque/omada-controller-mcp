...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/portals".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get portal list in a site template
     ...
     Get portal list with the given omadacId, siteTemplateId.<br/><br/>The interface requires one of the
