...
if TYPE_CHECKING:
    from ..models.simplified_voip_device_open_api_vo import (
        SimplifiedVoipDeviceOpenApiVO,
    )


T = TypeVar("T", bound="GridVOSimplifiedVoipDeviceOpenApiVO")


@_attrs_define
class GridVOSimplifiedVoipDeviceOpenApiVO:
    """
    Attributes:
        ...
        data (list[SimplifiedVoipDeviceOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[SimplifiedVoipDeviceOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SimplifiedVoipDeviceOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_simplified_voip_device_open_api_vo = cls(
        ...
        grid_vo_simplified_voip_device_open_api_vo.additional_properties = d
        return grid_vo_simplified_voip_device_open_api_vo
