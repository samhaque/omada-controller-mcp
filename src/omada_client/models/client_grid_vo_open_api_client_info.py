...
if TYPE_CHECKING:
    ...
    from ..models.open_api_client_info import OpenApiClientInfo


T = TypeVar("T", bound="ClientGridVOOpenApiClientInfo")


@_attrs_define
class ClientGridVOOpenApiClientInfo:
    """
    Attributes:
        ...
        data (list[OpenApiClientInfo] | Unset):
    ...
    data: list[OpenApiClientInfo] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OpenApiClientInfo.from_dict(data_item_data)
        ...
        client_grid_vo_open_api_client_info = cls(
        ...
        client_grid_vo_open_api_client_info.additional_properties = d
        return client_grid_vo_open_api_client_info
