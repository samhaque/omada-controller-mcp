...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/hotspot/vouchers/{id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a voucher
     ...
     Get a voucher with the given params.<br/><br/>The interface requires one of the permissions:
