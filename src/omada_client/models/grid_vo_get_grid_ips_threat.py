...
if TYPE_CHECKING:
    from ..models.get_grid_ips_threat import GetGridIpsThreat


T = TypeVar("T", bound="GridVOGetGridIpsThreat")


@_attrs_define
class GridVOGetGridIpsThreat:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = GetGridIpsThreat.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_get_grid_ips_threat = cls(
        ...
        grid_vo_get_grid_ips_threat.additional_properties = d
        return grid_vo_get_grid_ips_threat
