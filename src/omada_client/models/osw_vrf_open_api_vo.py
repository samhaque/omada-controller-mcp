...
T = TypeVar("T", bound="OswVrfOpenApiVO")


@_attrs_define
class OswVrfOpenApiVO:
    """
    Attributes:
        ...
        id (str | Unset): VRF ID
        is_default (bool | Unset): Indicates whether vrf is default vrf
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osw_vrf_open_api_vo.additional_properties = d
        return osw_vrf_open_api_vo
