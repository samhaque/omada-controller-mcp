...
T = TypeVar("T", bound="LanNetworkQueryOpenApiV2VO")


@_attrs_define
class LanNetworkQueryOpenApiV2VO:
    ...
    Attributes:
        ...
        dhcp_settings_vo (DhcpSettingInfo | Unset): Configure DHCP settings
    ...
    dhcp_settings_vo: DhcpSettingInfo | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        dhcp_settings_vo: DhcpSettingInfo | Unset
        if isinstance(_dhcp_settings_vo, Unset):
            dhcp_settings_vo = UNSET
        else:
            dhcp_settings_vo = DhcpSettingInfo.from_dict(_dhcp_settings_vo)
        ...
        lan_network_query_open_api_v2vo = cls(
            name=name,
            purpose=purpose,
        ...
        lan_network_query_open_api_v2vo.additional_properties = d
        return lan_network_query_open_api_v2vo
