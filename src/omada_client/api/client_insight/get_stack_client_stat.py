...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/stat/stacks/{stack_id}/client-stat".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get stack client stat.
     ...
     Obtain the sampling statistics of the clients.<br/><br/>The interface requires one of the
