...
T = TypeVar("T", bound="WlanSimpleOpenApiVO")


@_attrs_define
class WlanSimpleOpenApiVO:
    """
    Attributes:
        wlan_id (str | Unset): ID of WLAN
        wlan_name (str | Unset): Name of WLAN
        ssid_list (list[SsidSimpleOpenApiVO] | Unset): SSID list that support MAC-Based authentication
    """

    wlan_id: str | Unset = UNSET
    wlan_name: str | Unset = UNSET
    ssid_list: list[SsidSimpleOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _ssid_list is not UNSET:
            ...
            for ssid_list_item_data in _ssid_list:
                ssid_list_item = SsidSimpleOpenApiVO.from_dict(ssid_list_item_data)

                ssid_list.append(ssid_list_item)

        wlan_simple_open_api_vo = cls(
            wlan_id=wlan_id,
            wlan_name=wlan_name,
            ssid_list=ssid_list,
        )

        wlan_simple_open_api_vo.additional_properties = d
        return wlan_simple_open_api_vo
