...
if TYPE_CHECKING:
    from ..models.dot_customized_server_open_api_vo import DotCustomizedServerOpenApiVO


T = TypeVar("T", bound="DotSettingOpenApiVO")


@_attrs_define
class DotSettingOpenApiVO:
    ...
    Attributes:
        default_servers (list[int] | Unset): Preconfigured Server List. DefaultServers should be a value as follows:
            0:Google, 1：Cloudflare, 2：OpenDNS, 3：Quad9, 4: CleanBrowsing. Up to 2 DoT default and custom servers can be
            selected. For example, defaultServers : [0, 1] represents that you have selected default services Google and
            Cloudflare
        customized_servers (list[DotCustomizedServerOpenApiVO] | Unset): Custom Service list. Up to 2 DoT default and
    ...
    customized_servers: list[DotCustomizedServerOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.dot_customized_server_open_api_vo import (
        ...
        if _customized_servers is not UNSET:
            ...
            for customized_servers_item_data in _customized_servers:
                customized_servers_item = DotCustomizedServerOpenApiVO.from_dict(
                    customized_servers_item_data
                )

                customized_servers.append(customized_servers_item)

        dot_setting_open_api_vo = cls(
            default_servers=default_servers,
            customized_servers=customized_servers,
        )

        dot_setting_open_api_vo.additional_properties = d
        return dot_setting_open_api_vo
