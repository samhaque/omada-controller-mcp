...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/profiles/ldap/{ldap_profile_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify an exist LDAP profile
     ...
     Modify an exist LDAP profile with the given params.<br/><br/>The interface requires one of the
