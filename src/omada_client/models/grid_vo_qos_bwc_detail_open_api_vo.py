...
if TYPE_CHECKING:
    from ..models.qos_bwc_detail_open_api_vo import QosBwcDetailOpenApiVO


T = TypeVar("T", bound="GridVOQosBwcDetailOpenApiVO")


@_attrs_define
class GridVOQosBwcDetailOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.qos_bwc_detail_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = QosBwcDetailOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_qos_bwc_detail_open_api_vo = cls(
        ...
        grid_vo_qos_bwc_detail_open_api_vo.additional_properties = d
        return grid_vo_qos_bwc_detail_open_api_vo
