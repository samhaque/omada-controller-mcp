...
T = TypeVar("T", bound="ServicePortProfileDetailListQueryDTO")


@_attrs_define
class ServicePortProfileDetailListQueryDTO:
    """
    Attributes:
        search_key (str | Unset): Query conditions.
        sorts (list[C] | Unset): Sorting fields.
        search_fields (list[str] | Unset): Query Filter Fields:servicePortId,servicePortProfileId,svlan,gemId,userVlan,u
            serVlanPriority,tagAction,innerVlan,innerVlanPriority.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        service_port_profile_detail_list_query_dto = cls(
            search_key=search_key,
            sorts=sorts,
            search_fields=search_fields,
        )

        service_port_profile_detail_list_query_dto.additional_properties = d
        return service_port_profile_detail_list_query_dto
