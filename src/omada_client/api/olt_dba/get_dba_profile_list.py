...
from ...models.dba_profile_list_query_dto import DBAProfileListQueryDTO
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: DBAProfileListQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/dba/profiles/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get DBA profile list
     ...
     Get DBA profile list<br/><br/>The interface requires one of the permissions: <br/>Site Device
