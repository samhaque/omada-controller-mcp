...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/lan-profiles/{profile_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify a LAN profile
     ...
     Modify a LAN profile.<br/><br/>The interface requires one of the permissions: <br/>Site Settings
