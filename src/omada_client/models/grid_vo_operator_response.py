...
T = TypeVar("T", bound="GridVOOperatorResponse")


@_attrs_define
class GridVOOperatorResponse:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OperatorResponse.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_operator_response = cls(
        ...
        grid_vo_operator_response.additional_properties = d
        return grid_vo_operator_response
