...
from ...models.tcont_dto import TcontDTO
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/{line_profile_id}/t-conts/add".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create new t-cont
     ...
     Create new t-cont<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
