...
T = TypeVar("T", bound="LineProfileListQueryDTO")


@_attrs_define
class LineProfileListQueryDTO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        line_profile_list_query_dto = cls(
            search_key=search_key,
            sorts=sorts,
            search_fields=search_fields,
        )

        line_profile_list_query_dto.additional_properties = d
        return line_profile_list_query_dto
