...
if TYPE_CHECKING:
    from ..models.oui_based_vlan_switch_query_open_api_vo import (
        OuiBasedVlanSwitchQueryOpenApiVO,
    )


T = TypeVar("T", bound="GridVOOuiBasedVlanSwitchQueryOpenApiVO")


@_attrs_define
class GridVOOuiBasedVlanSwitchQueryOpenApiVO:
    """
    Attributes:
        ...
        data (list[OuiBasedVlanSwitchQueryOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[OuiBasedVlanSwitchQueryOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OuiBasedVlanSwitchQueryOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_oui_based_vlan_switch_query_open_api_vo = cls(
        ...
        grid_vo_oui_based_vlan_switch_query_open_api_vo.additional_properties = d
        return grid_vo_oui_based_vlan_switch_query_open_api_vo
