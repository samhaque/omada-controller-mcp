...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/anomaly/{mac}/influencing-devices".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Influencing Devices by an incident
     ...
     Get Influencing Devices by an incident<br/><br/>The interface requires one of the permissions:
