...
from ...models.gem_port_page_query_dto import GemPortPageQueryDTO
...
def _get_kwargs(
    ...
    line_profile_id: str,
    *,
    query_param: GemPortPageQueryDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/profile/line/{line_profile_id}/gem-ports/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get gem port page
     ...
     Get gem port page<br/><br/>The interface requires one of the permissions: <br/>Site Device Manager
