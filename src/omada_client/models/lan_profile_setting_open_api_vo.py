...
if TYPE_CHECKING:
    ...
    from ..models.lan_profile_setting_open_api_vo_tag_bridge_vlan_map import (
        LanProfileSettingOpenApiVOTagBridgeVlanMap,
    )
    from ..models.lan_profile_setting_open_api_vo_untag_bridge_vlan_map import (
...
T = TypeVar("T", bound="LanProfileSettingOpenApiVO")


@_attrs_define
class LanProfileSettingOpenApiVO:
    """
    Attributes:
        ...
        vlan_config_enable (bool | Unset): Vlan configuration enable status
        network_tags_setting (int | Unset): network Tags configuration mode should be a value as follows: 0:allow all,
            1:block all, 2:custom
        ...
        tag_bridge_vlan_map (LanProfileSettingOpenApiVOTagBridgeVlanMap | Unset): Tag Network Bridge Vlan Map
        untag_network_ids (list[str] | Unset): Untag Network IDs
        untag_bridge_vlan_map (LanProfileSettingOpenApiVOUntagBridgeVlanMap | Unset): Untag Network Bridge Vlan Map
    ...
    vlan_config_enable: bool | Unset = UNSET
    ...
    tag_bridge_vlan_map: LanProfileSettingOpenApiVOTagBridgeVlanMap | Unset = UNSET
    untag_network_ids: list[str] | Unset = UNSET
    untag_bridge_vlan_map: LanProfileSettingOpenApiVOUntagBridgeVlanMap | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if vlan_config_enable is not UNSET:
            field_dict["vlanConfigEnable"] = vlan_config_enable
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        vlan_config_enable = d.pop("vlanConfigEnable", UNSET)
        ...
        tag_bridge_vlan_map: LanProfileSettingOpenApiVOTagBridgeVlanMap | Unset
        if isinstance(_tag_bridge_vlan_map, Unset):
            tag_bridge_vlan_map = UNSET
        else:
            tag_bridge_vlan_map = LanProfileSettingOpenApiVOTagBridgeVlanMap.from_dict(
        ...
        untag_bridge_vlan_map: LanProfileSettingOpenApiVOUntagBridgeVlanMap | Unset
        if isinstance(_untag_bridge_vlan_map, Unset):
            untag_bridge_vlan_map = UNSET
        else:
            untag_bridge_vlan_map = (
                LanProfileSettingOpenApiVOUntagBridgeVlanMap.from_dict(
        ...
        lan_profile_setting_open_api_vo = cls(
            name=name,
            poe=poe,
            dot1x=dot1x,
        ...
        lan_profile_setting_open_api_vo.additional_properties = d
        return lan_profile_setting_open_api_vo
