...
from ...models.upload_client_cert_file_1_body import UploadClientCertFile1Body
...
def _get_kwargs(
    ...
    site_id: str,
    *,
    body: UploadClientCertFile1Body | Unset = UNSET,
    data: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v1/{omadac_id}/files/sites/{site_id}/setting/profiles/cert-profiles/client-cert".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Upload client certificate profile file
     ...
     Upload client certificate  profile file of the site with the given omadacId and siteId.<br/><br/>The
    interface requires one of the permissions: <br/>Network Config Page Modify<br/>Site Settings Manager
    ...
    Args:
        ...
        site_id (str):
        data (str):
        body (UploadClientCertFile1Body | Unset):
