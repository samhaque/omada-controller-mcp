...
T = TypeVar("T", bound="ConfigIotBtIbeaconOpenApiVO")


@_attrs_define
class ConfigIotBtIbeaconOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        config_iot_bt_ibeacon_open_api_vo = cls(
            name=name,
            mac_list=mac_list,
            uuid=uuid,
            major=major,
        ...
        config_iot_bt_ibeacon_open_api_vo.additional_properties = d
        return config_iot_bt_ibeacon_open_api_vo
