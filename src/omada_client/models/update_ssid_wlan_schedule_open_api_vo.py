...
T = TypeVar("T", bound="UpdateSsidWlanScheduleOpenApiVO")


@_attrs_define
class UpdateSsidWlanScheduleOpenApiVO:
    """
    Attributes:
        wlan_schedule_enable (bool): SSID WLAN schedule global config status. True: enable, false: disable.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update(
            {
                "wlanScheduleEnable": wlan_schedule_enable,
            }
        )
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        wlan_schedule_enable = d.pop("wlanScheduleEnable")

        action = d.pop("action", UNSET)

        schedule_id = d.pop("scheduleId", UNSET)

        update_ssid_wlan_schedule_open_api_vo = cls(
            wlan_schedule_enable=wlan_schedule_enable,
            action=action,
            schedule_id=schedule_id,
        )

        update_ssid_wlan_schedule_open_api_vo.additional_properties = d
        return update_ssid_wlan_schedule_open_api_vo
