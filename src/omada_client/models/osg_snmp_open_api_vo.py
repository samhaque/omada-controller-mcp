...
T = TypeVar("T", bound="OsgSnmpOpenApiVO")


@_attrs_define
class OsgSnmpOpenApiVO:
    """Snmp setting
    ...
    Attributes:
        ...
        type_ (int | Unset): SNMP config type, 0: use site setting, 1:custom.
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osg_snmp_open_api_vo = cls(
            location=location,
            contact=contact,
            type_=type_,
        )

        osg_snmp_open_api_vo.additional_properties = d
        return osg_snmp_open_api_vo
