...
from ...models.onu_register_authen_page_query_request_dto import (
...
def _get_kwargs(
    ...
    device_mac: str,
    *,
    query_param: OnuRegisterAuthenPageQueryRequestDTO,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/onu-register/authentications/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get authentication config list
     ...
     Get authentication config list<br/><br/>The interface requires one of the permissions: <br/>Site
    ...
    manage the device now.<br/>-45003  -  OLT rebooting... Cannot manage the device now.<br/>-45013  -
    Pon port does not exist.
