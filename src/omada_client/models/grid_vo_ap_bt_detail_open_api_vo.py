...
T = TypeVar("T", bound="GridVOApBtDetailOpenApiVO")


@_attrs_define
class GridVOApBtDetailOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = ApBtDetailOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ap_bt_detail_open_api_vo = cls(
        ...
        grid_vo_ap_bt_detail_open_api_vo.additional_properties = d
        return grid_vo_ap_bt_detail_open_api_vo
