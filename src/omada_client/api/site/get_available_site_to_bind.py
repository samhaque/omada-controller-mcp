...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/available-bind".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get available site to bind template
     ...
     Get available site to bind template.<br/><br/>The interface requires one of the permissions:
