...
T = TypeVar("T", bound="EasyManagedSwitchGeneralConfigDetail")


@_attrs_define
class EasyManagedSwitchGeneralConfigDetail:
    """
    Attributes:
        ...
        support_power_alert (bool | Unset): Parameter [supportPowerAlert] should be true or false.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        easy_managed_switch_general_config_detail = cls(
            name=name,
        ...
        easy_managed_switch_general_config_detail.additional_properties = d
        return easy_managed_switch_general_config_detail
