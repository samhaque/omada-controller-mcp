...
if TYPE_CHECKING:
    from ..models.ips_threat_open_api_vo import IpsThreatOpenApiVO


T = TypeVar("T", bound="GridVOIpsThreatOpenApiVO")


@_attrs_define
class GridVOIpsThreatOpenApiVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = IpsThreatOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ips_threat_open_api_vo = cls(
        ...
        grid_vo_ips_threat_open_api_vo.additional_properties = d
        return grid_vo_ips_threat_open_api_vo
