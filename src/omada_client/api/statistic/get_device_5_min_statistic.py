...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/openapi/v2/{omadac_id}/sites/{site_id}/stat/{device_mac}/5min".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get device statistic data 5 min
     ...
     Get device statistic data 5 min. The supported attrs and response fields depend on the type
