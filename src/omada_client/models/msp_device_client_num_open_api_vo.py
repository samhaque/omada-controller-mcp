...
T = TypeVar("T", bound="MspDeviceClientNumOpenApiVO")


@_attrs_define
class MspDeviceClientNumOpenApiVO:
    """Client number under the device for MSP

    Attributes:
        customer_id (str | Unset): Customer id of the device
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        msp_device_client_num_open_api_vo = cls(
        ...
        msp_device_client_num_open_api_vo.additional_properties = d
        return msp_device_client_num_open_api_vo
