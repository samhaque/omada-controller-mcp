...
def sync_detailed(
    ...
    *,
    ...
    """Delete an existing SSID template
     ...
     Delete an existing SSID template, Legacy note: “wlanId” is the legacy name of “apGroupId”. This
    endpoint will be deprecated in future releases. Please use Delete an existing SSID
