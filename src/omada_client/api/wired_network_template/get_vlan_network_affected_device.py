...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sitetemplates/{site_template_id}/networks/{network_id}/vlan/{vlan}/devices".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get device template list that use the network
     ...
     Get device template list that use the network<br/><br/>The interface requires one of the
