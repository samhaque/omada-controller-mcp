...
if TYPE_CHECKING:
    ...
    from ..models.stack_port_setting_vo_tag_bridge_vlan_map import (
        StackPortSettingVOTagBridgeVlanMap,
    )
    from ..models.stack_port_setting_vo_untag_bridge_vlan_map import (
        StackPortSettingVOUntagBridgeVlanMap,
    )


T = TypeVar("T", bound="StackPortSettingVO")


@_attrs_define
class StackPortSettingVO:
    """
    Attributes:
        ...
        tag_bridge_vlan_map (StackPortSettingVOTagBridgeVlanMap | Unset): Tag Network Bridge Vlan Map
        untag_network_ids (list[str] | Unset): Untag Network IDs
        untag_bridge_vlan_map (StackPortSettingVOUntagBridgeVlanMap | Unset): Untag Network Bridge Vlan Map
    ...
    tag_bridge_vlan_map: StackPortSettingVOTagBridgeVlanMap | Unset = UNSET
    untag_network_ids: list[str] | Unset = UNSET
    untag_bridge_vlan_map: StackPortSettingVOUntagBridgeVlanMap | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        tag_bridge_vlan_map: StackPortSettingVOTagBridgeVlanMap | Unset
        if isinstance(_tag_bridge_vlan_map, Unset):
            tag_bridge_vlan_map = UNSET
        else:
            tag_bridge_vlan_map = StackPortSettingVOTagBridgeVlanMap.from_dict(
        ...
        untag_bridge_vlan_map: StackPortSettingVOUntagBridgeVlanMap | Unset
        if isinstance(_untag_bridge_vlan_map, Unset):
            untag_bridge_vlan_map = UNSET
        else:
            untag_bridge_vlan_map = StackPortSettingVOUntagBridgeVlanMap.from_dict(
        ...
        stack_port_setting_vo.additional_properties = d
        return stack_port_setting_vo
