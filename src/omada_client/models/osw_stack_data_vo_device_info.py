...
T = TypeVar("T", bound="OswStackDataVODeviceInfo")


@_attrs_define
class OswStackDataVODeviceInfo:
    """
    Attributes:
        stack_id (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osw_stack_data_vo_device_info = cls(
            stack_id=stack_id,
        ...
        osw_stack_data_vo_device_info.additional_properties = d
        return osw_stack_data_vo_device_info
