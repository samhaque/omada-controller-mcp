...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/onu-register/authentications/page".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get authentication config page
     ...
     Get authentication config page<br/><br/>The interface requires one of the permissions: <br/>Site
