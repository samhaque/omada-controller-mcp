...
T = TypeVar("T", bound="VpnUserOpenApiGridVOVpnUserInfoVO")


@_attrs_define
class VpnUserOpenApiGridVOVpnUserInfoVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        vpn_user_open_api_grid_vo_vpn_user_info_vo = cls(
        ...
        vpn_user_open_api_grid_vo_vpn_user_info_vo.additional_properties = d
        return vpn_user_open_api_grid_vo_vpn_user_info_vo
