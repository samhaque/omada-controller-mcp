...
T = TypeVar("T", bound="OswStackMemberStatVOPortMap")


@_attrs_define
class OswStackMemberStatVOPortMap:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        osw_stack_member_stat_vo_port_map = cls()
        ...
        osw_stack_member_stat_vo_port_map.additional_properties = additional_properties
        return osw_stack_member_stat_vo_port_map
