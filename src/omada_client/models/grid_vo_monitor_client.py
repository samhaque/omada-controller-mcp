...
T = TypeVar("T", bound="GridVOMonitorClient")


@_attrs_define
class GridVOMonitorClient:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = MonitorClient.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_monitor_client = cls(
        ...
        grid_vo_monitor_client.additional_properties = d
        return grid_vo_monitor_client
