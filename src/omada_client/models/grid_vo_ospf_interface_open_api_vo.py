...
if TYPE_CHECKING:
    from ..models.ospf_interface_open_api_vo import OspfInterfaceOpenApiVO


T = TypeVar("T", bound="GridVOOspfInterfaceOpenApiVO")


@_attrs_define
class GridVOOspfInterfaceOpenApiVO:
    """
    Attributes:
        ...
        data (list[OspfInterfaceOpenApiVO] | Unset):
    """

    total_rows: int | Unset = UNSET
    current_page: int | Unset = UNSET
    current_size: int | Unset = UNSET
    data: list[OspfInterfaceOpenApiVO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.ospf_interface_open_api_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OspfInterfaceOpenApiVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_ospf_interface_open_api_vo = cls(
        ...
        grid_vo_ospf_interface_open_api_vo.additional_properties = d
        return grid_vo_ospf_interface_open_api_vo
