...
T = TypeVar("T", bound="OswDetailBatchSelectedVO")


@_attrs_define
class OswDetailBatchSelectedVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        osw_detail_batch_selected_vo = cls(
            type_=type_,
            mac=mac,
            name=name,
            model=model,
        ...
        osw_detail_batch_selected_vo.additional_properties = d
        return osw_detail_batch_selected_vo
