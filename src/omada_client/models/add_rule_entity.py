...
T = TypeVar("T", bound="AddRuleEntity")
...
class AddRuleEntity:
    ...
    Attributes:
        ...
        select_type (str): Select type of applications. include: include selected applications, exclude: all but exclude
            selected applications, all: include all applications.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        add_rule_entity.additional_properties = d
        return add_rule_entity
