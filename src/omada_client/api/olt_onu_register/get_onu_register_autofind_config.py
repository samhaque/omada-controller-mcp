...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/olts/{device_mac}/pon/onu-register/autofind/configs/get".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get ONU register auto find config
     ...
     Get ONU register auto find config<br/><br/>The interface requires one of the permissions: <br/>Site
