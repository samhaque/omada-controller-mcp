...
if TYPE_CHECKING:
    ...
    from ..models.impb_vo import ImpbVO
...
class ArpDetectVO:
    """
    Attributes:
        id (str | Unset): The primary id of the arp detection.
        omadac_id (str | Unset): The id of the omada the arp detect belongs to.
        site_id (str | Unset): The id of the site the arp detect belongs to.
        name (str | Unset): The name of the arp detect.
        ...
        impbs (list[ImpbVO] | Unset): The impbs selected.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        impbs: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.impbs, Unset):
            impbs = []
            for impbs_item_data in self.impbs:
                impbs_item = impbs_item_data.to_dict()
                impbs.append(impbs_item)
        ...
        if impbs is not UNSET:
            field_dict["impbs"] = impbs
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        _impbs = d.pop("impbs", UNSET)
        impbs: list[ImpbVO] | Unset = UNSET
        if _impbs is not UNSET:
            impbs = []
            for impbs_item_data in _impbs:
                impbs_item = ImpbVO.from_dict(impbs_item_data)
        ...
        arp_detect_vo.additional_properties = d
        return arp_detect_vo
