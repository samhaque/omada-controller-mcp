...
if TYPE_CHECKING:
    from ..models.osw_ports_setting_poe_vo import OswPortsSettingPoeVO


T = TypeVar("T", bound="GridVOOswPortsSettingPoeVO")


@_attrs_define
class GridVOOswPortsSettingPoeVO:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.osw_ports_setting_poe_vo import (
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = OswPortsSettingPoeVO.from_dict(data_item_data)

                data.append(data_item)

        grid_vo_osw_ports_setting_poe_vo = cls(
        ...
        grid_vo_osw_ports_setting_poe_vo.additional_properties = d
        return grid_vo_osw_ports_setting_poe_vo
