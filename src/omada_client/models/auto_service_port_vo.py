...
from ..models.auto_service_port_vo_auto_mode import AutoServicePortVOAutoMode
from ..models.auto_service_port_vo_ether_type import AutoServicePortVOEtherType
from ..models.auto_service_port_vo_tag_action import AutoServicePortVOTagAction
from ..types import UNSET, Unset

T = TypeVar("T", bound="AutoServicePortVO")


@_attrs_define
class AutoServicePortVO:
    """Content

    Attributes:
        auto_mode (AutoServicePortVOAutoMode | Unset): AutoMOde should be a value as follows:Disable,Enable
        ...
        tag_action (AutoServicePortVOTagAction | Unset): TagAction should be a value as
        ...
        ether_type (AutoServicePortVOEtherType | Unset): EtherType should be a value as follows:NONE,IPV4OE,IPV6OE,PPPOE
    ...
    auto_mode: AutoServicePortVOAutoMode | Unset = UNSET
    ...
    tag_action: AutoServicePortVOTagAction | Unset = UNSET
    inner_vlan: int | Unset = UNSET
    inner_vlan_priority: str | Unset = UNSET
    ether_type: AutoServicePortVOEtherType | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        auto_mode: AutoServicePortVOAutoMode | Unset
        if isinstance(_auto_mode, Unset):
            auto_mode = UNSET
        else:
            auto_mode = AutoServicePortVOAutoMode(_auto_mode)
        ...
        tag_action: AutoServicePortVOTagAction | Unset
        if isinstance(_tag_action, Unset):
            tag_action = UNSET
        else:
            tag_action = AutoServicePortVOTagAction(_tag_action)
        ...
        ether_type: AutoServicePortVOEtherType | Unset
        if isinstance(_ether_type, Unset):
            ether_type = UNSET
        else:
            ether_type = AutoServicePortVOEtherType(_ether_type)
        ...
        auto_service_port_vo.additional_properties = d
        return auto_service_port_vo
