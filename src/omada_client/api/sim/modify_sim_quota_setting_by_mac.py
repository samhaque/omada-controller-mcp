...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/gateways/{gateway_mac}/sim/quota".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify SIM data setting by mac
     ...
     Modify SIM data setting by mac.<br/><br/>The interface requires one of the permissions: <br/>Site
