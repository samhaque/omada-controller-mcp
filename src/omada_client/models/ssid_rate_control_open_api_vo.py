...
T = TypeVar("T", bound="SsidRateControlOpenApiVO")


@_attrs_define
class SsidRateControlOpenApiVO:
    """SSID 802.11 Rate Control config.

    Attributes:
        rate_2_g_ctrl_enable (bool | Unset): Whether to enable 2.4GHz Data Rate Control
        ...
        rate_5_g_ctrl_enable (bool | Unset): Whether to enable 5GHz Data Rate Control.
        ...
        rate_6_g_ctrl_enable (bool | Unset): Whether to enable 6GHz Data Rate Control.
        ...
        client_rates_require_6_g (bool | Unset): Whether to require clients to use rates at or above the specified value
            of 6GHz Data Rate Control.
        send_beacons_6_g (bool | Unset): Whether to enable send beacons at 6Mbps of 6GHz Data Rate Control.
        manage_rate_control_2_g_enable (bool | Unset): Whether to enable 2.4GHz Manage Rate Control.
    ...
    rate_2_g_ctrl_enable: bool | Unset = UNSET
    ...
    rate_5_g_ctrl_enable: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({})
        if rate_2_g_ctrl_enable is not UNSET:
            field_dict["rate2gCtrlEnable"] = rate_2_g_ctrl_enable
        ...
        if rate_5_g_ctrl_enable is not UNSET:
            field_dict["rate5gCtrlEnable"] = rate_5_g_ctrl_enable
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        rate_2_g_ctrl_enable = d.pop("rate2gCtrlEnable", UNSET)
        ...
        rate_5_g_ctrl_enable = d.pop("rate5gCtrlEnable", UNSET)
        ...
        ssid_rate_control_open_api_vo = cls(
        ...
        ssid_rate_control_open_api_vo.additional_properties = d
        return ssid_rate_control_open_api_vo
