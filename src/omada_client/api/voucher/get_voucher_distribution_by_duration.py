...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/openapi/v1/{omadac_id}/sites/{site_id}/hotspot/vouchers/statistics/history/distribution/duration".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get voucher distribution by duration
     ...
     Get voucher distribution by duration.<br/><br/>The interface requires one of the permissions:
    <br/>Site Hotspot Manager View Only<br/><br/>The possible error code for the interface in the
