...
T = TypeVar("T", bound="PageResponseServicePortProfileListDetailDTO")


@_attrs_define
class PageResponseServicePortProfileListDetailDTO:
    """
    Attributes:
        content (list[ServicePortProfileListDetailDTO] | Unset): Content
    ...
    content: list[ServicePortProfileListDetailDTO] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ServicePortProfileListDetailDTO.from_dict(
                    content_item_data
                )
        ...
        page_response_service_port_profile_list_detail_dto = cls(
            content=content,
        ...
        page_response_service_port_profile_list_detail_dto.additional_properties = d
        return page_response_service_port_profile_list_detail_dto
